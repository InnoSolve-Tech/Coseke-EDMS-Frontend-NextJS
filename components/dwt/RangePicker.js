            ...
            {this.props.rangePicker.bMutable ? (
              <>
                <span className="range-current">
                  {this.props.rangePicker.value} (Default:{" "}
                  {this.props.rangePicker.defaultvalue})
                </span>
                <span>{this.props.rangePicker.min}</span>
                <input
                  type="range"
                  prop={this.props.rangePicker.title}
                  _type={this.props.rangePicker.bCamera ? "camera" : "video"}
                  min={this.props.rangePicker.min}
                  max={this.props.rangePicker.max}
                  step={this.props.rangePicker.step}
                  value={this.props.rangePicker.value}
              ...
              <span className="range-current">
                Default and only value (immutable):{" "}
                {this.props.rangePicker.value}
              </span>
            )}
          </div>
          <div className="range-buttons">
            {this.props.rangePicker.bMutable ? (
              <button
                ...
                value="reset-range"
                onClick={(event) => this.props.handleRangeChange(event)}
              >
                Reset &amp; Close
              </button>
            ) : (
