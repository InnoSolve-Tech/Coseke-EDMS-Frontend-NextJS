...
export default class DWTView extends React.Component {
  ...
  handleQuickEdit(event) {
    ...
    switch (event.target.getAttribute("value")) {
      case "editor":
        ...
        break;
      case "rotateL":
        this.DWTObject.RotateLeft(this.props.buffer.current);
        break;
      case "rotateR":
        this.DWTObject.RotateRight(this.props.buffer.current);
        break;
      case "rotate180":
        this.DWTObject.Rotate(this.props.buffer.current, 180, true);
        break;
      case "mirror":
        this.DWTObject.Mirror(this.props.buffer.current);
        break;
      case "flip":
        this.DWTObject.Flip(this.props.buffer.current);
        break;
      case "removeS":
  ...
  changeImageSizeOK() {
    this.DWTObject.ChangeImageSize(
  ...
  handleNavigation(action) {
    switch (action) {
      default: //viewModeChange, removeAll
        break;
      case "first":
        this.DWTObject.CurrentImageIndexInBuffer = 0;
        break;
      case "last":
        this.DWTObject.CurrentImageIndexInBuffer = this.props.buffer.count - 1;
        break;
      case "previous":
                ...
                <li>
                  <label>
                    ...
                    <input
                      ...
                      className="width_48p floatR"
                      onChange={(event) => this.handleNewSize(event)}
                    />
                  </label>
                </li>
                <li>
                  ...
                  <select
                    tabIndex="6"
                    value={this.state.InterpolationMethod}
                    className="width_48p floatR"
                    onChange={(event) =>
                      this.handleInterpolationMethodChange(event)
                    }
                  >
