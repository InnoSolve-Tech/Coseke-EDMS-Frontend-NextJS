        ...
        insert: function (o) {
          ...
          (n = document.getElementsByTagName("apryse-webviewer")),
            n.length ||
              (n = (function o(n, e = document) {
                const t = [];
                return (
                  e.querySelectorAll(n).forEach((o) => t.push(o)),
                  e.querySelectorAll("*").forEach((e) => {
                    e.shadowRoot && t.push(...o(n, e.shadowRoot));
                  }),
                  t
                );
              })("apryse-webviewer"));
          ...
          for (let t = 0; t < n.length; t++) {
            ...
            if (0 === t)
              ...
              i.shadowRoot.appendChild(n), e.push(n);
            }
          }
        },
        singleton: !1,
            ...
            return (
              ...
              n
                ...
                : i.a.createElement(
                    "div",
                    {
                      className: l()({ Modal: !0, LoadingModal: !0, open: o }),
