  ...
  [15],
  {
            ...
            return (function (t) {
                      ...
                      (function a(u, y) {
                        ...
                        if (f) {
                          ...
                          for (b = 0; b < E.length; b++) {
                            var A,
                              O = E[b];
                            ((A = Object.getOwnPropertyDescriptor(u, O)) &&
                              A.enumerable) ||
                              ((g[O] = a(u[O], y - 1)),
                              Object.defineProperty(g, O, { enumerable: !1 }));
                          }
                        }
                        return g;
                      })(a, u)
                  ...
                  b = (function (t) {
                    function e(t, n) {
                      ...
                      return (
                        ...
                        r.addBinding({ key: e.keys.ENTER, shiftKey: null }, A),
                        r.addBinding(
                          {
                            key: e.keys.ENTER,
                            metaKey: null,
                          ...
                          value: function (t, e) {
                            ...
                            (this.pickers = t.map(function (t) {
                              if (t.classList.contains("ql-align"))
                                return (
                                  null == t.querySelector("option") && A(t, m),
              ...
              function (t, e, n) {
                ...
                var _ = (0, c.default)("quill:clipboard"),
                  ...
                  A = [h.AlignAttribute, g.DirectionAttribute].reduce(function (
                    t,
                    e,
                  ) {
                      ...
                      return (
                        ...
                        E.concat(r.options.matchers).forEach(function (t) {
                          var e = o(t, 2),
                            i = e[0],
                            a = e[1];
                          (n.matchVisual || a !== L) && r.addMatcher(i, a);
                        }),
                        r
                      );
                    }
    ...
    1540: function (t, e, n) {
      ...
      var r = n(49),
        o = n(340);
      r(
        { target: "String", proto: !0, forced: n(341)("link") },
        {
          link: function (t) {
    ...
    1542: function (t, e, n) {
      ...
      var j = (function (t) {
        ...
        function n(t, r) {
          ...
          return (
            l(this, n),
            f(y((o = e.call(this, t, r))), "hoverHandler", void 0),
            f(y(o), "hoverHandler", void 0),
            (o.clickHandler = null),
            (o.hoverHandler = null),
            (o.mounted = !1),
            o
            ...
            [
              {
                key: "attach",
                value: function () {
                  b(p(n.prototype), "attach", this).call(this),
                    this.mounted ||
                      ((this.mounted = !0),
              ...
              },
              {
                key: "detach",
                value: function () {
                  b(p(n.prototype), "detach", this).call(this),
                    (this.mounted = !1),
                    this.clickHandler &&
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    (n.value = h({}, this.domNode.dataset)), (n.event = e), n
                  );
                },
              },
            ],
            [
              {
                key: "create",
                value: function (t) {
                  var e = b(p(n), "create", this).call(this),
      ...
      (j.blotName = "mention"),
        (j.tagName = "span"),
        (j.className = "mention"),
        o.a.register("blots/mention", j);
      var S = (function () {
        function t(e, n) {
          var r = this;
          for (var o in (l(this, t),
          (this.isOpen = !1),
          (this.itemIndex = 0),
          ...
          (this.mentionContainer = document.createElement("div")),
            ...
            e.keyboard.addBinding({ key: E }, this.selectHandler.bind(this)),
            e.keyboard.bindings[E].unshift(e.keyboard.bindings[E].pop());
          var i,
            a = _(this.options.selectKeys);
          try {
            for (a.s(); !(i = a.n()).done; ) {
              var s = i.value;
          ...
          e.keyboard.bindings[A].unshift(e.keyboard.bindings[A].pop()),
            e.keyboard.addBinding({ key: O }, this.escapeHandler.bind(this)),
            e.keyboard.addBinding({ key: k }, this.upHandler.bind(this)),
            e.keyboard.addBinding({ key: C }, this.downHandler.bind(this));
        }
        return (
          c(t, [
            {
            ...
            },
            {
              ...
              value: function () {
                var t = this;
                if (-1 !== this.itemIndex) {
                  var e = this.mentionList.childNodes[this.itemIndex].dataset;
                  e.disabled ||
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                if (null !== r) {
                  var i,
                    s = a(a({}, this.options), n);
                  s.showDenotationChar || (r.denotationChar = ""),
                    e
                      ? (i = this.cursorPos)
                  ...
                  return (
                    s.spaceAfterInsert
                      ? (this.quill.insertText(i + 1, " ", o.a.sources.USER),
                        this.quill.setSelection(i + 2, o.a.sources.USER))
                      : this.quill.setSelection(i + 1, o.a.sources.USER),
                    this.hideMentionList(),
                    l
                  );
                }
                ...
                if (this.options.renderLoading())
                  if (
                    ...
                    (t.className = "ql-mention-loading"),
                      N(t, this.options.renderLoading()),
                  ...
                  for (var r = -1, o = 0; o < e.length; o += 1) {
                    ...
                    (i.id = "quill-mention-item-" + o),
                      ...
                      e[o].disabled
                        ...
                        : -1 === r && (r = o),
                      (i.dataset.index = o),
                      N(i, this.options.renderItem(e[o], n)),
                      e[o].disabled
                        ? (i.onmouseenter =
                      ...
                      this.mentionList.appendChild(
                        T(i, e[o], this.options.dataAttributes),
                      );
                  }
                  (this.itemIndex = r),
                    this.highlightItem(),
                      ...
                      r.reduce(
                        function (t, e) {
                          ...
                          if (o && i) {
                            ...
                            r =
                              s !== e
                                ? n.lastIndexOf(s) + s.length - e.length
                                : 0;
                  ...
                  if (
                    ...
                    if (
                      ...
                      this.existingSourceExecutionToken &&
                        ...
                        this.renderLoading();
                      var d = { abandoned: !1 };
                      (this.existingSourceExecutionToken = d),
                        this.options.source(
                          p,
                          function (e, n) {
                            d.abandoned ||
      ...
      o.a.register("modules/mention", S);
    },
    1543: function (t, e, n) {
      ...
      t.exports = (function () {
        ...
        const c = E(Array.prototype.forEach),
          ...
          b = E(Object.prototype.hasOwnProperty),
        ...
        return (function e() {
          ...
          if (
            ((r.version = "3.1.6"),
            (r.removed = []),
            !n || !n.document || n.document.nodeType !== tt)
          )
          ...
          let { IS_ALLOWED_URI: wt } = Y,
            Et = null;
          const At = A({}, [...T, ...N, ...j, ...P, ...D]);
          let Ot = null;
          const kt = A({}, [...L, ...B, ...M, ...F]);
          let Ct = Object.seal(
              s(null, {
          ...
          let re = ne,
            oe = !1,
            ie = null;
          const ae = A({}, [te, ee, ne], d);
          let se = null;
          const le = ["application/xhtml+xml", "text/html"],
            ue = "text/html";
          let ce = null,
            fe = null;
          const he = o.createElement("form"),
            pe = function (t) {
            ...
            de = function () {
              ...
              if (!fe || fe !== t) {
                if (
                  ...
                  (t = k(t)),
                  (se =
                    -1 === le.indexOf(t.PARSER_MEDIA_TYPE)
                      ? ue
                      : t.PARSER_MEDIA_TYPE),
                  (ce = "application/xhtml+xml" === se ? d : p),
                  (Et = b(t, "ALLOWED_TAGS") ? A({}, t.ALLOWED_TAGS, ce) : At),
                  (Ot = b(t, "ALLOWED_ATTR") ? A({}, t.ALLOWED_ATTR, ce) : kt),
                  (ie = b(t, "ALLOWED_NAMESPACES")
                    ? A({}, t.ALLOWED_NAMESPACES, d)
                    : ae),
                  (Qt = b(t, "ADD_URI_SAFE_ATTR")
                    ? A(k(Jt), t.ADD_URI_SAFE_ATTR, ce)
                    : Jt),
                  ($t = b(t, "ADD_DATA_URI_TAGS")
                    ? A(k(Xt), t.ADD_DATA_URI_TAGS, ce)
                    : Xt),
                  (Gt = b(t, "FORBID_CONTENTS")
                    ? A({}, t.FORBID_CONTENTS, ce)
                    : Yt),
                  (Tt = b(t, "FORBID_TAGS") ? A({}, t.FORBID_TAGS, ce) : {}),
                  (Nt = b(t, "FORBID_ATTR") ? A({}, t.FORBID_ATTR, ce) : {}),
                  (Zt = !!b(t, "USE_PROFILES") && t.USE_PROFILES),
                  (jt = !1 !== t.ALLOW_ARIA_ATTR),
                  (St = !1 !== t.ALLOW_DATA_ATTR),
                  (Pt = t.ALLOW_UNKNOWN_PROTOCOLS || !1),
                  (qt = !1 !== t.ALLOW_SELF_CLOSE_IN_ATTR),
                  (Dt = t.SAFE_FOR_TEMPLATES || !1),
                  (Lt = !1 !== t.SAFE_FOR_XML),
                  (Bt = t.WHOLE_DOCUMENT || !1),
                  (Rt = t.RETURN_DOM || !1),
                  (It = t.RETURN_DOM_FRAGMENT || !1),
                  (Ut = t.RETURN_TRUSTED_TYPE || !1),
                  (Ft = t.FORCE_BODY || !1),
                  (Ht = !1 !== t.SANITIZE_DOM),
                  (zt = t.SANITIZE_NAMED_PROPS || !1),
                  (Wt = !1 !== t.KEEP_CONTENT),
                  (Vt = t.IN_PLACE || !1),
                  (wt = t.ALLOWED_URI_REGEXP || K),
                  (re = t.NAMESPACE || ne),
                  ...
                  Zt &&
                    ((Et = A({}, D)),
                    (Ot = []),
                    !0 === Zt.html && (A(Et, T), A(Ot, L)),
                    !0 === Zt.svg && (A(Et, N), A(Ot, B), A(Ot, F)),
                    !0 === Zt.svgFilters && (A(Et, j), A(Ot, B), A(Ot, F)),
                    !0 === Zt.mathMl && (A(Et, P), A(Ot, M), A(Ot, F))),
                  t.ADD_TAGS &&
                    (Et === At && (Et = k(Et)), A(Et, t.ADD_TAGS, ce)),
                  t.ADD_ATTR &&
                    (Ot === kt && (Ot = k(Ot)), A(Ot, t.ADD_ATTR, ce)),
                  t.ADD_URI_SAFE_ATTR && A(Qt, t.ADD_URI_SAFE_ATTR, ce),
                  t.FORBID_CONTENTS &&
                    (Gt === Yt && (Gt = k(Gt)), A(Gt, t.FORBID_CONTENTS, ce)),
                  Wt && (Et["#text"] = !0),
                  Bt && A(Et, ["html", "head", "body"]),
                  Et.table && (A(Et, ["tbody"]), delete Tt.tbody),
                  ...
                  (at = t.TRUSTED_TYPES_POLICY), (st = at.createHTML(""));
                } else
                  void 0 === at && (at = nt(z, l)),
                    null !== at &&
                      "string" == typeof st &&
            ...
            ye = A({}, ["mi", "mo", "mn", "ms", "mtext"]),
            ge = A({}, ["foreignobject", "annotation-xml"]),
            me = A({}, ["title", "style", "font", "a", "script"]),
            ve = A({}, [...N, ...j, ...S]),
            be = A({}, [...P, ...q]),
            xe = function (t) {
              let e = it(t);
              (e && e.tagName) ||
                (e = { namespaceURI: re, tagName: "template" });
              const n = p(t.tagName),
                r = p(e.tagName);
              return (
                !!ie[t.namespaceURI] &&
                  ...
                  : t.namespaceURI === te
                    ? e.namespaceURI === ne
                      ...
                      : e.namespaceURI === ee
                        ...
                        : Boolean(be[n])
                    : t.namespaceURI === ne
                      ? !(e.namespaceURI === ee && !ge[r]) &&
                        !(e.namespaceURI === te && !ye[r]) &&
                        !be[n] &&
                        (me[n] || !ve[n])
                      : !(
                          "application/xhtml+xml" !== se || !ie[t.namespaceURI]
                        ))
              );
            },
            _e = function (t) {
            ...
            Ee = function (t) {
              ...
              "application/xhtml+xml" === se &&
                ...
                (t =
                  ...
                  t +
                  "</body></html>");
              const r = at ? at.createHTML(t) : t;
              if (re === ne)
                try {
                  e = new H().parseFromString(r, se);
                } catch (t) {}
              if (!e || !e.documentElement) {
                e = lt.createDocument(re, "template", null);
                try {
                  e.documentElement.innerHTML = oe ? st : r;
                } catch (t) {}
              }
            ...
            ke = function (t) {
              return "function" == typeof E && t instanceof E;
            },
            Ce = function (t, e, n) {
              pt[t] &&
                c(pt[t], (t) => {
            ...
            Te = function (t) {
              let e = null;
              if ((Ce("beforeSanitizeElements", t, null), Oe(t)))
                return _e(t), !0;
              const n = ce(t.nodeName);
              if (
                (Ce("uponSanitizeElement", t, { tagName: n, allowedTags: Et }),
                t.hasChildNodes() &&
                ...
                return _e(t), !0;
              if (t.nodeType === Q) return _e(t), !0;
              if (Lt && t.nodeType === J && x(/<[/\w]/g, t.data))
                return _e(t), !0;
              if (!Et[n] || Tt[n]) {
                if (!Tt[n] && je(n)) {
                  if (
                ...
                if (Wt && !Gt[n]) {
                  const e = it(t) || t.parentNode,
                    n = ot(t) || t.childNodes;
                  if (n && e)
                    for (let r = n.length - 1; r >= 0; --r) {
                      const o = V(n[r], !0);
                      (o.__removalCount = (t.__removalCount || 0) + 1),
                        e.insertBefore(o, rt(t));
                    }
                }
                return _e(t), !0;
              }
              return t instanceof O && !xe(t)
                ? (_e(t), !0)
            ...
            Ne = function (t, e, n) {
              if (Ht && ("id" === e || "name" === e) && (n in o || n in he))
                return !1;
              if (St && !Nt[e] && x(mt, e));
              else if (jt && x(vt, e));
              else if (!Ot[e] || Nt[e]) {
            ...
            je = function (t) {
              return "annotation-xml" !== t && y(t, _t);
            },
            Se = function (t) {
              ...
              for (; o--; ) {
                ...
                if (
                  ...
                  Ce("uponSanitizeAttribute", t, n),
                  (h = n.attrValue),
                  Lt && x(/((--!?|])>)|<\/(style|title)/i, h))
                ) {
                  we(a, t);
                  continue;
                }
                if (n.forceKeepAttr) continue;
                if ((we(a, t), !n.keepAttr)) continue;
                if (!qt && x(/\/>/i, h)) {
                  we(a, t);
                  continue;
                }
                ...
                if (Ne(p, u, h)) {
                  if (
                    ...
                    if (s);
                      ...
                      switch (z.getAttributeType(p, u)) {
                        case "TrustedHTML":
                          h = at.createHTML(h);
                          break;
                        case "TrustedScriptURL":
                          h = at.createScriptURL(h);
                      }
                  try {
                    s ? t.setAttributeNS(s, a, h) : t.setAttribute(a, h),
                      Oe(t) ? _e(t) : f(r.removed);
                  } catch (t) {}
                }
              }
            ...
            Pe = function t(e) {
              let n = null;
              const r = Ae(e);
              for (Ce("beforeSanitizeShadowDOM", e, null); (n = r.nextNode()); )
                Ce("uponSanitizeShadowNode", n, null),
                  Te(n) || (n.content instanceof u && t(n.content), Se(n));
            ...
            (r.sanitize = function (t) {
              ...
              if (
                ...
                (n = Ee("\x3c!----\x3e")),
                  ...
                  (o.nodeType === $ && "BODY" === o.nodeName) ||
                  "HTML" === o.nodeName
                    ? (n = o)
                    : n.appendChild(o);
              else {
                if (!Rt && !Dt && !Bt && -1 === t.indexOf("<"))
                  return at && Ut ? at.createHTML(t) : t;
                if (((n = Ee(t)), !n)) return Rt ? null : Ut ? st : "";
              }
              n && Ft && _e(n.firstChild);
              const l = Ae(Vt ? t : n);
              for (; (i = l.nextNode()); )
                Te(i) || (i.content instanceof u && Pe(i.content), Se(i));
              if (Vt) return t;
              if (Rt) {
                if (It)
                  for (s = ct.call(n.ownerDocument); n.firstChild; )
                    s.appendChild(n.firstChild);
                else s = n;
                return (
                  (Ot.shadowroot || Ot.shadowrootmode) &&
                    (s = ht.call(a, s, !0)),
                  s
                );
              }
              let f = Bt ? n.outerHTML : n.innerHTML;
              return (
                Bt &&
                  Et["!doctype"] &&
                  n.ownerDocument &&
                  ...
                  x(Z, n.ownerDocument.doctype.name) &&
                  (f = "<!DOCTYPE " + n.ownerDocument.doctype.name + ">\n" + f),
                Dt &&
                  c([dt, yt, gt], (t) => {
                    f = g(f, t, " ");
                  }),
                at && Ut ? at.createHTML(f) : f
              );
            }),
        ...
        F = (function (t) {
          ...
          return (
            ...
            (e.prototype.parseMatches = function (t) {
              ...
              function x(t) {
                "." === t ? (c = 7) : "-" === t ? (c = 6) : D.test(t) || O();
              }
              function _(t) {
                "-" === t || "." === t ? O() : D.test(t) ? (c = 5) : O();
              }
              function w(t) {
                "." === t || "-" === t
                  ? O()
