    ...
    1938: function (t, e, n) {
      ...
      function w() {
        ...
        function u(t, e, n, o) {
          var a = e && e.prototype instanceof d ? e : d,
            ...
            c = new x(o || []);
          return r(i, "_invoke", { value: A(t, n, c) }), i;
        }
        function s(t, e, n) {
          try {
      ...
      var N = function (t) {
        var e = t.rightClickedAnnotation,
          ...
          a = L(
            Object(c.e)(function (t) {
              return [
                ...
                p.a.getSelectedTab(t, "linkModal"),
              ];
            }),
            9,
          ),
          ...
          _ = o.a.createRef(),
          T = o.a.createRef(),
          M = L(Object(r.useState)(""), 2),
          U = M[0],
          D = M[1],
          G = L(Object(r.useState)(""), 2),
          R = G[0],
          B = G[1],
          F = s.a.isAnnotationSelected(e, P),
          H = s.a.getSelectedAnnotations(P),
          K = s.a.getAnnotationManager(P),
          Y = function () {
            I(h.a.closeElement(m.a.LINK_MODAL)),
              D(""),
              s.a.setToolMode(u.a),
              n(null);
          },
          ...
          X = function (t) {
            var n = [],
              r = s.a.getSelectedTextQuads(P);
            if (r) {
              var o = s.a.getSelectedText(P),
                a = function (e) {
                  var a = [];
            ...
            return (
              (!O || F ? H : [e]).forEach(function (e) {
                if (e) {
                  var r = K.getGroupAnnotations(e);
                  if (r.length > 1) {
                    var o = r.filter(function (t) {
                      return t instanceof window.Core.Annotations.Link;
                    });
                    o.length > 0 && s.a.deleteAnnotations(o, P);
                  }
                  var a = W(e.X, e.Y, e.Width, e.Height);
                  a.addAction("U", t),
                    s.a.addAnnotations([a], P),
                    n.push(a),
                    K.groupAnnotations(e, [a]);
                }
              }),
              n
            );
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          (a = e[0]),
                            ...
                            (i.Opacity = 0),
                            (i.Quads = n),
                            (i.Author = s.a.getCurrentUser(P)),
                            i.setContents(r),
                            e.forEach(function (t, e) {
                              t.addAction("U", o),
                                0 === e
                                  ? s.a.addAnnotations([t, i], P)
                                  : s.a.addAnnotations([t], P);
                            }),
                            K.groupAnnotations(i, e, P);
                        case 14:
                        case "end":
                          return t.stop();
                      }
          ...
          J = function (t) {
            if ((t.preventDefault(), U.length)) {
              var e;
              e = s.a.isValidURI(U) ? U : "https://".concat(U);
              var n = new window.Core.Actions.URI({ uri: e }),
                r = X(n).map(function (t) {
                  return t.PageNumber;
                });
              (r = b(new Set(r))).forEach(function (t) {
                s.a.drawAnnotations(t, null, !0, void 0, P);
              }),
                Y();
            }
          },
        ...
        Object(r.useEffect)(
          ...
          Object(r.useEffect)(
            function () {
              "PageNumberPanelButton" === S && A
                ? T.current.focus()
                : "URLPanelButton" === S && A && _.current.focus();
            },
            [S, A, T, _],
          ),
        ...
        var V = i()({ Modal: !0, LinkModal: !0, open: A, closed: !A });
        return g
          ? null
          : o.a.createElement(
              y.a,
              { dataElement: m.a.LINK_MODAL, className: V },
              o.a.createElement(
                v.a,
                {
                  title: C("link.insertLinkOrPage"),
                  isOpen: A,
                  closeHandler: Y,
                  onCloseClick: Y,
                  swipeToClose: !0,
                  ...
                  o.a.createElement(
                    ...
                    "URLPanelButton" === j
                      ...
                      : o.a.createElement(d.a, {
                          ...
                          label: C("action.link"),
                          onClick: Q,
                          disabled: !(null == x ? void 0 : x.includes(R)),
                        }),
                  ),
                ),
              ),
