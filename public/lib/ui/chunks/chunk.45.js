    ...
    1914: function (e, t, n) {
        ...
        T = function (e, t) {
          if (t && t.current) {
            ...
            if (n) {
              ...
              return {
                left: Object(w.a)(u, s) - l,
                top: Object(w.b)(u, s) - a,
              };
            }
          }
        },
      ...
      var H = { annotation: m.a.object, editor: m.a.object },
        M = function (e) {
          var t,
            ...
            l = I(
              Object(p.e)(function (e) {
                return [
                  C.a.isElementDisabled(e, _.a.RICH_TEXT_POPUP),
                  C.a.isElementOpen(e, _.a.RICH_TEXT_POPUP),
                  C.a.isElementDisabled(e, "colorPalette"),
                  C.a.getCustomColors(e, "customColors"),
                  C.a.isInDesktopOnlyMode(e),
                  C.a.isElementOpen(e, _.a.STYLE_POPUP_TEXT_STYLE_CONTAINER),
                  C.a.isElementOpen(e, _.a.STYLE_POPUP_COLORS_CONTAINER),
                  C.a.getFonts(e),
                  !C.a.isElementDisabled(e, _.a.LEGACY_RICH_TEXT_POPUP),
                ];
              }, p.c),
              9,
            ),
            ...
            L = l[7],
            z = l[8],
            H = I(Object(o.useState)(!1), 2),
            M = H[0],
            U = H[1],
            Y = I(Object(o.useState)({ left: 0, top: 0 }), 2),
            W = Y[0],
            q = Y[1],
            V = I(Object(o.useState)({ x: 0, y: 0 }), 2),
            X = V[0],
            G = V[1],
            J = I(Object(o.useState)({}), 2),
            K = J[0],
            Z = J[1],
            $ = Object(o.useRef)(null),
            Q = Object(o.useRef)(null),
            ee = Object(o.useRef)(null),
            te = Object(o.useRef)({}),
            ne = Object(p.d)(),
            oe = Object(o.useRef)(),
            ie = I(Object(o.useState)(n.isAutoSizeFont()), 2),
            re = ie[0],
            ae = ie[1];
          Object(o.useEffect)(function () {
            return (
              ne(R.a.disableElements([_.a.ANNOTATION_STYLE_POPUP])),
              ne(R.a.closeElement(_.a.ANNOTATION_POPUP)),
              function () {
                ne(R.a.enableElements([_.a.ANNOTATION_STYLE_POPUP]));
              }
            );
          }, []),
            Object(o.useEffect)(function () {
              var e = function (e, t) {
                  !e &&
                    t &&
                    Q.current &&
                    Q.current.setSelection(t.index, t.length),
                    e && Q.current && Z(ce(e));
                },
                t = function () {
                  var e, t;
            ...
            Object(o.useEffect)(
              function () {
                var e, t, o, i, a, l, c;
                G({ x: 0, y: 0 }), (Q.current = r), (ee.current = n);
                var p = "solid";
                try {
                  p =
                    "dash" === n.Style
                ...
                (te.current = {
                  ...
                  oe.current &&
                    (Q.current.setSelection(oe.current), (oe.current = null));
              },
              [n, r],
            ),
            Object(o.useEffect)(
              function () {
                var e = function () {
                  ne(R.a.closeElements([_.a.RICH_TEXT_POPUP])),
                    (Q.current = null),
                    (ee.current = null);
                };
                return (
          ...
          var ce = function (e) {
              if (!e) return {};
              var t = Q.current.getFormat(e.index, e.length);
              if ("string" == typeof t.color)
                ...
                t.color = n;
              } else t.color || (t.color = ee.current.TextColor);
              return t;
            },
            pe = function (e) {
              return function () {
                var t = Q.current.getSelection(),
                  n = t.index,
                  o = t.length;
                if (0 === o) {
                  oe.current = { index: n, length: o };
                  var i = Q.current.getSelection();
                  (n = i.index), (o = i.length);
                }
                var r = Q.current.getFormat(n, o);
                se(e, !r[e]);
              };
            },
            ue = function (e, t) {
              se("color", t.toHexString());
            },
            se = function (e, t) {
              var n, o;
              "size" === e
                ...
                : null === (o = Q.current) || void 0 === o || o.format(e, t);
              if (
                ("color" === e && (t = new window.Core.Annotations.Color(t)),
                g.a.isFullPDFEnabled() && "font" === e)
              ) {
                var i = B(B({}, K), {}, { "original-font-family": t });
                return Z(i);
              }
              Z(B(B({}, K), {}, F({}, e, t)));
            },
            ...
            me =
              (F((t = {}), _.a.STYLE_POPUP_TEXT_STYLE_CONTAINER, S),
              F(t, _.a.STYLE_POPUP_COLORS_CONTAINER, D),
              t),
            he = function (e) {
              ne(me[e] ? R.a.closeElement(e) : R.a.openElement(e));
            },
            fe = function () {
              return he(_.a.STYLE_POPUP_TEXT_STYLE_CONTAINER);
            },
            be = function () {
              return he(_.a.STYLE_POPUP_COLORS_CONTAINER);
            };
          return (
            (te.current.bold = K.bold),
            (te.current.italic = K.italic),
            (te.current.underline = K.underline),
            (te.current.strikeout = K.strike),
            (te.current.quillFont =
              K["original-font-family"] || K.font || te.current.Font),
            (te.current.quillFontSize = K.originalSize || te.current.FontSize),
            u || (Object(x.k)() && !v)
              ? null
              : i.a.createElement(
                  a.a,
                      ...
                      : i.a.createElement(
                          ...
                          i.a.createElement(
                            ...
                            i.a.createElement(j.a, {
                              glyph: "icon-chevron-".concat(S ? "up" : "down"),
                            }),
                          ),
                          S &&
                            i.a.createElement(
                              ...
                              i.a.createElement(k.a, {
                                ...
                                properties: te.current,
                                stateless: !0,
                                isFreeText: !0,
                                onFreeTextSizeToggle: function () {
                                  return Object(N.a)(n, ae, re);
                                },
                                isFreeTextAutoSize: re,
                      ...
                      i.a.createElement(P, {
                        onClickHandler: function (e) {
                          var t = Q.current.getSelection(),
                            n = t.index,
                            o = t.length;
                          o > 0 && Q.current.deleteText(n, o),
                            Q.current.insertText(n, e),
                            Q.current.setSelection(n + 1);
                        },
                        maxHeight: 150,
                      }),
                  ),
