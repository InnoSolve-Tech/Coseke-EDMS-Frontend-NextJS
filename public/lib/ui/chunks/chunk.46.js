    ...
    1549: function (e, t, n) {
      ...
      function p() {
        ...
        var v = Object.getPrototypeOf,
          w = v && v(v(j([])));
        w && w !== t && n.call(w, a) && (y = w);
        var b = (m.prototype = g.prototype = Object.create(y));
        function x(e) {
                                  ...
                                  for (;;)
                                    switch ((e.prev = e.next)) {
                                      ...
                                      case 80:
                                        V = e.sent;
                                      case 81:
                                        return (e.next = 83), V.hasNext();
                                      case 83:
                                        if (!e.sent) {
                                          e.next = 275;
                                          break;
                                        }
                                        return (e.next = 86), V.current();
                                      case 86:
                                        return (
                                          (T = e.sent),
                                          (e.next = 89),
      ...
      var R = function (e) {
        ...
        G = function (e) {
          var t,
            ...
            g = p[0],
            h = p[1],
            m = F(Object(r.useState)(!1), 2),
            y = m[0],
            v = m[1],
            w = window.Core.PDFNet,
            b = w.VerificationResult,
            x = w.VerificationOptions.TimeMode,
            S = b.ModificationPermissionsStatus,
            E = F(Object(o.a)(), 1)[0],
            _ = f.signed,
            k = f.signTime,
            L = f.verificationStatus,
            j = f.permissionStatus,
            O = f.disallowedChanges,
            V = f.trustVerificationResultBoolean,
            T = f.timeOfTrustVerificationEnum,
            ...
            H = function () {
              !(function (e) {
                if (e.widgets.length) {
                  ...
                  h({ x1: o.x - r, y1: o.y - i, x2: s.x - r, y2: s.y - i });
                }
              })(d);
            },
            q = Object(N.a)(function () {
              z(s.a.setSignatureValidationModalWidgetName(l)),
                    ...
                    P.a,
                    {
                      labelHeader:
                        ...
                        (n += " "
                          ...
                          .concat(W || E("digitalSignatureModal.unknown"))),
                        k &&
                          (n += " "
      ...
      var Q = function () {
        var e = Object(a.d)(),
          t = J(Object(r.useState)([]), 2),
          n = t[0],
          l = t[1],
          d = J(Object(r.useState)(!1), 2),
          f = d[0],
          p = d[1],
          g = J(Object(r.useState)(""), 2),
          h = g[0],
          y = g[1],
          v = J(Object(r.useState)(c.a.getDocument()), 2),
          w = v[0],
          b = v[1],
          x = J(
          ...
          C = function (e, t) {
            ...
            "add" === t
              ? P(c.a.getAnnotationManager().getAnnotationsList())
              : "delete" === t && n && D(e);
          },
          N = function () {
        ...
        if (
          (Object(r.useEffect)(
            function () {
              return (
                c.a.addEventListener("documentLoaded", V),
                ...
                function () {
                  c.a.removeEventListener("documentLoaded", V),
