    ...
    1615: function (o, e, n) {
      ...
      var N = function (o) {
        var e,
          ...
          w = d[4],
          y = d[5],
          x = j(Object(t.useState)(!1), 2),
          S = x[0],
          P = x[1],
          _ = j(Object(t.useState)(!1), 2),
          I = _[0],
          N = _[1],
          M = j(Object(t.useState)([]), 2),
          R = M[0],
          L = M[1],
          D = y.customizableUI,
          K = j(Object(r.a)(), 1)[0],
        ...
        var z = Object.keys(f).map(function (o) {
        ...
        var U = function (o) {
          var e = K("warning.deleteBookmark.title"),
            n = {
              message: K("warning.deleteBookmark.message"),
              title: e,
              onConfirm: function () {
              ...
              confirmBtnText: K("action.delete"),
            };
          H(A.a.showWarningMessage(n));
        };
        return m
          ? null
          : a.a.createElement(
              ...
              a.a.createElement(
                ...
                a.a.createElement(
                  ...
                  K("component.bookmarksPanel"),
                ),
                !I &&
                  a.a.createElement(k.a, {
                    dataElement: g.a.BOOKMARK_MULTI_SELECT,
                    label: K("action.edit"),
                    disabled: S || 0 === z.length,
                    onClick: function () {
                      return N(!0);
                    },
                    ariaLabel: ""
                      .concat(K("action.edit"), " ")
                      .concat(K("component.bookmarksPanel")),
                  }),
                I &&
                  a.a.createElement(k.a, {
                    dataElement: g.a.BOOKMARK_MULTI_SELECT,
                    label: K("option.bookmarkOutlineControls.done"),
                    disabled: S,
                    onClick: function () {
                      N(!1), L([]);
                    },
                    ariaLabel: ""
                      .concat(K("option.bookmarkOutlineControls.done"), " ")
                      .concat(K("action.edit")),
                  }),
              ),
              ...
              a.a.createElement(
                ...
                S &&
                  a.a.createElement(E, {
                    isAdding: !0,
                    label: ""
                      .concat(K("component.bookmarkPage"), " ")
                      .concat(v[h], " - ")
                      .concat(K("component.bookmarkTitle")),
                    text: null !== (n = f[h]) && void 0 !== n ? n : "",
                    pageIndex: h,
                    onSave: function (o) {
                      s.a.addUserBookmark(h, o), P(!1);
                    },
                    onCancel: function () {
                      return P(!1);
                    },
                ...
                I
                  ? a.a.createElement(
                      ...
                      a.a.createElement(b.a, {
                        ...
                        img: "icon-menu-add",
                        disabled: R.length > 0 || !!f[h] || S,
                        onClick: function () {
                          return P(!0);
                        },
                        ariaLabel: ""
                          .concat(K("action.add"), " ")
                          .concat(K("component.bookmarkPanel")),
                      }),
                      a.a.createElement(b.a, {
                        className: "multi-selection-button",
