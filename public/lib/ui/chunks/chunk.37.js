  ...
  [37],
  {
    ...
    1912: function (t, e, o) {
      ...
      var n = o(0),
        ...
        y = o(42),
        w = o(151),
        x = (o(150), o(104), o(46), o(52), Object(n.createContext)()),
        E = function (t) {
          var e = t.children,
            o = t.keywords,
            a = void 0 === o ? [] : o,
            r = Object(n.useContext)(x).trim();
          return !r ||
            a.some(function (t) {
              ...
              function () {
                if (g) {
                  var t = function (t) {
                    ...
                    e = function () {
                      if (w.size > 0) {
                        var t = Array.from(w).join("+").toLowerCase();
                        b(t);
                      }
                      if ((x(new Set()), f(!1), S)) {
            ...
            i.a.createElement(
              ...
              i.a.createElement(
                ...
                i.a.createElement(T.a, {
                  ...
                  disabled: g,
                  onClick: function (t) {
                    if ((x(new Set()), t.detail > 0)) f(!0), v(!1);
                    else {
                      v(!0);
      ...
      var F = function (t, e, o, n) {
        ...
        z = function () {
          var t = B(
            ...
            C = [
              [f("option.settings.viewing"), v],
              [f("option.settings.annotations"), M],
              [f("option.settings.notesPanel"), T],
              [f("option.settings.search"), A],
              [f("option.settings.pageManipulation"), N],
              [f("option.settings.miscellaneous"), h],
            ],
            k = function (t, e) {
              return [
                t,
                            ...
                            i.a.createElement(w.a, {
                              ...
                              checked:
                                "function" == typeof t.isChecked
                                  ...
                                  : t.isChecked,
                              onChange: function (e) {
                                t.onToggled(e.target.checked), S();
                              },
                            }),
                          ),
                        );
      ...
      var Y = p.a.SETTINGS_MODAL,
        $ = function () {
          var t = q(
              Object(a.e)(function (t) {
                return [
                  d.a.isElementDisabled(t, p.a.SETTINGS_MODAL),
                  d.a.isElementOpen(t, p.a.SETTINGS_MODAL),
                  d.a.getSelectedTab(t, Y),
                  d.a.isElementDisabled(t, p.a.SETTINGS_GENERAL_BUTTON),
                  d.a.isElementDisabled(t, p.a.SETTINGS_KEYBOARD_BUTTON),
                  d.a.isElementDisabled(t, p.a.SETTINGS_ADVANCED_BUTTON),
                ];
              }),
              6,
            ),
