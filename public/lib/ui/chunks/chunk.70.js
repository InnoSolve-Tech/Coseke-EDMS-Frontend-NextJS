    ...
    1940: function (e, t, o) {
      ...
      function O() {
        ...
        function c(e, t, o, a) {
          var r = t && t.prototype instanceof s ? t : s,
            ...
            l = new k(a || []);
          return n(i, "_invoke", { value: w(e, o, l) }), i;
        }
        function p(e, t, o) {
          try {
        ...
        var v = Object.getPrototypeOf,
          b = v && v(v(L([])));
        b && b !== t && o.call(b, r) && (h = b);
        var g = (f.prototype = s.prototype = Object.create(h));
        function y(e) {
                ...
                return new t(function (a, i) {
                  !(function n(a, r, i, l) {
                    ...
                    if ("throw" !== d.type) {
                      var c = d.arg,
                        u = c.value;
                      return u && "object" == _(u) && o.call(u, "__await")
        ...
        function w(e, t, o) {
          ...
          return function (a, r) {
            ...
            for (o.method = a, o.arg = r; ; ) {
              ...
              if ("normal" === d.type) {
                if (
                  ((n = o.done ? "completed" : "suspendedYield"), d.arg === u)
                )
                  continue;
        ...
        return (
          ...
          (m.displayName = d(f, l, "GeneratorFunction")),
          ...
          (e.mark = function (e) {
            return (
              Object.setPrototypeOf
                ...
                : ((e.__proto__ = f), d(e, l, "GeneratorFunction")),
          ...
          (k.prototype = {
            ...
            finish: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                ...
                if (o.finallyLoc === e)
                  return this.complete(o.completion, o.afterLoc), M(o), u;
              }
            },
            catch: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
            ...
            delegateYield: function (e, t, o) {
              return (
                (this.delegate = { iterator: L(e), resultName: t, nextLoc: o }),
      ...
      var A = "all",
        ...
        P = function () {
          var e = Object(r.f)(),
            ...
            f = L(
              Object(r.e)(function (e) {
                return [
                  i.a.isElementOpen(e, c.a.SAVE_MODAL),
            ...
            _ = f[1],
            j = [D.PDF, D.IMAGE],
            P = L(Object(n.useState)(j), 2),
            T = P[0],
            R = P[1],
            G = L(Object(n.useState)(""), 2),
            z = G[0],
            H = G[1],
            V = L(Object(n.useState)(T[0]), 2),
            W = V[0],
            B = V[1],
            U = L(Object(n.useState)(A), 2),
            q = U[0],
            J = U[1],
            K = L(Object(n.useState)(), 2),
            Y = K[0],
            $ = K[1],
            Q = L(Object(n.useState)(!0), 2),
            X = Q[0],
            Z = Q[1],
            ee = L(Object(n.useState)(!1), 2),
            te = ee[0],
            oe = ee[1],
            ne = L(Object(n.useState)(1), 2),
            ae = ne[0],
            re = ne[1],
            ie = L(Object(n.useState)(""), 2),
            le = ie[0],
            de = ie[1];
          Object(n.useEffect)(
            function () {
              var e = (function () {
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                ...
                                return (
                                  ...
                                  I.includes(i) || R([].concat(j, [D.OFFICE])),
                                  (e.next = 14),
                              ...
                              case 16:
                                a === x.a.OFFICE_EDITOR &&
                                  (R([D.OFFICE_EDITOR, D.PDF]),
                                  B(D.OFFICE_EDITOR));
                              case 17:
                                re(m.a.getTotalPages(_));
                              case 18:
                              case "end":
                                return e.stop();
                            }
                ...
                o = function () {
                  H(""),
                    ...
                    R(j),
                    B(j[0]),
                    t(l.a.closeElement(c.a.SAVE_MODAL));
                };
              return (
                e(),
                m.a.addEventListener("documentUnloaded", o, void 0, _),
                m.a.addEventListener("documentLoaded", e, void 0, _),
                function () {
                  m.a.removeEventListener("documentUnloaded", o, _),
                    m.a.removeEventListener("documentLoaded", e, _);
                }
              );
            },
            [_],
            ...
            Object(n.useEffect)(
              function () {
                var e = m.a.getDocument(_);
                if (Object(y.f)() && e) {
                  B(D.OFFICE_EDITOR);
                  var t = e.getFilename(),
                    o = t.substring(0, t.lastIndexOf(".")) || t;
                  H(o);
                }
              },
              [w],
          ...
          var ce = function () {
              return t(l.a.closeElement(c.a.SAVE_MODAL));
            },
            pe = Object(M.a)(ce),
            ue = function () {
              return de("");
            },
            se = L(Object(n.useState)(!1), 2),
            me = se[0],
            fe = se[1],
            he = ((le || !me) && q === F) || !z,
            ve = "office" === W.extension || Object(y.f)(),
            be = a.a.createElement(
              "div",
              {
                className: h()("page-number-input-container", { error: !!le }),
              },
              a.a.createElement(
                "label",
                { className: "specifyPagesChoiceLabel" },
                a.a.createElement("span", null, o("option.print.specifyPages")),
                q === F &&
                  a.a.createElement(
                    "span",
              ...
              q === F &&
                a.a.createElement(b.a, {
                  selectedPageNumbers: Y,
                  pageCount: ae,
                  onBlurHandler: $,
                  onSelectedPageNumbersChange: function (e) {
                    me || fe(!0), e.length > 0 && ue();
                  },
                  onError: function () {
                    return de(o("saveModal.pageError") + ae);
                  },
                  pageNumberError: le,
                }),
            );
          return a.a.createElement(
            "div",
            {
              className: h()("SaveModal", { open: w, closed: !w }),
              ...
              a.a.createElement(
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(u.a, {
                    ...
                    padMessageText: !0,
                    messageText:
                      "" === z ? o("saveModal.fileNameCannotBeEmpty") : "",
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      ...
                      a.a.createElement(s.a, {
                        ...
                        label: o("saveModal.includeAnnotation"),
                        onChange: function () {
                          return Z(!X);
                        },
                      }),
                      a.a.createElement(s.a, {
                        ...
                        label: o("saveModal.includeComments"),
                        onChange: function () {
                          return oe(!te);
                        },
                      }),
                    ...
                    z &&
                      ((o =
                        q === F
                          ? null != Y && Y.length
                            ? Y
                            : [m.a.getCurrentPage(_)]
                          : q === N || q === C
                            ? [m.a.getCurrentPage(_)]
                            : S()(1, m.a.getTotalPages(_) + 1, 1)),
                      Object(g.a)(
                        t,
                        {
                          includeAnnotations: X,
                          includeComments: te,
                          filename: z || "untitled",
