    ...
    1927: function (e, t, n) {
      ...
      function M(e) {
        var t = e.scale,
          ...
          p = S(Object(a.useState)(""), 2),
          m = p[0],
          f = p[1],
          b = S(Object(a.useState)(""), 2),
          x = b[0],
          y = b[1],
          M = S(Object(a.useState)(!1), 2),
          E = M[0],
          A = M[1],
          k = S(Object(a.useState)(""), 2),
          j = k[0],
          O = k[1],
        ...
        Object(a.useEffect)(
          function () {
            V.includes(t[0][1]) || Q(V[0], !0);
          },
          [t[0][1]],
        ),
          Object(a.useEffect)(
            function () {
              V.includes(t[0][1]) && !W.includes(t[1][1]) && Q(W[0], !1);
            },
            [t[0][1], t[1][1]],
          ),
          Object(a.useEffect)(
            function () {
              ...
              t[0][0] &&
                ...
                f(
                  E
                    ? v.getFormattedValue(t[0][0], t[0][1], c, !1, !0) || ""
                    : e(t[0][0]) || "",
                ),
                !t[1][0] ||
                  (H && H.current === document.activeElement) ||
                  (E || "ft-in" === t[1][1]
                    ? y(v.getFormattedValue(t[1][0], t[1][1], c, !1, !0) || "")
                    : y(e(t[1][0]) || ""));
            },
            [t, c, H, U, E, I],
          ),
          ...
          Object(a.useEffect)(
            function () {
              if (q || K)
                ...
                Y(U.current.value, !0, function (t) {
                  e = t.pageScale;
                });
                ...
                Y(H.current.value, !1, function (e) {
                  ...
                  $(new v({ pageScale: e, worldScale: n }));
              }
            },
            [E],
          ),
        ...
        var q = !!t[0][0],
          ...
          Q = function (e, n) {
            ...
            (a =
              n && e !== t[0][1]
                ? {
                    value: t[0][0] ? Object(d.c)(t[0][0], t[0][1], e) : t[0][0],
                    unit: e,
                  }
          ...
          X = function (e) {
            var n = e ? t[0][1] : t[1][1];
            return E ? d.i[n] : "ft-in" === n ? d.i["ft-in decimal"] : "";
          },
          Z = function () {
            L(function (e) {
              return !e;
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement("input", {
                      type: E || "ft-in" === t[1][1] ? "text" : "number",
                      min: "0",
                      className: J,
                      value: x,
                      "aria-label": P("insertPageModal.pageDimensions.units"),
      ...
      var I = window.Core.Scale,
        ...
        R = function (e) {
          ...
          Object(a.useEffect)(
            ...
            Object(a.useEffect)(
              function () {
                Y(L), ne(new I(N.getScaleRatioAsArray()));
                var e = p.a.getScalePrecision(N);
                if (e) {
                  var t = Object(d.j)(e);
                  W(t);
                  var n = d.r[me(t)].find(function (t) {
                    return t[1] === e;
                  });
                  G(n),
                    setTimeout(function () {
            ...
            Object(a.useEffect)(
              function () {
                !y &&
                  H &&
                  (ne(new I(H)),
                  b(m.a.updateCalibrationInfo({ isCalibration: !1 })),
                  W(F));
              },
              [y],
            ),
            ...
            Object(a.useEffect)(
              function () {
                v && R && !H && (Y(L), ne(d.l), W(!1), G(d.r[d.a.DECIMAL][0]));
              },
              [v, R],
            );
          var ce = function () {
              b(m.a.closeElement(A.a.SCALE_MODAL));
            },
            le = function () {
              var e = function (e, t) {
                var n = e,
            ...
            be =
              ...
              !(
                d.e.includes(
                  null === (t = te.pageScale) || void 0 === t ? void 0 : t.unit,
                ) &&
                d.e.includes(
                  null === (n = te.worldScale) || void 0 === n
                    ? void 0
                    : n.unit,
                )
              );
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement(c.a, {
                          ...
                          checked: de,
                          label: "".concat(
                            h("option.measurement.scaleModal.custom"),
                            ":",
                          ),
                          center: !0,
                        }),
                          ...
                          "button",
                          {
                            ...
                            onClick: function () {
                              ...
                              b(
                                ...
                                b(m.a.setIsElementHidden(A.a.SCALE_MODAL, !0));
                            },
                          },
                          h("option.measurement.scaleModal.calibrate"),
                        ),
                    ),
                    de
                      ? o.a.createElement(E, {
                          scale: te.getScaleRatioAsArray(),
                          onScaleChange: ne,
                          precision: K[1],
                        })
                      : null,
                    o.a.createElement(
                      ...
                      o.a.createElement(c.a, {
                        ...
                        checked: !de,
                        label: "".concat(
                          h("option.measurement.scaleModal.preset"),
                          ":",
                        ),
                        center: !0,
                      }),
                    ...
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement(g.a, {
                          ...
                          ariaLabel: h("option.shared.precision"),
                        }),
                      ),
                    ),
                    o.a.createElement(
                  ...
                  o.a.createElement(
                    "button",
                    {
                      onClick: function () {
                        ...
                        (e = new I(le(), K[1])),
                          (t = [].concat(_(l), [f])),
                          p.a.createAndApplyScale(e, t),
                          ce();
                      },
                      className: "scale-create",
                      "data-element": "createScale",
                      disabled: !fe || (!P && re) || (!R && !oe),
                    },
                    h("action.create"),
                  ),
                ),
