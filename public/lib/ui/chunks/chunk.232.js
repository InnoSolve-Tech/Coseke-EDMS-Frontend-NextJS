      ...
      (function (n, e) {
         ...
         */ (function () {
          ...
          var Yt = (function n(t) {
            var r,
              e = (t =
                null == t ? Gn : Yt.defaults(Gn.Object(), t, Yt.pick(Gn, $n)))
                .Array,
              u = t.Date,
              J = t.Error,
              hn = t.Function,
              ...
              Sn = Yn ? t.Buffer : void 0,
              Ln = t.Symbol,
              Un = t.Uint8Array,
              Tn = Sn ? Sn.allocUnsafe : void 0,
              Pn = Pt(_n.getPrototypeOf, _n),
              Kn = _n.create,
              Vn = mn.propertyIsEnumerable,
              Jn = bn.splice,
              Hn = Ln ? Ln.isConcatSpreadable : void 0,
            ...
            function Yr(n, t, r, e, u, i) {
              ...
              var B = x ? void 0 : (v ? (c ? Vu : Ku) : c ? jf : xf)(n);
              return (
                at(B || n, function (e, u) {
            ...
            function Nu(n, t, r, u, f, a, c, l) {
              var s = 2 & t;
              if (!s && "function" != typeof n) throw new yn(i);
              var v = u ? u.length : 0;
              if (
                (v || ((t &= -97), (u = f = void 0)),
              ...
              if (
                ...
                (f = d[4]),
                !(l = d[9] =
                  void 0 === d[9] ? (s ? 0 : n.length) : fr(d[9] - v, 0)) &&
                  24 & t &&
                  (t &= -25),
                t && 1 != t)
              )
            ...
            var Ei = $e(function (n, t) {
              ...
              Si = $e(function (n, t) {
                ...
                return (
                  To(r) && (r = void 0),
                  To(n) ? ne(n, oe(t, 1, To, !0), void 0, r) : []
                );
              });
            function Li(n, t, r) {
            ...
            var io = Iu(Li),
              oo = Iu(Ci);
            function fo(n, t) {
              return (Wo(n) ? at : te)(n, Yu(t, 3));
            }
            function ao(n, t) {
              return (Wo(n) ? ct : re)(n, Yu(t, 3));
            }
            ...
            var Oo = cu(function (n, t) {
              ...
              Io = $e(function (n, t) {
                return Nu(n, 32, void 0, t, qt(t, Hu(Io)));
              }),
              Ro = $e(function (n, t) {
            ...
            return (
              ...
              (Er.escape = function (n) {
                return (n = cf(n)) && $.test(n) ? n.replace(T, $t) : n;
              }),
              ...
              (Er.size = function (n) {
                if (null == n) return 0;
                if (Bo(n)) return Yo(n) ? Vt(n) : n.length;
                var t = ei(n);
              ...
              (Er.toSafeInteger = function (n) {
                return n
                  ? Hr(uf(n), -9007199254740991, 9007199254740991)
                  : 0 === n
                    ? n
                    : 0;
              }),
              ...
              (Er.trim = function (n, t, r) {
                ...
                var e = Gt(n),
                  u = Gt(t);
                return lu(e, Ut(e, u), Bt(e, u) + 1).join("");
              }),
              (Er.trimEnd = function (n, t, r) {
                ...
                if (!n || !(t = Qe(t))) return n;
                var e = Gt(n);
                return lu(e, 0, Bt(e, Gt(t)) + 1).join("");
              }),
              ...
              (Er.unescape = function (n) {
                return (n = cf(n)) && D.test(n) ? n.replace(B, Ht) : n;
              }),
