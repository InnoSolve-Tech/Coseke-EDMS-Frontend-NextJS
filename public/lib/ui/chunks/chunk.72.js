  ...
  [72],
  {
    ...
    1904: function (e, a, t) {
      ...
      t(23),
        ...
        t(17);
      var r = t(2),
        l = (t(34), t(139), t(24), t(38), t(0)),
        o = t.n(l),
        n = t(43),
        i = t(42),
        c = (t(94), t(107), t(79), t(19)),
        s = t.n(c),
        d = t(74),
        p = t(4),
        u = t.n(p),
      ...
      var S = {
          scales: u.a.arrayOf(u.a.object).isRequired,
          selectedScales: u.a.arrayOf(u.a.string).isRequired,
          onScaleSelected: u.a.func.isRequired,
          onAddingNewScale: u.a.func.isRequired,
        },
        M = window.Core.Scale,
        O = function (e) {
          var a = e.scales,
                ...
                var a = new M(e),
                  t = (function (e) {
                    var a = h.a.getScales(),
                      ...
                      r = new Set();
                    return (
                      a[e.toString()].forEach(function (e) {
                        e instanceof window.Core.Annotations.Annotation &&
                          (r.add(e.PageNumber), t.push(e));
                      }),
                      { measurementsNum: t.length, pages: b(r) }
                    );
                  })(a),
                  l = {
                    message: !!t.pages.length
                      ? o.a.createElement(
                          "div",
                    ...
                    onConfirm: function () {
                      return h.a.deleteScale(a);
                    },
                  };
                O(r.a.showWarningMessage(l));
              }
            },
            j = function (e) {
              var a = h.a.getScalePrecision(e),
                t = M.getFormattedValue(
                  e.pageScale.value,
                  e.pageScale.unit,
                  a,
                  !1,
                ),
                r = M.getFormattedValue(
                  e.worldScale.value,
                  e.worldScale.unit,
                  a,
                  !1,
            ...
            W = S("option.measurement.scaleOverlay.multipleScales");
          if (p.length && !A) {
            var N = new M(p[0]);
            W = j(N);
          }
          var C = g(Object(l.useState)(!1), 2),
            I = C[0],
            k = C[1],
            _ = function () {
              k(function (e) {
                  ...
                  return o.a.createElement(
                    "li",
                    {
                      ...
                      className: s()({
                        ...
                        "option-selected": p.includes(e.toString()),
                      }),
                    },
                    o.a.createElement(
                      "button",
                      {
                        ...
                        onClick: function () {
                          return u(p, e.toString());
                        },
                        onKeyDown: function (a) {
                          ("Enter" !== a.key && " " !== a.key) ||
                            (a.preventDefault(), u(p, e.toString()));
                        },
                      },
                      j(e),
                    ),
                    o.a.createElement(
                      "button",
                      {
                        ...
                        onKeyDown: function (a) {
                          ("Enter" !== a.key && " " !== a.key) ||
                            (a.preventDefault(), P(e.toString()));
                        },
                        disabled: t.length <= 1,
                        "aria-label": ""
                          .concat(S("action.delete"), " ")
                          .concat(e.toString()),
                      },
                ...
                E &&
                  o.a.createElement(
                    ...
                    o.a.createElement(n.a, {
                      onClick: w,
                      label: S("option.measurement.scaleOverlay.addNewScale"),
      ...
      var q = { 'in"': "in", "ft'": "ft" };
      F.propTypes = {
        annotation: u.a.object,
        isOpen: u.a.bool.isRequired,
        selectedTool: u.a.object,
      };
      ...
      function F(e) {
        var a,
          ...
          s = null == t ? void 0 : t.Measure.axis[0].factor,
          d =
          ...
          p = z(
            Object(l.useState)(
              ((null == t ? void 0 : t.getLineLength()) * s || 0).toFixed(2),
            ),
            2,
          ),
          u = p[0],
        ...
        Object(l.useEffect)(
          function () {
            if (t) {
              var e = function () {
                f((t.getLineLength() * s).toFixed(2)), C(j());
              };
              return (
        ...
        var b = function (e) {
          ...
          S = function (e) {
            if (t) {
              ...
              a < t.Precision && ((a = t.Precision), f(a));
          ...
          M = Object(l.useCallback)(
            function (e) {
              if (
                ...
                var a = A();
                t.setLineLength(Math.min(a, e)), E();
              }
              var r, l;
            },
            [t, E, A],
          ...
          A = Object(l.useCallback)(
            function () {
              ...
              var d = Math.abs((e - c) / Math.cos(t.getAngle())),
                p = Math.abs((a - s) / Math.sin(t.getAngle()));
              return Math.min(d, p);
            },
            [t],
          ),
            ...
            C(e.target.value),
              (function (e) {
                var a = e.target.value * (Math.PI / 180) * -1,
                  ...
                  o = Math.cos(a) * r + l.x,
                  n = Math.sin(a) * r + l.y;
                t.setEndPoint(o, n), t.adjustRect(), E();
              })(e),
              g();
          },
            ...
            (function () {
              var e = (t && L(t.Start, t.End)) || 0,
                ...
                r = B.getFormattedValue(
                  t && Math.abs(u * Math.cos(e)),
                  a,
                  null == t ? void 0 : t.Precision,
                ),
                l = B.getFormattedValue(
                  t && Math.abs(u * Math.sin(e)),
                  a,
                  null == t ? void 0 : t.Precision,
                );
              return o.a.createElement(
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(
                    "div",
                    { className: "measurement_list" },
                    i("option.measurementOverlay.xAxis"),
                    ":",
                  ),
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(
                    "div",
                    { className: "measurement_list" },
                    i("option.measurementOverlay.yAxis"),
                    ":",
                  ),
        ...
        annotation: function (e, a, t) {
          return e.annotation || e.selectedTool
            ? (e.annotation &&
                u.a.checkPropTypes(
                  {
                    annotation: u.a.shape({
                      Precision: u.a.number,
                      DisplayUnits: u.a.arrayOf(u.a.string),
                      getContents: u.a.func,
                    }),
                  },
        ...
        selectedTool: function (e, a, t) {
          return e.annotation || e.selectedTool
            ? (e.selectedTool &&
                u.a.checkPropTypes(
                  {
                    selectedTool: u.a.shape({
                      defaults: u.a.shape({ Precision: u.a.number }),
                      Measure: u.a.shape({ unit: u.a.string }),
                    }),
                  },
      ...
      function K(e) {
        ...
        Object(l.useEffect)(
          function () {
            return (
              b(),
              h.a.addEventListener("mouseMove", b),
              function () {
                h.a.removeEventListener("mouseMove", b);
              }
            );
          },
          [i],
            ...
            function (e, a) {
              if (e > S(a)) {
                var t = a.getRect(),
                  ...
                  p = h.a.getPageHeight(s);
                l > d && ((t.x2 = d), (i = d - r)),
                  n > p && ((t.y2 = p), (c = p - o)),
                  i < d ? a.setWidth(i) : a.setWidth(d),
                  c < p ? a.setHeight(c) : a.setHeight(p),
                  a.resize(t),
                  x(a);
              }
            },
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              "div",
              { className: "measurement_list" },
              d("option.measurementOverlay.area"),
              ":",
            ),
            o.a.createElement("div", { className: "measurement" }, f.area),
          ),
          o.a.createElement(
            "div",
            { className: "measurement__detail-item" },
            ...
            o.a.createElement("input", {
              ...
              value: E,
              onChange: function (e) {
                w(e), h.a.getAnnotationManager().selectAnnotation(i);
              },
              onBlur: function (e) {
                return (function (e) {
                  var a = Math.abs(e.target.value),
              ...
              onKeyDown: function (e) {
                "Enter" === e.key &&
                  (w(e), h.a.getAnnotationManager().deselectAnnotation(i));
              },
            }),
            f.unit,
          ),
      ...
      var re = window.Core.Scale,
        le = {
          tempScale: u.a.string,
          onCancelCalibrationMode: u.a.func,
          onApplyCalibration: u.a.func,
        },
        oe = function (e) {
          var a,
            t = e.tempScale,
      ...
      var pe = window.Core.Scale,
        ue = {
          annotations: u.a.arrayOf(u.a.object).isRequired,
          selectedTool: u.a.object,
          updateIsCalibration: u.a.func.isRequired,
          enableOrDisableToolElements: u.a.func.isRequired,
          onScaleSelected: u.a.func.isRequired,
          onCancelCalibrationMode: u.a.func.isRequired,
          onApplyCalibration: u.a.func.isRequired,
          onAddingNewScale: u.a.func.isRequired,
        },
        ve = function (e) {
          var a = e.annotations,
            ...
            S = u[1],
            M = ce(Object(l.useState)(h.a.getScales()), 2),
            O = M[0],
            E = M[1],
            A = !(
          ...
          Object(l.useEffect)(
            ...
            Object(l.useEffect)(
              function () {
                "AnnotationCreateCalibrationMeasurement" === S
                  ? (!f && r(!0), n(!0))
                  : (r(!1), n(!1));
              },
              [S, r, n],
      ...
      function Se(e, a) {
        if (e) {
          if ("string" == typeof e) return Me(e, a);
          var t = Object.prototype.toString.call(e).slice(8, -1);
          return (
            "Object" === t && e.constructor && (t = e.constructor.name),
            "Map" === t || "Set" === t
          ...
          P = (function () {
            ...
            if ("top" === e[0])
              ...
              null != O &&
                ...
                (a.top = M + (null == A ? void 0 : A.offsetTop) - 10 - t || 85);
            }
            if ("right" === e[1])
              (a.left = 0.666 * S),
                E &&
                  ...
                  (a.left = Math.min(
                    (null == E ? void 0 : E.offsetLeft) +
                      ...
                      10 || a.left,
                    S - O.current.getBoundingClientRect().width - 10,
                  ));
            else {
