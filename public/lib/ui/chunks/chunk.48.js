  ...
  [48],
  {
    1490: function (e, t, o) {
      ...
      var S = function (e) {
        ...
        E = { color: d.a.any, ariaTypeLabel: d.a.string },
        T = function (e) {
          var t = e.onColorChange,
            o = e.hasTransparentColor,
            r = void 0 !== o && o,
            c = e.color,
            d = e.activeTool,
            v = e.type,
            g = e.ariaTypeLabel,
            E = Object.values(window.Core.Tools.ToolNames).includes(d)
              ? d
            ...
            A = w(
              Object(u.e)(function (e) {
                return [h.a.getColors(e, E, v)];
              }),
              1,
            )[0],
            O = w(Object(n.useState)(), 2),
            j = O[0],
            R = O[1],
            z = w(Object(n.useState)(!1), 2),
            L = z[0],
            _ = z[1],
            N = Object(n.useRef)(!0);
          Object(n.useEffect)(
          ...
          var F = function () {
              var e = h.a.getCustomColor(T.getState());
              return P(s.a.setCustomColor(null)), e;
            },
            I = Object(n.useCallback)(
              function () {
                P(s.a.openElement("ColorPickerModal"));
                Object(m.c)().addEventListener(
                  ...
                  function e(o) {
                    ...
                    if ("ColorPickerModal" === i && !r) {
                      var l = S(F());
                      if (l)
                        if (A.includes(l)) R(l), t(l);
                        else {
                          var a = [].concat(x(A), [l]);
                          P(s.a.setColors(a, E, v, !0)), R(l), t(l);
                        }
                    }
              ...
              [null == A ? void 0 : A.length, P, R, t, F, v, E],
            ),
            D = Object(y.a)(I),
            M = A.map(function (e) {
          ...
          r && M.push("transparent"),
            j || R("transparent"),
            M.indexOf(j) > 6 && !L && N.current && (_(!0), (N.current = !1));
          var H = M.length <= 7,
            W = !(j && !M.includes(j)),
            B = M.length <= 1 || !W;
          return (
                ...
                M.map(function (e) {
                  ...
                  return e
                    ? i.a.createElement(
                        ...
                        {
                          content: ""
                            .concat(k("option.colorPalette.colorLabel"), " ")
                            .concat(
                              null == e ||
              ...
              i.a.createElement(
                ...
                i.a.createElement(
                  ...
                  i.a.createElement(f.a, {
                    ...
                    title: k("action.addNewColor"),
                    onClick: D,
                    className: "control-button",
                    dataElement: "addCustomColor",
                    ariaLabel: ""
                      .concat(g, " ")
                      .concat(k("action.addNewColor"), " ")
                      .concat(k("action.fromCustomColorPicker")),
                  }),
                  i.a.createElement(f.a, {
                    img: "icon-delete-line",
                    title: k("action.deleteColor"),
                    onClick: function () {
                      var e = S(j),
                        o = x(A),
                        n = o.indexOf(e);
                      if (n > -1) {
                        var i = n === o.length - 1 ? 0 : n + 1;
                        R(A[i]),
                          t(A[i]),
                          o.splice(n, 1),
                          P(s.a.setColors(o, E, v, !0));
                      }
                    },
                    disabled: B,
                    className: "control-button",
                    ...
                    ariaLabel: ""
                      .concat(g, " ")
                      .concat(k("action.deleteColor"), " ")
                      .concat(j),
                  }),
                  i.a.createElement(f.a, {
                    img: "icon-copy2",
                    title: k("action.copySelectedColor"),
                    onClick: function () {
                      var e = S(j),
                        t = [].concat(x(A), [e]);
                      P(s.a.setColors(t, E, v, !0));
                    },
                    disabled: W,
                    className: "control-button",
                    ...
                    ariaLabel: ""
                      .concat(g, " ")
                      .concat(k("action.copySelectedColor"), " ")
                      .concat(j),
                  }),
                ),
                i.a.createElement(
                  ...
                  k(L ? "message.showLess" : "message.showMore"),
                ),
              ),
            )
          );
        ...
        insert: function (e) {
          ...
          for (let n = 0; n < t.length; n++) {
            ...
            if (0 === n)
              ...
              i.shadowRoot.appendChild(t), o.push(t);
            }
          }
        },
        singleton: !1,
    ...
    1617: function (e, t, o) {
      ...
      var C = {
          ...
          editor: a.a.object,
          style: a.a.shape({ TextColor: a.a.string, RichTextStyle: a.a.any }),
        ...
        E = function (e) {
          var t,
            ...
            j = e.editor,
            R = e.style,
            z = e.isFreeTextAutoSize,
            L = e.onFreeTextSizeToggle,
            _ = e.onPropertyChange,
            N = e.onRichTextStyleChange,
            F = e.isRichTextEditMode,
            I = e.setIsRichTextEditMode,
            D = e.isRedaction,
            M = e.isWidget,
            H = e.activeTool,
            W = g(
          ...
          Object(n.useEffect)(function () {
            ...
            return (
              ...
              J(s.a.disableElements([p.a.ANNOTATION_STYLE_POPUP])),
              function () {
                d.a.removeEventListener("editorSelectionChanged", e),
                  d.a.removeEventListener("editorTextChanged", t),
                  J(s.a.enableElements([p.a.ANNOTATION_STYLE_POPUP]));
              }
            );
          }, []),
            Object(n.useEffect)(
              function () {
                var e;
                if (((V.current = j), (q.current = O), F && O)) {
                  var t,
                    o,
                    n,
                    i,
                  ...
                  G.current = {
                    ...
                    underline:
                      (null == c ||
                      null === (n = c["text-decoration"]) ||
                      void 0 === n
                        ? void 0
                        : n.includes("underline")) ||
                      (null == c ||
                ...
                U(
                  ...
                  $.current &&
                    (V.current.setSelection($.current), ($.current = null));
              },
              [O, j, F],
            ),
            Object(n.useEffect)(
              function () {
                var e = function () {
                    (V.current = null), (q.current = null), I(!1);
                  },
                  t = function () {
                    I(!0);
                  };
          ...
          var X,
            Z = function (e) {
              ...
              if ("string" == typeof t.color)
                ...
                var o = new window.Core.Annotations.Color(
                  t.color[t.color.length - 1],
                );
                t.color = o;
              } else t.color || (t.color = q.current.TextColor);
              for (
                var n = 0, i = ["font", "size", "originalSize"];
                n < i.length;
                n++
              ) {
                var r = i[n];
            ...
            ee = function (e, t) {
              ...
              "size" === e
                ? null === (o = V.current) ||
                  void 0 === o ||
                  o.format("applyCustomFontSize", t)
                : null === (n = V.current) || void 0 === n || n.format(e, t);
              "color" === e && (t = new window.Core.Annotations.Color(t)),
                U(w(w({}, Y), {}, v({}, e, t)));
            },
            te = function (e, t) {
              if (K.current) {
                var o = V.current.getSelection(),
                  n = o.index,
                  i = o.length,
                  r = q.current;
                (r[e] = t),
            ...
            ne = {
              ...
              underline:
                ...
                null === (y = oe[0]) ||
                void 0 === y ||
                null === (x = y["text-decoration"]) ||
                void 0 === x
                  ? void 0
                  : x.includes("underline")) ||
                (null == oe ||
                null === (S = oe[0]) ||
                void 0 === S ||
          ...
          (X = w(w({}, R), ne)),
            F &&
              O &&
              ((G.current.bold = Y.bold),
              (G.current.italic = Y.italic),
              (G.current.underline = Y.underline),
              (G.current.strikeout = Y.strike),
              (G.current.quillFont = Y.font || G.current.Font),
              (G.current.quillFontSize = Y.originalSize || G.current.FontSize));
          var ie = {
              fonts: W,
              onPropertyChange: te,
              properties: X,
                    ...
                    !(function (e) {
                      return function () {
                        var t = V.current.getSelection(),
                          ...
                          n = t.length;
                        if (0 === n) {
                          $.current = { index: o, length: n };
                          var i = V.current.getSelection();
                          (o = i.index), (n = i.length);
                        }
                        var r = V.current.getFormat(o, n);
                        ee(e, !r[e]);
                      };
                    })(o[e])();
                } else N(e, t);
              },
              properties: F ? G.current : X,
              isFreeTextAutoSize: z,
              isRichTextEditMode: F,
              isRedaction: D,
              onFreeTextSizeToggle: L,
            },
            le = {
          ...
          return i.a.createElement(
            "div",
            {
              ...
              onMouseDown: function (e) {
                "touchstart" !== e.type && F && e.preventDefault();
              },
            },
            i.a.createElement(
              "div",
              { className: "menu-items" },
              i.a.createElement(m.a, b({}, ie, M ? le : re)),
            ),
            i.a.createElement(c.a, {
              onColorChange: function (e) {
                !(function (e, t) {
                  K.current ? ee("color", t.toHexString()) : _(e, t);
                })("TextColor", new window.Core.Annotations.Color(e));
              },
              color: F ? Y.color : R.TextColor,
              activeTool: H,
              type: "Text",
