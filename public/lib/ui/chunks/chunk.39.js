    ...
    1612: function (e, t, n) {
      ...
      var F = i.a.forwardRef(function (e, t) {
        var n = e.index,
          ...
          S = e.isThumbnailMultiselectEnabled,
        ...
        Object(a.useEffect)(
          function () {
            Q.current && (Z.current = Object(A.a)(Q.current));
          },
          [w, de, ie],
        ),
          Object(a.useEffect)(
            function () {
              Q.current && (ee.current = Object(A.a)(Q.current));
            },
            [W, ie],
          );
        var Ee = W && ie;
            ...
            onClick: function (e) {
              ...
              if (S && !P) {
                var o = e.ctrlKey || e.metaKey,
                  ...
                  a = M(j);
                if (r) {
                  k(R.setThumbnailSelectingPages(!0));
                  var i = c;
                  null === i &&
                    ((i = E - 1), k(R.setShiftKeyThumbnailsPivotIndex(i)));
                  var l = Math.min(i, n),
                    u = Math.max(i, n);
                  a = M(
                    new Set(
                      ...
                      (o || t || G === L.a.THUMBNAIL) &&
                        (0 !== j.length || W
                          ? j.includes(n)
                            ...
                            : a.push(n)
                          : a.push(E - 1)),
                      k(R.setShiftKeyThumbnailsPivotIndex(n)))
                    : (a = [n]);
                var s = a[a.length - 1];
                !W && !r && k(R.setShiftKeyThumbnailsPivotIndex(s)),
                  k(R.setSelectedPageThumbnails(a));
              } else U() && k(R.closeElement("leftPanel"));
              setTimeout(function () {
      ...
      function ce(e) {
        var t,
          ...
          j = A === O.a.XOD,
          S = A === O.a.OFFICE || A === O.a.LEGACY_OFFICE;
        if (!g && c)
          try {
            t =
        ...
        if (
          ...
          j || S || (null != T && T.isWebViewerServerDocument()))
        )
          return i.a.createElement(
            "div",
      ...
      var Ae = function (e) {
        var t = e.panelSelector,
          ...
          S = Object(l.e)(p.a.isDocumentReadOnly),
          P = Object(l.e)(function (e) {
            return p.a.getTotalPages(e, 2);
          }),
          k = Object(l.e)(p.a.getActiveDocumentViewerKey),
          I = Object(l.e)(
          ...
          Ne = Ie[1],
          De = 2 === k ? P : f,
          Re = null == L ? void 0 : L.customizableUI,
          Me = Object(l.d)(),
          _e = {};
        Object(a.useEffect)(function () {
          var e = function (e) {
        ...
        var $e = function () {
          ...
          mt = O ? Number(Ae) + 50 : Number(Ae) + 80,
          pt = !(j || S || N),
          ...
          !A &&
            i.a.createElement(
              ...
              i.a.createElement(w.a, {
                ...
                hideTooltipShortcut: !0,
                onClick: function () {
                  Ae + Number("50") < 1001 && (je(Ae + Number("50")), dt());
                },
