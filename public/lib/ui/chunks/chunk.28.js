  ...
  [28],
  {
    ...
    1450: function (t, e, n) {
      ...
      T(
        ...
        d.Quill.register("modules/keyboard", F, !0);
      var z = d.Quill.import("modules/clipboard"),
        H = window.Core.quillShadowDOMWorkaround,
        G = (function (t) {
          S(n, t);
          var e = P(n);
          function n(t, o) {
            return A(this, n), H(t), e.call(this, t, o);
          }
          return N(n);
        })(z);
      ...
      var U = {
          mention: {
            ...
            renderItem: function (t) {
              ...
              if (((e.innerText = t.value), t.email)) {
          ...
          return r.a.createElement(
            ...
            r.a.createElement(f.a, {
              ...
              ref: function (t) {
                return (
                  t &&
                    (t.getEditor().root.ariaLabel = "".concat(
                      h(d ? "action.reply" : "action.comment"),
                    )),
                  e(t)
                );
              },
              modules: s && s.length > 0 ? U : {},
              theme: "snow",
              value: o,
              placeholder: "".concat(
                h(d ? "action.reply" : "action.comment"),
            ...
            d &&
              ...
              r.a.createElement(m.a, {
                ...
                title: ""
                  .concat(h("action.add"), " ")
                  .concat(h("option.type.fileattachment")),
                onClick: function () {
                  var t;
                  null ===
      ...
      var Q = {
        ...
        X = r.a.forwardRef(function (t, e) {
          var n = Z(
            ...
            i = n[0],
            a = n[1],
            c = Object(o.useContext)(s.a).resize,
            d = Object(o.useRef)(),
            f = Object(o.useRef)();
          ...
          var m = $(
            ...
            {},
            {
              ...
              onChange: u()(function (e, n, o, r) {
                if (((e = e.replace(/&nbsp;/g, " ")), d.current)) {
                  var i = "";
                  if (
                    ...
                    var a,
                      ...
                      u = r.getText().length + c.plainTextValue.length,
                      s =
                        null === (a = d.current) || void 0 === a
                          ? void 0
                          : a.editor;
                    setTimeout(function () {
                      return null == s ? void 0 : s.setSelection(u, u);
                    }, 1);
                  }
                }
              }, 100),
      ...
      (X.displayName = "NoteTextarea"), (X.propTypes = Q);
      var tt = X;
      e.a = tt;
    },
    1476: function (t, e, n) {
    ...
    1478: function (t, e, n) {
      ...
      var h = function (t, e, n) {
          return {
            icon: e,
            label: "option.state.".concat(t.toLowerCase()),
            title: "option.state.".concat(t.toLowerCase()),
            option: t,
            dataElement: n,
          };
        },
        m = [
          ...
          h("None", "icon-annotation-status-none", "noteStateFlyoutNoneOption"),
          h(
            "Marked",
        ...
        b = function (t) {
          var e = t.noteId,
            n = t.handleStateChange,
            i = void 0 === n ? function () {} : n,
            a = t.isMultiSelectMode,
            s = void 0 !== a && a,
            p = Object(r.d)(),
            f = s ? "" : "-".concat(e),
            h = "".concat(l.a.NOTE_STATE_FLYOUT).concat(f),
            b = Object(r.e)(function (t) {
              return u.a.getFlyout(t, h);
            });
          return (
            Object(o.useLayoutEffect)(
              function () {
                ...
                p(b ? c.a.updateFlyout(t.dataElement, t) : c.a.addFlyout(t));
              },
              [i],
            ),
            null
    ...
    1535: function (t, e, n) {
      ...
      var P = function (t, e, n) {
          return {
            icon: e,
            label: "action.".concat(t.toLowerCase()),
            title: "action.".concat(t.toLowerCase()),
            option: t,
            dataElement: n,
          };
        },
        L = [
          P("Edit", "", "notePopupEdit"),
          P("Delete", "", "notePopupDelete"),
        ],
        I = {
          handleEdit: c.a.func,
      ...
      function _(t) {
        var e = t.handleEdit,
          ...
          f = Object(u.e)(function (t) {
            var e;
            return null === (e = x.a.getFeatureFlags(t)) || void 0 === e
              ? void 0
              : e.customizableUI;
          }),
          h = "".concat(q.a.NOTE_POPUP_FLYOUT, "-").concat(d),
          m = S(Object(s.a)(), 1)[0];
        if (!l && !c) return null;
        var b = a()("overflow note-popup-toggle-trigger"),
          y = a()("NotePopup options note-popup-options", {
            "options-reply": p,
            "modular-ui": f,
          });
        return r.a.createElement(
          ...
          r.a.createElement(E.a, {
            dataElement: "notePopup-".concat(d),
            className: b,
            img: "icon-tools-more",
      ...
      var R = function (t) {
        var e = t.flyoutSelector,
          n = t.handleClick,
          r = t.isEditable,
          i = t.isDeletable,
          a = Object(u.d)(),
          l = Object(u.e)(function (t) {
            return x.a.getFlyout(t, e);
          }),
          c = S(Object(s.a)(), 1)[0];
        return (
          Object(o.useLayoutEffect)(
            function () {
              ...
              r
                ? i ||
                  (t = t.filter(function (t) {
                    return "Delete" !== t.option;
                  }))
                : (t = t.filter(function (t) {
                    return "Edit" !== t.option;
                  }));
              var o = {
                dataElement: e,
              ...
              a(l ? k.a.updateFlyout(o.dataElement, o) : k.a.addFlyout(o));
            },
            [r, i],
          ),
          null
      ...
      var U = function (t) {
          var e = z(
              Object(u.e)(function (t) {
                return [x.a.getActiveDocumentViewerKey(t)];
              }),
              1,
            )[0],
            n = t.annotation,
            o = t.setIsEditing,
            i = t.noteIndex,
            a = z(r.a.useState(w.a.canModify(n)), 2),
            l = a[0],
            c = a[1],
            s = z(r.a.useState(w.a.canModifyContents(n)), 2),
            p = s[0],
            d = s[1];
          r.a.useEffect(
            function () {
              function t() {
                c(w.a.canModify(n, e)), d(w.a.canModifyContents(n, e));
              }
              return (
                t(),
          ...
          return r.a.createElement(M, D({}, t, f));
        },
        B = n(1478);
      function W(t, e) {
        return (
      ...
      function $(t) {
        ...
        return r.a.createElement(
          ...
          r.a.createElement(E.a, {
            ...
            img: l,
            toggleElement: "".concat(q.a.NOTE_STATE_FLYOUT, "-").concat(c),
          }),
          r.a.createElement(B.a, { noteId: c, handleStateChange: o }),
        );
      }
      $.propTypes = Y;
      var K = $,
      ...
      var X = { annotation: c.a.object };
      function tt(t) {
        var e = Object(u.e)(function (t) {
            return x.a.getActiveDocumentViewerKey(t);
          }),
          n = Object(u.e)(function (t) {
            return x.a.isElementDisabled(t, "noteState");
          }),
          i = t.annotation,
          a = Object(J.a)(
            Object(o.useCallback)(
              function (t) {
                var n = Object(Z.a)(i, t, e);
                i.addReply(n);
                var o = w.a.getAnnotationManager(e);
                o.addAnnotation(n),
        ...
        return (
          ...
          r.a.createElement(
            "div",
            null,
            r.a.createElement(K, Q({ handleStateChange: a }, t)),
          )
        );
      }
      tt.propTypes = X;
      ...
      var at = {
        ...
        lt = function (t) {
          var e = t.annotationId,
            n = t.ariaLabel,
            i = t.pendingEditTextMap,
            a = t.pendingReplyMap,
            l = t.pendingAttachmentMap,
            c = Object(s.a)().t,
            u = rt(Object(o.useState)(!1), 2),
            p = u[0],
            d = u[1],
            f = rt(Object(o.useState)(!1), 2),
            h = f[0],
            m = f[1],
            b = rt(Object(o.useState)(!1), 2),
            y = b[0],
            g = b[1];
          return (
            Object(o.useEffect)(
              function () {
                var t, n, o;
                d(
                  (null === (t = i[e]) || void 0 === t ? void 0 : t.length) > 0,
                ),
                  m(
                    (null === (n = a[e]) || void 0 === n ? void 0 : n.length) >
                      0,
                  ),
                  g(
                    (null === (o = l[e]) || void 0 === o ? void 0 : o.length) >
                      0,
                  );
              },
              [i, a, l],
      ...
      lt.propTypes = at;
      var ct = lt,
        ut = { annotationId: c.a.string, ariaLabel: c.a.string },
        st = function (t) {
          var e = t.annotationId,
            n = t.ariaLabel,
            o = Object(u.e)(function (t) {
              return x.a.isElementDisabled(t, "unpostedCommentIndicator");
            }),
            i = r.a.useContext(p.a),
      ...
      function Et(t) {
        var e,
          ...
          A = t.isGroupMember,
          S = t.showAnnotationNumbering,
          C = t.timezone,
          P = t.isTrackedChange,
          L = xt(Object(s.a)(), 1)[0],
          I =
            k === yt.a.MODIFIED_DATE || (m && k !== yt.a.CREATED_DATE)
              ? Object(ht.a)(c)
              : c.DateCreated;
        if (C && I) {
          var T = I.toLocaleString("en-US", { timeZone: C });
          o = new Date(T);
        } else o = I;
        var _ = o
            ? h()(o).locale(u).format(p)
            : L("option.notesPanel.noteContent.noDate"),
          R = c.getReplies().length,
          M =
            null === (e = c[l]) ||
            void 0 === e ||
            ...
            void 0 === n
              ? void 0
              : n.call(e);
        E === gt.a.DARK && M && Object(bt.c)(M)
          ? (M = wt.b.white)
          : E === gt.a.LIGHT && M && Object(bt.d)(M) && (M = wt.b.black);
        var D = Object(mt.a)(c.FillColor),
          F = c.getAssociatedNumber(),
          z = "#".concat(F, " - "),
          H = a()("author-and-date", { isReply: b }),
          G = a()("NoteHeader", { parent: !b && !A });
        return r.a.createElement(
          "div",
          { className: G },
          !b &&
                ...
                r.a.createElement(
                  ...
                  R > 0 &&
                    ...
                    r.a.createElement(
                      ...
                      r.a.createElement("div", { className: "num-replies" }, R),
                    ),
                ),
              ),
              r.a.createElement(
                ...
                j &&
                  ...
                  r.a.createElement(dt.a, {
                    ...
                    "aria-label": ""
                      .concat(g(c), " ")
                      .concat(L("option.notesPanel.toggleMultiSelect")),
                    checked: O,
                    onClick: function (t) {
                ...
                r.a.createElement(pt, {
                  annotationId: c.Id,
                  ariaLabel: "Unposted Comment, ".concat(g(c), ", ").concat(_),
                }),
                !v &&
                  !b &&
                  !j &&
                  !A &&
                  !P &&
                  r.a.createElement(et, { annotation: c, isSelected: d }),
                !x &&
                  d &&
                  !j &&
                  !A &&
                ...
                d &&
                  ...
                  r.a.createElement(
                    ...
                    r.a.createElement(ft.a, {
                      title: L("officeEditor.accept"),
                      img: "icon-menu-checkmark",
                      className: "tracked-change-icon-wrapper accept",
                      onClick: function () {
                        return (
                          (t = c.getCustomData(vt.m)),
                          void w.a.getOfficeEditor().acceptTrackedChange(t)
                        );
                        var t;
                      },
                    ...
                    r.a.createElement(ft.a, {
                      title: L("officeEditor.reject"),
                      img: "icon-close",
                      className: "tracked-change-icon-wrapper reject",
                      onClick: function () {
                        return (
                          (t = c.getCustomData(vt.m)),
                          void w.a.getOfficeEditor().rejectTrackedChange(t)
                        );
                        var t;
                      },
                      iconClassName: "tracked-change-icon",
      ...
      var Ct = function (t) {
          var e = At(
            Object(u.e)(function (t) {
              return [x.a.getNotesPanelWidth(t)];
            }, u.c),
            1,
          )[0];
          return r.a.createElement(jt.a, Nt({}, t, { panelWidth: e }));
        },
        Pt = (n(408), n(409), n(161));
      n(212);
      function Lt(t) {
        return (Lt =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
                ...
                return new e(function (r, a) {
                  !(function o(r, i, a, l) {
                    ...
                    if ("throw" !== c.type) {
                      var u = c.arg,
                        p = u.value;
                      return p && "object" == Lt(p) && n.call(p, "__await")
                        ? e.resolve(p.__await).then(
                            function (t) {
                              o("next", t, a, l);
                            },
      ...
      var Rt = "ic-file-pdf",
        ...
        Ht = "ic-file-xls",
        Gt = "ic-file-etc",
        Ut = window.Core.Annotations.FileAttachmentUtils;
      function Bt(t) {
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return t.abrupt(
                      "return",
                      Ut.decompressWithFlateDecode(e.content, e.type),
                    );
                  case 1:
                  case "end":
                    return t.stop();
                ...
                return new e(function (r, a) {
                  !(function o(r, i, a, l) {
                    ...
                    if ("throw" !== c.type) {
                      var u = c.arg,
                        p = u.value;
                      return p && "object" == Qt(p) && n.call(p, "__await")
                        ? e.resolve(p.__await).then(
                            function (t) {
                              o("next", t, a, l);
                            },
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 5:
                        return (
                          (o = []),
                          Jt.a.addHook("uponSanitizeElement", function (t, e) {
                            var n = e.tagName;
                ...
                return new e(function (r, a) {
                  !(function o(r, i, a, l) {
                    ...
                    if ("throw" !== c.type) {
                      var u = c.arg,
                        p = u.value;
                      return p && "object" == re(p) && n.call(p, "__await")
                        ? e.resolve(p.__await).then(
                            function (t) {
                              o("next", t, a, l);
                            },
      ...
      var se = function (t) {
          var e = t.file,
            n = ce(Object(s.a)(), 1)[0],
            i = ce(Object(o.useState)(), 2),
            l = i[0],
            c = i[1],
            u = ce(Object(o.useState)(!1), 2),
            p = u[0],
            d = u[1];
          return (
            Object(o.useEffect)(
          ...
          var e = t.files,
            ...
            i = ce(
              Object(u.e)(function (t) {
                return [
                  x.a.getTabManager(t),
                  x.a.isReplyAttachmentPreviewEnabled(t),
                ];
              }),
              2,
            ),
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          ...
                          break;
                        case 6:
                          return (t.next = 8), Bt(n);
                        case 8:
                          t.t0 = t.sent;
                        case 9:
                          (o = t.t0), Object(Pt.saveAs)(o, n.name);
                        case 11:
                        case "end":
                          return t.stop();
                      }
          ...
          return r.a.createElement(
            ...
            e.map(function (t, e) {
              return r.a.createElement(
                ...
                l && $t(t) && r.a.createElement(se, { file: t }),
                r.a.createElement(
                  "div",
        ...
        he = function (t) {
          var e = {};
          if (
            (t["font-weight"] && "normal" !== t["font-weight"] && (e.bold = !0),
            t["font-style"] && "normal" !== t["font-style"] && (e.italic = !0),
        ...
        me = function (t, e) {
          for (
            var n = t.getRichTextStyle(),
              o = Object.keys(n),
              r = de.a.getFormattedTextFromDeltas(e.getContents()),
              i = de.a.extractMentionDataFromStr(r).plainTextValue,
              a = [],
              l = 0;
            l < o.length;
            l++
            ...
            var c = n[o[l]],
              u = he(c);
            if (!isNaN(o[l])) {
              var s = isNaN(o[l + 1]) ? i.length : o[l + 1],
                p = i.slice(o[l], s);
              a.push({ insert: p, attributes: u });
            }
          }
                ...
                return new e(function (r, a) {
                  !(function o(r, i, a, l) {
                    ...
                    if ("throw" !== c.type) {
                      var u = c.arg,
                        p = u.value;
                      return p && "object" == we(p) && n.call(p, "__await")
                        ? e.resolve(p.__await).then(
                            function (t) {
                              o("next", t, a, l);
                            },
      ...
      var Oe = {
        ...
        je = function (t) {
          var e,
            ...
            q = t.isGroupMember,
            E = Object(u.e)(function (t) {
              return x.a.getNoteDateFormat(t);
            }),
            O = Object(u.e)(function (t) {
              return x.a.getIconColor(t, Object(ye.g)(n), u.c);
            }),
            j = Object(u.e)(function (t) {
              return x.a.isElementDisabled(t, "noteStateFlyout");
            }),
            N = Object(u.e)(function (t) {
              return x.a.getCurrentLanguage(t);
            }),
            A = Object(u.e)(function (t) {
              return x.a.notesShowLastUpdatedDate(t);
            }),
            S = Object(u.e)(function (t) {
              return x.a.isNotesPanelTextCollapsingEnabled(t);
            }),
            C = Object(u.e)(function (t) {
              return x.a.isNotesPanelRepliesCollapsingEnabled(t);
            }),
            P = Object(u.e)(function (t) {
              return x.a.getActiveTheme(t);
            }),
            L = Object(u.e)(function (t) {
              return x.a.getTimezone(t);
            }),
            I = Object(u.e)(function (t) {
              var e;
              return null === (e = x.a.getFeatureFlags(t)) || void 0 === e
                ? void 0
                : e.customizableUI;
            ...
            B = ke(Object(s.a)(), 1)[0],
            W = n.isReply(),
            V = Object(ye.g)(n) === ye.c.TRACKED_CHANGE,
            Y = ke(Object(o.useState)([]), 2),
            $ = Y[0],
            K = Y[1];
          Object(o.useEffect)(
            function () {
          ...
          var Z,
            J = Object(o.useCallback)(
              function (t) {
                ...
                return e ? Pe(e, R) : B("option.notesPanel.noteContent.noName");
              },
              [R],
            ),
            Q = n.getSkipAutoLink && n.getSkipAutoLink(),
            X = Object(o.useCallback)(
              function (t, e, o, i) {
                        ...
                        beforeContent: function () {
                          ...
                          var t =
                            1 === n.TrackedChangeType
                              ? B("officeEditor.added")
                              : B("officeEditor.deleted");
                          return r.a.createElement(
                            "span",
                            {
                              style: {
                ...
                return (
                  ...
                  u < t.length - 1 && c.push(Pe(t, R, e, u)),
                  c
                );
              },
              [R],
            ),
            tt = Object(ye.e)(Object(ye.g)(n)).icon;
          try {
            Z = JSON.parse(n.getCustomData("trn-mention"));
          } catch (t) {
            Z = n.getCustomData("trn-mention");
          }
          var et =
              (null === (e = Z) || void 0 === e ? void 0 : e.contents) ||
              n.getContents(),
            nt = n.getContents(),
            ot = n.getRichTextStyle(),
            rt = n.TextColor;
          if (P === gt.a.DARK)
            rt &&
              Object(bt.c)(rt.toHexString()) &&
              (rt = new window.Core.Annotations.Color(255, 255, 255, 1)),
              ot &&
                Object.keys(ot).forEach(function (t) {
                  ot[t].color &&
                    Object(bt.c)(ot[t].color) &&
                    (ot[t].color = wt.b.white);
                });
          else if (P === gt.a.LIGHT) {
            if (
              (rt &&
                Object(bt.d)(rt.toHexString()) &&
                (rt = new window.Core.Annotations.Color(0, 0, 0, 1)),
              ot)
            )
              Object.keys(ot).forEach(function (t) {
                ot[t].color &&
                  Object(bt.d)(ot[t].color) &&
                  (ot[t].color = wt.b.black);
              });
          }
          var it,
            at = void 0 === D[n.Id];
          ...
          var lt = function (t) {
            ...
            st = n.getCustomData("trn-annot-preview"),
            pt = Object(o.useMemo)(
              function () {
                if ("" === st) return null;
                var t = Pe(st, R),
        ...
        Ae = function (t) {
          var e = t.annotation,
            ...
            f = ke(
              Object(u.e)(function (t) {
                return [
                  x.a.getAutoFocusNoteOnAnnotationSelection(t),
                  x.a.getIsMentionEnabled(t),
                  x.a.isElementDisabled(t, q.a.INLINE_COMMENT_POPUP),
                  x.a.isElementOpen(t, q.a.INLINE_COMMENT_POPUP),
                  x.a.isElementOpen(t, q.a.NOTES_PANEL),
                  x.a.getActiveDocumentViewerKey(t),
                  x.a.isAnyCustomPanelOpen(t),
                ];
              }),
              7,
            ),
            ...
            S = A.setCurAnnotId,
            C = A.pendingAttachmentMap,
            P = A.deleteAttachment,
            L = A.clearAttachments,
            I = A.addAttachments,
            T = !b && y && Object(be.k)();
          Object(o.useEffect)(
            function () {
              if (E || ((g || y) && j.current)) {
                var t = j.current.getEditor();
                e &&
                  ...
                  d
                    ...
                    : t.getContents() &&
                      setTimeout(function () {
                        if (m) {
                          l = de.a.getFormattedTextFromDeltas(t.getContents());
                          var n = de.a.extractMentionDataFromStr(l),
                            o = n.plainTextValue;
                        ...
                        T ||
                          (h &&
                            (null === (r = j.current) ||
                              void 0 === r ||
                              r.focus(),
                            e.getRichTextStyle() && me(e, t)));
                      }, 100);
                var n = t.getLength() - 1;
                if (T) return;
                setTimeout(function () {
                  n && t.setSelection(n, n);
                }, 100);
              }
            },
            [g, y, T],
          ...
          var _ = (function () {
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (l = de.a.getFormattedTextFromDeltas(
                                r.getContents(),
                              )),
                              Object(fe.a)(r, e),
                              l.length > 1 &&
                              ...
                              m
                                ? ((a = de.a.extractMentionDataFromStr(l)),
                                  (u = a.plainTextValue),
                                  (s = a.ids),
                                  de.a
                                    .extractMentionDataFromAnnot(e)
                                    .mentions.forEach(function (t) {
                                      u.includes(t.value) && s.push(t.id);
                                    }),
                                  e.setCustomData(
                                    "trn-mention",
                                    JSON.stringify({ contents: l, ids: s }),
                                  ),
                                  e.setContents(u))
                                : e.setContents(l),
                              (t.next = 11),
            ...
            R = a()("edit-content", { "reply-content": N }),
            M = C[e.Id] || [];
          return r.a.createElement(
            "div",
            { className: R },
            ...
            r.a.createElement(
              ...
              r.a.createElement(ft.a, {
                ...
                onClick: function (t) {
                  t.stopPropagation(), i(!1, n), c(void 0, e.Id), L(e.Id);
                },
              }),
              r.a.createElement(ft.a, {
      ...
      var Se = function (t, e, n) {
        ...
        Pe = function (t, e, n) {
          ...
          var u = l.indexOf(c);
          if (!c.trim() || -1 === u) return Ce(a, n, o);
          var s = [],
            p = [u],
            d = c.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
          if (new RegExp("(".concat(d, ")"), "gi").test(l))
            for (; -1 !== u; )
              -1 !== (u = l.indexOf(c, u + c.length)) && p.push(u);
          return (
            p.forEach(function (t, e) {
              0 === e && 0 !== t && s.push(Ce(a.substring(0, t), n, o)),
                s.push(
                  r.a.createElement(
                    "span",
                    {
                    ...
                    Ce(a.substring(t, t + c.length), n, o + t),
                  ),
                ),
                t + c.length < l.length &&
                  t + c.length !== p[e + 1] &&
                ...
                return new e(function (r, a) {
                  !(function o(r, i, a, l) {
                    ...
                    if ("throw" !== c.type) {
                      var u = c.arg,
                        p = u.value;
                      return p && "object" == Ie(p) && n.call(p, "__await")
                        ? e.resolve(p.__await).then(
                            function (t) {
                              o("next", t, a, l);
                            },
      ...
      var De = { annotation: c.a.object.isRequired },
        Fe = function (t) {
          var e = t.annotation,
            n = t.isUnread,
            ...
            l = Re(
              Object(u.e)(function (t) {
                ...
                return [
                  x.a.getAutoFocusNoteOnAnnotationSelection(t),
                  x.a.isDocumentReadOnly(t),
                  x.a.isElementDisabled(t, "noteReply"),
                  null === (n = x.a.getIsReplyDisabled(t)) || void 0 === n
                    ? void 0
                    : n(e),
                  x.a.getIsMentionEnabled(t),
                  x.a.getIsNoteEditing(t),
                  x.a.isElementDisabled(t, q.a.INLINE_COMMENT_POPUP),
                  x.a.isElementOpen(t, q.a.INLINE_COMMENT_POPUP),
                  x.a.getActiveDocumentViewerKey(t),
                ];
            ...
            O = E.isContentEditable,
            j = E.isSelected,
            N = E.pendingReplyMap,
            A = E.setPendingReply,
            S = E.isExpandedFromSearch,
            C = E.scrollToSelectedAnnot,
            P = E.setCurAnnotId,
            L = E.pendingAttachmentMap,
            I = E.clearAttachments,
            T = E.deleteAttachment,
            _ = Re(Object(o.useState)(!1), 2),
            R = _[0],
            M = _[1],
            D = Object(u.d)(),
            F = Object(o.useRef)(),
          ...
          Object(ge.a)(
            function () {
              R || D(k.a.finishNoteEditing());
            },
            [R],
          ),
            Object(o.useEffect)(
              function () {
                z || (m && j && !O && c && F && F.current && F.current.focus());
              },
              [O, m, j, z],
            ),
            Object(o.useEffect)(function () {
              if (
                (!S &&
                  C &&
                  setTimeout(function () {
                    F && F.current && c && F.current.focus();
                  }, 100),
                F && F.current)
              ) {
                if (z) return;
                var t = F.current.getEditor().getLength() - 1;
                setTimeout(function () {
                  F.current && F.current.editor.setSelection(t, t);
                }, 100);
              }
            }, []);
          var H = (function () {
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            if (
                              (n.preventDefault(),
                              n.stopPropagation(),
                              (o = F.current.getEditor()),
                              (r = de.a.getFormattedTextFromDeltas(
                                o.getContents(),
                              )).trim())
                            ) {
                              t.next = 6;
      ...
      var Ue = {
        ...
        Be = function (t) {
          var e = t.groupAnnotations,
            ...
            h = r.a.createElement(ft.a, {
              onClick: function (t) {
                t.preventDefault(), t.stopPropagation(), d(!0);
              },
            ...
            m = r.a.createElement(ft.a, {
              onClick: function (t) {
                t.preventDefault(), t.stopPropagation(), d(!1);
              },
              className: "text-button",
                      ...
                      ft.a,
                      {
                        ...
                        onClick: function (e) {
                          e.preventDefault(),
                            ...
                            l(k.a.openElement("annotationPopup"));
                        },
                      },
      ...
      var Je = function (t) {
          var e = t.children,
            n = Object($e.a)().querySelector("#line-connector-root"),
            r = document.createElement("div");
          return (
            r.setAttribute("data-element", q.a.ANNOTATION_NOTE_CONNECTOR_LINE),
            Object(o.useEffect)(
              function () {
                return (
                  n.appendChild(r),
        ...
        Qe = function (t) {
          var e = t.annotation,
            ...
            a = Ke(
              Object(u.e)(function (t) {
                return [
                  x.a.getNotesPanelWidth(t),
                  x.a.isElementOpen(t, q.a.ANNOTATION_NOTE_CONNECTOR_LINE),
                  x.a.isElementOpen(t, q.a.NOTES_PANEL),
                  x.a.isElementDisabled(t, q.a.ANNOTATION_NOTE_CONNECTOR_LINE),
                  x.a.getDocumentContainerWidth(t),
                  x.a.getDocumentContainerHeight(t),
                  x.a.getActiveDocumentViewerKey(t),
                ];
              }, u.c),
              7,
            ...
            h = a[6],
            m = Object(u.d)(),
            b = Ke(Object(o.useState)(0), 2),
            y = b[0],
            g = b[1],
            v = Ke(Object(o.useState)(0), 2),
            E = v[0],
            O = v[1],
            j = Ke(Object(o.useState)(0), 2),
            N = j[0],
            A = j[1],
            S = Ke(Object(o.useState)(0), 2),
            C = S[0],
            P = S[1],
            L = Ke(Object(o.useState)(0), 2),
            I = L[0],
            T = L[1],
            _ = Ke(Object(o.useState)(0), 2),
            R = _[0],
            M = _[1],
            D = Object(Ye.d)(e, h),
            F = D.bottomRight,
          ...
          if (
            (Object(o.useEffect)(
              function () {
                ...
                if (!(F && z))
                  return function () {
                    m(k.a.closeElement(q.a.ANNOTATION_NOTE_CONNECTOR_LINE));
                  };
                var i = F.x - z.x,
                  a = F.y - z.y,
                  c = window.isApryseWebViewerWebComponent
                    ? Object($e.a)().host.clientWidth
                    : window.innerWidth,
                  u = window.isApryseWebViewerWebComponent
                    ? Object($e.a)().host.offsetTop
                    : 0;
                A(l - 16), O(n.current.getBoundingClientRect().top - u);
                var s = c - l - z.x + 16 + r - i;
                g(0.75 * s);
                var p = e.getNoZoomReferencePoint(),
                  d = e.NoZoom && p.x ? p.x * a : 0;
                P(s - y - H() + d), M(l - 16 + y);
                var f = e.NoZoom && p.y ? p.y * a : 0;
                T(z.y + a / 2 - o - f);
                var b = function () {
                  m(k.a.closeElement(q.a.ANNOTATION_NOTE_CONNECTOR_LINE));
                };
                return (
                  w.a.addEventListener("pageNumberUpdated", b, void 0, h),
                  function () {
                    w.a.removeEventListener("pageNumberUpdated", b, h);
                  }
                );
              },
              [n, l, F, z, d, f, m, h],
            ...
            return r.a.createElement(
              ...
              r.a.createElement("div", {
                ...
                style: { width: y, right: N, top: E },
              }),
              r.a.createElement("div", {
                className: "verticalLine",
                style: { height: G, top: U, right: N + y },
              }),
              r.a.createElement(
                "div",
                {
                  className: "horizontalLine",
                  style: { width: C, right: R, top: I },
                },
      ...
      var cn = {
        ...
        sn = function (t) {
          var e = t.annotation,
            ...
            E = h.isExpandedFromSearch,
            O = h.setCurAnnotId,
            j = Object(o.useRef)(),
            N = Object(o.useRef)(),
            A = an(Object(o.useState)({}), 2),
            S = A[0],
            C = A[1],
            P = Object(o.useRef)([]),
            L = Object(u.d)(),
            ...
            _ = an(
              Object(u.e)(function (t) {
                return [
                  x.a.getNoteTransformFunction(t),
                  x.a.getCustomNoteSelectionFunction(t),
                  x.a.getUnreadAnnotationIdSet(t),
                  x.a.isCommentThreadExpansionEnabled(t),
                  x.a.isRightClickAnnotationPopupEnabled(t),
                  x.a.getActiveDocumentViewerKey(t),
                  x.a.getIsOfficeEditorMode(t),
                  x.a.getOfficeEditorEditMode(t),
                ];
              }, u.c),
              8,
            ),
            ...
            G = _[6],
            U = _[7],
            B = e.getReplies().sort(function (t, e) {
          ...
          B.filter(function (t) {
            ...
            Object(o.useEffect)(function () {
              ...
              (N.current = e), t && Math.round(t) !== Math.round(e) && b();
            }),
            Object(o.useEffect)(function () {
              if (R) {
                var t = Object($e.a)().querySelectorAll(".NotesPanel")[0];
                ...
                R(j.current, n, function () {
                  var t,
                    e = (t = document).createElement.apply(t, arguments),
                    n = "custom-element-".concat(un);
                  return (
                    un++,
                    P.current.push(n),
          ...
          var W = (function () {
                        ...
                        switch ((t.prev = t.next)) {
                          ...
                          case 4:
                            if (
                              ...
                              m ||
                                ...
                                setTimeout(function () {
                                  return L(
                                    k.a.openElement(
                                      q.a.ANNOTATION_NOTE_CONNECTOR_LINE,
                                    ),
                                  );
                                }, 300)),
                              !l || (G && U === vt.o.PREVIEW))
                            ...
                            if (
                              ...
                              z || L(k.a.openElement(q.a.ANNOTATION_POPUP)),
                              !G)
                            ) {
                              t.next = 17;
                              break;
            ...
            Y = a()({
              ...
              "is-multi-selected": n,
              unread: D.has(e.Id) || V,
              disabled: G && U === vt.o.PREVIEW,
            }),
            $ = a()({ replies: !0, hidden: !m });
          Object(o.useEffect)(
            function () {
              i ||
                B.forEach(function (t, e) {
                  var n = y[t.Id];
                  "" !== n && void 0 !== n && m && Q(!0, 1 + e);
                });
            },
            [m, i],
          ),
          ...
          var K = !Object.values(S).some(function (t) {
              return t;
            }),
            Z = function (t) {
              T.has(t.Id) &&
            ...
            Q = Object(o.useCallback)(
              function (t, e) {
                C(function (n) {
                  return en(en({}, n), {}, nn({}, e, t));
                });
              },
              [C],
            ),
            X = w.a.getGroupAnnotations(e, H),
            tt = X.length > 1,
            et = Object(ye.g)(e) === ye.c.TRACKED_CHANGE,
            nt = B.length > 0 ? B[B.length - 1].Id : null;
          return r.a.createElement(
            "div",
            { ref: j, className: Y, id: "note_".concat(e.Id) },
            r.a.createElement(ft.a, {
              className: "note-button",
              onClick: function (t) {
                return W(t);
              },
              ariaLabelledby: "note_".concat(e.Id),
              ariaCurrent: m,
            ...
            r.a.createElement(Le, {
              ...
              setIsEditing: Q,
              isEditing: S[0],
              isNonReplyNoteRead: !D.has(e.Id),
              isUnread: D.has(e.Id) || V,
    ...
    1924: function (t, e, n) {
      ...
      var O = {
        ...
        j = function (t) {
          var e = t.isMobile,
            ...
            v = t.contextValue,
            w = t.annotationForAttachment,
            q = t.addAttachments,
            E = k(Object(d.a)(), 1)[0],
            O = k(Object(o.useState)(!1), 2),
            j = O[0],
            N = O[1],
            A = Object(g.g)(p) === g.c.TRACKED_CHANGE,
            S = r.a.createElement(
              "div",
              {
                className: u()({
      ...
      var Y = { annotation: p.a.object, closeAndReset: p.a.func },
        $ = function (t) {
          var e = t.annotation,
            n = t.closeAndReset,
            a = B(
            ...
            h = a[7],
            m = Object(i.d)(),
            b = B(Object(o.useState)({ left: 0, top: 0 }), 2),
            g = b[0],
            v = b[1],
            w = Object(o.useRef)(),
            x = Object(T.k)(),
            q = x || !!T.l || T.e,
            k = l || (c && u && "notesPanel" === s);
          Object(P.a)(w, function (t) {
            var n = Object(_.a)().querySelector('[data-element="notesPanel"]'),
              o = null == n ? void 0 : n.contains(t.target),
              r = Object(_.a)().querySelector(
                '[data-element="noteStateFlyout-'.concat(e.Id, '"]'),
              ),
              i = null == r ? void 0 : r.contains(t.target),
              a = Object(C.b)(),
              l = Object(C.d)(),
              c = Object(C.c)();
            o ||
              ...
              c ||
              a ||
              m(L.a.closeElement(y.a.INLINE_COMMENT_POPUP));
          });
          var E = !k,
            O = function () {
            ...
            W = function (t, e) {
              H(function (n) {
                return G(
                  G({}, n),
                  {},
                  U({}, t, [].concat(z(n[t] || []), z(e))),
                );
              });
            },
            V = B(Object(o.useState)(void 0), 2),
            Y = V[0],
            $ = V[1],
            K = B(Object(o.useState)({}), 2),
            Z = K[0],
            J = K[1],
            Q = Object(o.useCallback)(
              function (t, e) {
