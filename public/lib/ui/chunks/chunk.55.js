    ...
    1930: function (o, t, e) {
      ...
      function v(o, t) {
        return (
          ...
          (function (o, t) {
            if (!o) return;
            if ("string" == typeof o) return g(o, t);
            var e = Object.prototype.toString.call(o).slice(8, -1);
            "Object" === e && o.constructor && (e = o.constructor.name);
            if ("Map" === e || "Set" === e) return Array.from(o);
            if (
      ...
      var M = function (o) {
          var t = o.Measure.axis[0].factor;
          switch (o.Scale[1][1]) {
            case "ft-in":
              return (o.getLineLength() * t) / 12;
            case "in":
            default:
              return o.getLineLength() * t;
          }
        },
        C = /^\d*(\.\d*)?$/,
        A = /^\d*(\s\d\/\d*)$/,
        ...
        E = function () {
          var o = v(
              Object(l.e)(function (o) {
                return [
                  h.a.isElementOpen(o, w.a.CALIBRATION_MODAL),
                  h.a.isElementDisabled(o, w.a.CALIBRATION_MODAL),
                  h.a.getMeasurementUnits(o),
                ];
              }, l.c),
              3,
            ),
            ...
            i = o[2],
            u = Object(l.d)(),
            m = v(Object(n.useState)(null), 2),
            g = m[0],
            E = m[1],
            O = v(Object(n.useState)(""), 2),
            S = O[0],
            j = O[1],
            k = v(Object(n.useState)(0), 2),
            I = k[0],
            N = k[1],
            L = v(Object(n.useState)(""), 2),
            T = L[0],
            D = L[1],
            R = v(Object(n.useState)(!1), 2),
            z = R[0],
            F = R[1],
            B = v(Object(d.a)(), 1)[0],
          ...
          Object(n.useEffect)(
            ...
            Object(n.useEffect)(function () {
              var o = function (o, t) {
                "selected" === t
                  ? $(o)
                  : "deselected" === t && (E(null), j(""), D(""), N(0));
              };
              return (
                p.a.addEventListener("annotationSelected", o),
                function () {
                  return p.a.removeEventListener("annotationSelected", o);
                }
              );
            }, []),
            Object(n.useEffect)(
              function () {
                ...
                return (
                  p.a.addEventListener("annotationChanged", o),
                  function () {
                    return p.a.removeEventListener("annotationChanged", o);
                  }
                );
              },
              [g],
          ...
          var $ = function (o) {
              if (
                ...
                "distanceMeasurement" === Object(s.g)(o[0])
              ) {
                var t = o[0];
                E(t);
                var e = M(t).toFixed(2);
                j(e), D(t.Scale[1][1]), N(parseFloat(e));
              }
            },
            U = function (o) {
              return (g.Scale = o), W();
                    ...
                    a.a.createElement(
                      ...
                      a.a.createElement(
                        ...
                        a.a.createElement("input", {
                          ...
                          value: S,
                          onChange: function (o) {
                            F(!1), j(o.target.value);
                          },
                          onBlur: function (o) {
                            var t = o.target.value.trim();
                            if (("" === t && F(!0), C.test(t)))
                              0 !== parseFloat(t)
                                ? (N(parseFloat(t)), j(t))
                                : F(!0);
                    ...
                    a.a.createElement(
                      ...
                      a.a.createElement(c.a, {
                        ...
                        onClick: function () {
                          var o = W(),
                            t = U(o);
                          p.a.setAnnotationStyles(g, { Scale: t }),
                            Object(b.a)(
