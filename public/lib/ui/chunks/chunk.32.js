        ...
        (t.default = function (e) {
          for (
            ...
            for (var I = d.getSizeAndPositionOfCell(y), T = n; T <= l; T++) {
              var b = r.getSizeAndPositionOfCell(T),
                z = T >= S.start && T <= S.stop && y >= v.start && y <= v.stop,
                R = "".concat(y, "-").concat(T),
                w = void 0;
              m && h[R]
                ? (w = h[R])
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        (R === this._horizontalScrollBarSize &&
                          ...
                          (I.overflowX = T + z <= v ? "hidden" : "auto"),
                          (I.overflowY = b + R <= c ? "hidden" : "auto");
                      ...
                      value: function () {
                        ...
                        if (((this._childrenToDisplay = []), i > 0 && d > 0)) {
                          ...
                          var T = s({
                            ...
                            z = T.overscanStartIndex,
                            R = T.overscanStopIndex,
                            w = b.overscanStartIndex,
                            O = b.overscanStopIndex;
                          if (l) {
                            if (!l.hasFixedHeight())
                              for (var x = w; x <= O; x++)
                                if (!l.has(x, 0)) {
