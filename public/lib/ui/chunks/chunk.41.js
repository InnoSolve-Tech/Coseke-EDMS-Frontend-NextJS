  ...
  [41],
  {
    ...
    1910: function (t, e, n) {
      ...
      var o = n(0),
        ...
        O = n(51),
        x = n(21),
        P = (n(35), n(27), n(28), n(25), n(32), n(53), n(57), n(54), n(172)),
        S = n.n(P),
        T = n(19),
        C = n.n(T),
        N = n(288),
        ...
        ot = function (t) {
          ...
          if (
            ...
            var Gt,
              ...
              Qt,
              Zt,
              te = y.getRichTextStyle(),
              ee = y.isAutoSizeFont(),
              ne = y.getCalculatedFontSize();
            Wt = {
              Font: y.Font,
              FontSize: y.FontSize,
              ...
              bold:
                null !==
                  (Gt =
                    "bold" ===
                    (null == te || null === (Yt = te[0]) || void 0 === Yt
                      ? void 0
                      : Yt["font-weight"])) &&
                void 0 !== Gt &&
                Gt,
              italic:
                null !==
                  (Vt =
                    "italic" ===
                    (null == te || null === (Ht = te[0]) || void 0 === Ht
                      ? void 0
                      : Ht["font-style"])) &&
                void 0 !== Vt &&
                Vt,
              underline:
                ...
                null === (Kt = te[0]) ||
                void 0 === Kt ||
                null === (qt = Kt["text-decoration"]) ||
                void 0 === qt
                  ? void 0
                  : qt.includes("underline")) ||
                (null == te ||
                null === ($t = te[0]) ||
                void 0 === $t ||
                null === (Jt = $t["text-decoration"]) ||
                void 0 === Jt
                  ? void 0
                  : Jt.includes("word")),
              strikeout:
                null !==
                  (Xt =
                    ...
                    null === (Qt = te[0]) ||
                    void 0 === Qt ||
                    null === (Zt = Qt["text-decoration"]) ||
                    void 0 === Zt
                      ? void 0
                      : Zt.includes("line-through")) &&
                void 0 !== Xt &&
                Xt,
              StrokeStyle: Bt,
              isAutoSizeFont: ee,
              calculatedFontSize: ne,
            };
          }
          Ft &&
            (Wt = {
      ...
      var pt = window.Core.Tools.ToolNames,
        ...
        mt = function t(e) {
          var n = e.focusedAnnotation,
            ...
            Pt = Y || (X && Q && "notesPanel" === Z) || et,
            St = nt.customizableUI;
          Object(g.a)(
            Et,
          ...
          var Nt = !!Object(v.a)("webviewerServerURL", null)
          ...
          if (M || !n) return null;
          var jt = p.a.getSelectedAnnotations(tt),
            _t = jt.length,
            Ft = _t > 1,
            Dt =
            ...
            Yt =
              ...
              (!W || St) &&
              (!Ft || Rt || (Ft && !Ot)) &&
              !Gt.includes(n.ToolName) &&
              !(n instanceof dt.Model3DAnnotation) &&
              !n.isContentEditPlaceholder() &&
              !Bt &&
              !(n instanceof dt.PushButtonWidgetAnnotation),
            Vt = n instanceof dt.EllipseAnnotation || !p.a.isFullPDFEnabled(),
            Ht =
              n.isContentEditPlaceholder() &&
            ...
            qt = p.a.isAnnotationRedactable(n, tt) && !Ft && !j,
            $t = jt.find(function (t) {
              return !t.InReplyTo;
            }),
            Jt = l && Ot && Mt && !j,
            Xt = Rt,
            ...
            Zt = j && Qt && !(n instanceof dt.PushButtonWidgetAnnotation),
            te = l,
            ee = function () {
              Ot
            ...
            oe = l && n.Measure && n instanceof dt.LineAnnotation,
            ie = n instanceof dt.FileAttachmentAnnotation,
            ae = (function () {
              var t = ct(
          ...
          return i.a.createElement(it, {
            ...
            position: mt,
            focusedAnnotation: n,
            multipleAnnotationsSelected: Ft,
            showViewFileButton: kt,
            onViewFile: Lt,
            showCommentButton: zt,
            ...
            showEditStyleButton: Yt,
            isStylePopupOpen: P,
            hideSnapModeCheckbox: Vt,
            ...
            onGroupAnnotations: function () {
              p.a.groupAnnotations($t, jt, tt);
            },
            showUngroupButton: Xt,
            onUngroupAnnotations: function () {
              p.a.ungroupAnnotations(jt, tt);
            },
            showFormFieldButton: Zt,
            ...
            showDeleteButton: te,
            onDeleteAnnotation: ee,
            showLinkButton: ne,
            hasAssociatedLink: L,
            linkAnnotationToURL: function () {
              L
                ? ((Ot ? jt : [n]).forEach(function (t) {
            ...
            showFileDownloadButton: ie,
            downloadFileAttachment: ae,
            showAudioPlayButton: re,
