  ...
  [52],
  {
    ...
    1911: function (t, e, n) {
      ...
      function y() {
        ...
        function l(t, e, n, o) {
          var a = e && e.prototype instanceof u ? e : u,
            ...
            c = new W(o || []);
          return r(i, "_invoke", { value: P(t, n, c) }), i;
        }
        function p(t, e, n) {
          try {
        ...
        var g = Object.getPrototypeOf,
          x = g && g(g(S([])));
        x && x !== e && n.call(x, a) && (h = x);
        var w = (f.prototype = u.prototype = Object.create(h));
        function v(t) {
      ...
      var w,
        v,
        k = function (t, e) {
          for (var n = [], r = 1; r <= e; r++) r !== t && n.push(r);
          return n;
        },
        P = function (t, e) {
          var n, r;
          return {
            x1: t.y1 < 0 ? 0 : t.x1,
            x2: (n = e.width - t.x2 < 0 ? 0 : e.width - t.x2) > e.width ? 0 : n,
            y1: t.y1 < 0 ? 0 : t.y1,
            y2:
              (r = e.height - t.y2 < 0 ? 0 : e.height - t.y2) > e.height
                ? 0
                : r,
          };
        },
              ...
              return y().wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (n = l.a.getDocumentViewer()),
                        (r = n.getCurrentPage()),
                        (o = e.getPageCount()),
                        (a = Object(h.b)(r)),
                        (i = l.a.getDocument().getPageInfo(r)),
                        (c = P(a, i)),
                        (t.next = 8),
                        e.cropPages([r], c.y1, c.y2, c.x1, c.x2)
                      );
                    case 8:
                      return (s = k(r, o)), (t.next = 11), e.removePages(s);
                    case 11:
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ...
                        (c = e.getPrintablePDF()),
                        (p = []),
                        null == o || !o.includeComments)
                      ) {
                        t.next = 10;
                        break;
                      }
                      return (t.next = 6), C(n, r, !0);
                    case 6:
                      (d = t.sent), (p = _(r.length)), (t.next = 13);
                      break;
                    case 10:
                      return (
                        (t.next = 12),
                        C(n, r, null == o ? void 0 : o.includeAnnotations)
                      );
                    case 12:
                      d = t.sent;
                    case 13:
                      ...
                      return (t.next = 16), e.extractPages(r, d);
                    case 16:
                      return (
                        (l = t.sent),
                        (t.next = 19),
                        window.Core.createDocument(l, { extension: "pdf" })
                      );
                    case 19:
                      (s = t.sent), (t.next = 34);
                      break;
                    case 22:
                      return (
                        (t.next = 24), e.getFileData({ downloadType: "pdf" })
                      );
                    case 24:
                      return (
                        (u = t.sent),
                        (t.next = 27),
                        window.Core.createDocument(u, { extension: "pdf" })
                      );
                    case 27:
                      return (s = t.sent), (t.next = 30), s.extractPages(r, d);
                    case 30:
                      return (
                        (l = t.sent),
                        (t.next = 33),
                    ...
                    case 33:
                      s = t.sent;
                    case 34:
                      if (null == o || !o.isCurrentView) {
                        t.next = 39;
                        break;
                      }
                      return (t.next = 37), E(s);
                    case 37:
                      (s = t.sent), (p = _(s.getPageCount()));
                    case 39:
                      if (!a) {
                        t.next = 44;
                        break;
                      }
                      return s.setWatermark(a), (t.next = 43), L(s);
                    case 43:
                      s = t.sent;
                    case 44:
                      if (
                    ...
                    case 51:
                      if (
                        null == o ||
                        !o.includeComments ||
                        (null != o && o.includeAnnotations)
                      ) {
                        t.next = 62;
                        break;
                      }
                      return (t.next = 54), s.formatDocumentForPrint(p);
                    case 54:
                      return (
                        (s = t.sent),
                        (p = _(s.getPageCount())),
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      ...
                      return (
                        (o = e.getRegisteredAnnotationTypes()),
                        (a = Object.keys(o).reduce(function (t, e) {
                          return (
                            o[e].forEach(function (e) {
                              Object.getPrototypeOf(e.prototype) ===
                                window.Core.Annotations.CustomAnnotation
                                  .prototype &&
                                (t.push({
                                  originalSerializationMode:
                                    e.SerializationType,
                                  customType: e,
                                }),
                                (e.SerializationType =
                                  window.Core.Annotations.CustomAnnotation.SerializationTypes.STAMP));
                            }),
                            t
                          );
                        }, [])),
                        (i = e.getAnnotationsList().filter(function (t) {
                          return n.indexOf(t.PageNumber) > -1;
                        })),
                        (t.next = 6),
                        e.exportAnnotations({
                          annotationList: i,
                    ...
                    case 6:
                      return (
                        ...
                        a.forEach(function (t) {
                          t.customType.SerializationType =
                            t.originalSerializationMode;
                        }),
                        t.abrupt("return", c)
                      );
                    case 9:
                      return t.abrupt(
                        "return",
                        '<?xml version="1.0" encoding="UTF-8" ?><xfdf xmlns="http://ns.adobe.com/xfdf/" xml:space="preserve"></xfdf>',
                      );
                    case 10:
                    case "end":
                      return t.stop();
        ...
        W = function (t, e) {
          return t
            .getFileData({ printDocument: !0 })
            .then(function (t) {
              var n = new Uint8Array(t),
                r = new Blob([n], { type: "application/pdf" }),
                o = Object(u.a)().getElementById("print-handler");
              if (((o.src = URL.createObjectURL(r)), !e))
              ...
              (e.location.href = o.src),
                setTimeout(function () {
                  e.print();
                }, 100);
            })
            .catch(function (t) {
              return console.error("Print Error status: ", t);
            });
        },
        S = (function () {
          var t = x(
              ...
              return y().wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 4:
                      return (
                        (p = t.sent).initSecurityHandler(),
                        (t.next = 8),
                        r.create()
                      );
                    case 8:
                      return (d = t.sent), (t.next = 11), p.getPageIterator(1);
                    case 11:
                      u = t.sent;
                    case 13:
                      return (t.next = 15), u.hasNext();
                    case 15:
                      if (!t.sent) {
                        t.next = 148;
                        break;
                      }
                      return (t.next = 18), u.current();
                    case 18:
                      return (m = t.sent), (t.next = 21), m.getCropBox();
                    case 21:
                      return (f = t.sent), (t.next = 24), m.getMediaBox();
                    case 24:
                      return (h = t.sent), (t.next = 27), d.pageCreate(h);
                    case 27:
                      return (
                        (b = t.sent), (t.t0 = b), (t.next = 31), m.getRotation()
                      );
                    case 31:
                      return (
                        (t.t1 = t.sent),
                        (t.next = 34),
                        t.t0.setRotation.call(t.t0, t.t1)
                      );
                    case 34:
                      return (t.next = 36), o.create();
                    case 36:
                      return (g = t.sent), (t.next = 39), a.create();
                    case 39:
                      return (
                        (x = t.sent),
                        (t.next = 42),
                        x.beginOnPage(b, a.WriteMode.e_overlay, !1)
                      );
                    case 42:
                      return (t.next = 44), g.createFormFromDoc(m, d);
                    case 44:
                      return (w = t.sent), (t.next = 47), w.getXObject();
                    case 47:
                      return (
                        (v = t.sent),
                        (t.next = 50),
                        v.putRect("BBox", h.x1, h.y1, h.x2, h.y2)
                      );
                    case 50:
                      return (
                        (t.t2 = v), (t.next = 53), s.createIdentityMatrix()
                      );
                    case 53:
                      return (
                        (t.t3 = t.sent),
                        (t.next = 56),
                        t.t2.putMatrix.call(t.t2, "Matrix", t.t3)
                      );
                    case 56:
                      return (t.next = 58), x.writeElement(w);
                    case 58:
                      return (
                        (t.t4 = g),
                        (t.t5 = h.x1),
                    ...
                    case 63:
                      return (t.t7 = t.sent), (t.next = 66), h.height();
                    case 66:
                      return (
                        (t.t8 = t.sent),
                        (t.next = 69),
                        t.t4.createRect.call(t.t4, t.t5, t.t6, t.t7, t.t8)
                      );
                    case 69:
                      return (k = t.sent), (t.next = 72), k.setPathFill(!0);
                    case 72:
                      return (t.next = 74), k.getGState();
                    case 74:
                      return (
                        (P = t.sent),
                        (t.t9 = P),
                    ...
                    case 78:
                      return (
                        (t.t10 = t.sent),
                        (t.next = 81),
                        t.t9.setFillColorSpace.call(t.t9, t.t10)
                      );
                    case 81:
                      return (t.t11 = P), (t.next = 84), c.init(1, 1, 1);
                    case 84:
                      return (
                        (t.t12 = t.sent),
                        (t.next = 87),
                        t.t11.setFillColorWithColorPt.call(t.t11, t.t12)
                      );
                    case 87:
                      return (t.next = 89), x.writeElement(k);
                    case 89:
                      return (t.next = 91), g.reset();
                    case 91:
                      return (
                        (t.t13 = g),
                        (t.t14 = h.x1),
                    ...
                    case 96:
                      return (t.t16 = t.sent), (t.next = 99), h.height();
                    case 99:
                      return (
                        (t.t17 = t.sent),
                        (t.next = 102),
                        t.t13.createRect.call(t.t13, t.t14, t.t15, t.t16, t.t17)
                      );
                    case 102:
                      return (k = t.sent), (t.next = 105), k.setPathFill(!0);
                    case 105:
                      return (t.next = 107), k.setPathStroke(!1);
                    case 107:
                      return (t.next = 109), k.getGState();
                    case 109:
                      return (
                        (P = t.sent),
                        (t.next = 112),
                        P.setBlendMode(l.BlendMode.e_bl_darken)
                      );
                    case 112:
                      return (t.t18 = P), (t.next = 115), i.createDeviceGray();
                    case 115:
                      return (
                        (t.t19 = t.sent),
                        (t.next = 118),
                        t.t18.setFillColorSpace.call(t.t18, t.t19)
                      );
                    case 118:
                      return (t.t20 = P), (t.next = 121), c.init(0);
                    case 121:
                      return (
                        (t.t21 = t.sent),
                        (t.next = 124),
                        t.t20.setFillColorWithColorPt.call(t.t20, t.t21)
                      );
                    case 124:
                      return (
                        (t.t22 = A),
                    ...
                    case 129:
                      return (
                        ...
                        (t.t26 = v),
                        (t.next = 133),
                        (0, t.t22)(t.t23, t.t24, t.t25, t.t26)
                      );
                    case 133:
                      return (E = t.sent), (t.next = 136), P.setSoftMask(E);
                    case 136:
                      return (t.next = 138), x.writeElement(k);
                    case 138:
                      return (t.next = 140), x.end();
                    case 140:
                      return (t.next = 142), b.setCropBox(f);
                    case 142:
                      return (t.next = 144), d.pagePushBack(b);
                    case 144:
                      return (t.next = 146), u.next();
                    case 146:
                      t.next = 13;
                      break;
                    case 148:
                      return t.abrupt("return", window.Core.createDocument(d));
                    case 149:
                    case "end":
                      return t.stop();
                  }
        ...
        A = (function () {
          var t = x(
            y().mark(function t(e, n, r, o) {
              var a, i, c, s, l, p, d, u, m;
              return y().wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (t.next = 2), o.putRect("BBox", n.x1, n.y1, n.x2, n.y2)
                      );
                    case 2:
                      return (t.next = 4), o.putDict("Group");
                    case 4:
                      return (
                        (a = t.sent), (t.next = 7), o.putMatrix("Matrix", r)
                      );
                    case 7:
                      return (t.next = 9), a.putName("S", "Transparency");
                    case 9:
                      return (t.next = 11), a.putName("CS", "DeviceGray");
                    case 11:
                      return (t.next = 13), a.putBool("I", !0);
                    case 13:
                      return (t.next = 15), e.createIndirectDict();
                    case 15:
                      return (
                        (i = t.sent),
                        (t.next = 18),
                        i.putName("S", "Luminosity")
                      );
                    case 18:
                      return (t.next = 20), i.put("G", o);
                    case 20:
                      return (t.next = 22), i.putArray("BC");
                    case 22:
                      return (c = t.sent), (t.next = 25), c.pushBackNumber(1);
                    case 25:
                      return (t.next = 27), e.createIndirectDict();
                    case 27:
                      return (
                        (s = t.sent),
                        (t.next = 30),
                        s.putNumber("FunctionType", 2)
                      );
                    case 30:
                      return (t.next = 32), s.putArray("Domain");
                    case 32:
                      return (l = t.sent), (t.next = 35), l.pushBackNumber(0);
                    case 35:
                      return (t.next = 37), l.pushBackNumber(1);
                    case 37:
                      return (t.next = 39), s.putArray("Range");
                    case 39:
                      return (p = t.sent), (t.next = 42), p.pushBackNumber(0);
                    case 42:
                      return (t.next = 44), p.pushBackNumber(1);
                    case 44:
                      return (
                        (d = Object(f.a)()), (t.next = 47), s.putNumber("N", d)
                      );
                    case 47:
                      return (t.next = 49), s.putArray("C0");
                    case 49:
                      return (u = t.sent), (t.next = 52), u.pushBackNumber(1);
                    case 52:
                      return (t.next = 54), s.putArray("C1");
                    case 54:
                      return (m = t.sent), (t.next = 57), m.pushBackNumber(0);
                    case 57:
                      return (t.next = 59), i.put("TR", s);
                    case 59:
            ...
            y().mark(function t(e, n) {
              ...
              return y().wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (t.next = 2), e.getFileData(n);
                    case 2:
                      return (
                        (r = t.sent),
                        (o = new Blob([r], { type: "application/pdf" })),
                        (t.next = 6),
                        window.Core.createDocument(o, { extension: "pdf" })
                      );
                    case 6:
      ...
      function J() {
        ...
        function l(t, e, n, o) {
          var a = e && e.prototype instanceof u ? e : u,
            i = Object.create(a.prototype),
            c = new O(o || []);
          return r(i, "_invoke", { value: v(t, n, c) }), i;
        }
        function p(t, e, n) {
          try {
            return { type: "normal", arg: t.call(e, n) };
        ...
        var b = Object.getPrototypeOf,
          y = b && b(b(C([])));
        y && y !== e && n.call(y, a) && (h = y);
        var g = (f.prototype = u.prototype = Object.create(h));
        function x(t) {
          ["next", "throw", "return"].forEach(function (e) {
            s(t, e, function (t) {
              return this._invoke(e, t);
      ...
      var ct = {
        ...
        ht = "isUnderlined",
        bt =
          (at((w = {}), "location", ct.CENTER),
          at(w, st, 48),
          at(w, lt, ""),
          at(w, pt, new window.Core.Annotations.Color(228, 66, 52)),
          at(w, dt, 100),
          at(w, ut, V[0]),
          at(w, mt, !1),
          at(w, ft, !1),
          ...
          w),
        yt =
          (at((v = {}), ct.CENTER, "diagonal"),
          at(v, ct.TOP_LEFT, "headerLeft"),
          at(v, ct.TOP_RIGHT, "headerRight"),
          at(v, ct.TOP_CENTER, "headerCenter"),
          at(v, ct.BOT_LEFT, "footerLeft"),
          at(v, ct.BOT_RIGHT, "footerRight"),
          at(v, ct.BOT_CENTER, "footerCenter"),
          v),
        gt = (function (t) {
          !(function (t, e) {
          ...
          function i(t) {
            ...
            !(function (t, e) {
                ...
                function () {
                  e.props.isVisible
                          ...
                          J().mark(function t() {
                            return J().wrap(function (t) {
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  case 0:
                                    return (t.next = 2), l.a.getWatermark();
                                  case 2:
                    ...
                    : (e.removeWatermarkCreatedByModal(),
                      l.a.setWatermark(e.preExistingWatermark));
                },
              ),
              at(rt(e), "addWatermarks", function () {
                var t = e.createWatermarks(),
                  n = e.props.t;
                l.a.setWatermark(t);
                var r = l.a.getPageHeight(e.props.pageIndexToView + 1),
                  o = 300 / l.a.getPageWidth(e.props.pageIndexToView + 1),
                  a = 300 / r,
                  i = Math.min(a, o),
                  c = e.props.pageIndexToView + 1;
                l.a.getDocument().loadCanvas({
                  pageNumber: c,
                  zoom: i,
                  drawComplete: function (t) {
                    var r = e.canvasContainerRef.current.childNodes;
                    r &&
                      r.length > 0 &&
                      e.canvasContainerRef.current.removeChild(r[0]),
                      (t.style.border =
                        e.canvasContainerRef.current.style.border),
                      (t.style.height =
                        e.canvasContainerRef.current.style.height),
                      (t.style.backgroundColor =
                        e.canvasContainerRef.current.style.backgroundColor),
                      t.setAttribute("role", "img"),
                      t.setAttribute(
                        "aria-label",
                        "".concat(n("action.page"), " ").concat(c),
                      ),
                      e.canvasContainerRef.current.appendChild(t);
                  },
                });
              }),
              at(rt(e), "constructWatermarkOption", function (t) {
                var e = [];
                return (
                  t.isBolded && e.push(l.a.getFontStyles().BOLD),
                  t.isItalic && e.push(l.a.getFontStyles().ITALIC),
                  t.isUnderlined && e.push(l.a.getFontStyles().UNDERLINE),
                  {
                    fontSize: t.fontSize,
                    fontFamily: t.font,
              ...
              at(rt(e), "createWatermarks", function () {
                var t = {};
                return (
              ...
              at(rt(e), "removeWatermarkCreatedByModal", function () {
                l.a.setWatermark({});
              }),
              at(rt(e), "closeModal", function () {
                e.props.modalClosed();
              }),
              at(rt(e), "handleInputChange", function (t, n) {
                var r = K({}, e.state.locationSettings),
              ...
              at(rt(e), "resetForm", function (t) {
                t.preventDefault();
                var n = e.resetLocationSettings();
                e.setState({ locationSettings: n }, function () {
                  return e.addWatermarks();
                });
              }),
              at(rt(e), "onOkPressed", function () {
                e.setState(
              ...
              at(rt(e), "setColorPaletteVisibility", function (t) {
                e.setState({ isColorPaletteVisible: t });
              }),
              at(rt(e), "onLocationChanged", function (t) {
                var n = K({}, e.state.locationSettings);
                Object.keys(n).forEach(function (e) {
                  var r = n[e];
                  (r = K(K({}, r), {}, { isSelected: t === e })), (n[e] = r);
                }),
                  e.setState({ locationSettings: n }, function () {
                    e.addWatermarks();
                  });
              }),
              at(rt(e), "resetLocationSettings", function () {
                var t = {};
                return (
              ...
              at(rt(e), "initializeLocationSettings", function () {
                var t = e.resetLocationSettings();
                return (
                  e.props.watermarkLocations &&
                    Object.keys(ct).forEach(function (n) {
                      var r,
                        o,
                        a = ct[n],
                        i =
                          null !== (r = e.props.watermarkLocations[yt[a]]) &&
                          void 0 !== r &&
                          r;
                      if (i) {
                        var c = e.constructWatermarkOption(i);
                        t[n].text = c.text;
                        var s = i.color.slice(5).replace(")", "").split(","),
                          l = new window.Core.Annotations.Color(
                            s[0],
                            s[1],
                            s[2],
                            s[3],
                        ...
                        (t[n].color = l),
                          (t[n].opacity = c.opacity),
                          (t[n].fontSize = c.fontSize),
                          i.fontStyles &&
                            ((t[n].isBolded = i.fontStyles.includes("BOLD")),
                            (t[n].isItalic = i.fontStyles.includes("ITALIC")),
                            (t[n].isUnderlined =
                              i.fontStyles.includes("UNDERLINE")));
                        var p =
                          null !== (o = i.fontFamily) && void 0 !== o && o;
                        (p && 0 !== p.trim().length) || (t[n] = bt.font);
                      }
                    }),
                  t
                );
              }),
              at(rt(e), "getKeyByValue", function (t, e) {
                return Object.keys(t).find(function (n) {
                  return t[n] === e;
                });
              }),
              at(rt(e), "getCurrentSelectedLocation", function () {
                return Object.keys(e.state.locationSettings).find(function (t) {
                  return e.state.locationSettings[t].isSelected;
                });
              }),
              at(rt(e), "onColorChanged", function (t) {
                var n = e.getCurrentSelectedLocation(),
                  r = e.state.locationSettings[n];
                r[pt] = new window.Core.Annotations.Color(t.R, t.G, t.B);
                var o = K({}, e.state.locationSettings);
                r[lt] ||
                  Object.keys(ct).forEach(function (e) {
                    var n = o[e];
                    n[lt] ||
                      (n[pt] = new window.Core.Annotations.Color(
                        t.R,
                        t.G,
                        t.B,
                      ));
            ...
            return (
              ...
              (e.canvasContainerRef = o.a.createRef()),
              e
            );
          }
          return (
            ...
            (n = [
              {
                ...
                value: function (t) {
                  var e = this;
                  l.a.addEventListener("documentLoaded", this.closeModal),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var e = this.props,
                    n = e.t,
                    r = e.isCustomizableUI,
                    a = this.getCurrentSelectedLocation(),
                    i = this.state.locationSettings[a],
                    c = i[pt].toHexString(),
                    s = Object(m.k)() ? 160 : 314,
                    l = Object(m.k)() ? 328 : 314;
                          ...
                          o.a.createElement(
                            ...
                            o.a.createElement(
                              ...
                              o.a.createElement(Q.a, {
                                ...
                                items: Object.keys(ct),
                                getTranslationLabel: function (t) {
                                  return n(
                                    "option.watermark.locations.".concat(ct[t]),
                                  );
                                },
                            ...
                            o.a.createElement(
                              ...
                              o.a.createElement(
                                ...
                                o.a.createElement(Q.a, {
                                  ...
                                  items: V,
                                  currentSelectionKey: i[ut],
                                  onClickItem: function (e) {
                                    return t.handleInputChange(ut, e);
                                  },
                                  width: s,
                                }),
                              ),
                              ...
                              o.a.createElement(
                                ...
                                o.a.createElement(
                                  ...
                                  o.a.createElement(B.a, {
                                    ...
                                    isActive: i[mt],
                                    onClick: function () {
                                      return t.handleInputChange(mt, !i[mt]);
                                    },
                                  }),
                                  o.a.createElement(B.a, {
                                    ...
                                    isActive: i[ft],
                                    onClick: function () {
                                      return t.handleInputChange(ft, !i[ft]);
                                    },
                                  }),
                                  o.a.createElement(B.a, {
                                    ...
                                    isActive: i[ht],
                                    onClick: function () {
                                      return t.handleInputChange(ht, !i[ht]);
                                    },
                                  }),
                                ),
                              ),
      ...
      at(gt, "propTypes", {
        isVisible: T.a.bool,
        pageIndexToView: T.a.number,
        watermarkLocations: T.a.object,
        modalClosed: T.a.func,
        formSubmitted: T.a.func,
        t: T.a.func.isRequired,
        isCustomizableUI: T.a.bool,
      });
      var xt = Object(z.a)()(gt),
        wt = n(279),
        vt = n(396),
        kt = n(436),
        Pt = n(97);
      ...
      var Ct = function t(e) {
          var n = e.isDisabled,
            p = e.isOpen,
            d = e.isApplyWatermarkDisabled,
            u = e.isFullAPIEnabled,
            m = e.currentPage,
            f = e.printQuality,
            h = e.isGrayscale,
            b = e.setIsGrayscale,
            y = e.setIsCurrentView,
            g = e.isCurrentViewDisabled,
            x = e.includeAnnotations,
            w = e.setIncludeAnnotations,
            v = e.includeComments,
            k = e.setIncludeComments,
            P = e.isWatermarkModalVisible,
            E = e.setIsWatermarkModalVisible,
            O = e.watermarkModalOptions,
            C = e.existingWatermarksRef,
            W = e.setAllowWatermarkModal,
            S = e.closePrintModal,
            A = e.createPagesAndPrint,
            L = e.pagesToPrint,
            _ = e.setPagesToPrint,
            j = e.count,
            D = e.isPrinting,
            F = e.layoutMode,
            R = e.useEmbeddedPrint,
            z = e.pageLabels;
          t.propTypes = {
            isDisabled: T.a.bool,
            isOpen: T.a.bool,
            isApplyWatermarkDisabled: T.a.bool,
            isFullAPIEnabled: T.a.bool,
            currentPage: T.a.number,
            printQuality: T.a.number,
            isGrayscale: T.a.bool,
            setIsGrayscale: T.a.func,
            setIsCurrentView: T.a.func,
            isCurrentViewDisabled: T.a.bool,
            includeAnnotations: T.a.bool,
            setIncludeAnnotations: T.a.func,
            includeComments: T.a.bool,
            setIncludeComments: T.a.func,
            isWatermarkModalVisible: T.a.bool,
            setIsWatermarkModalVisible: T.a.func,
            watermarkModalOptions: T.a.object,
            existingWatermarksRef: T.a.object,
            setAllowWatermarkModal: T.a.func,
            closePrintModal: T.a.func,
            createPagesAndPrint: T.a.func,
            pagesToPrint: T.a.array,
            setPagesToPrint: T.a.func,
            count: T.a.number,
            isPrinting: T.a.bool,
            layoutMode: T.a.string,
            useEmbeddedPrint: T.a.bool,
            pageLabels: T.a.array,
          };
          var G = Object(c.d)(),
            V = Et(Object(vt.a)(), 1)[0],
            Y = Object(r.useRef)(),
            q = Object(r.useRef)(),
            K = Object(r.useRef)(),
            J = Object(r.useRef)(),
            X = Object(r.useRef)(),
            $ = Et(Object(r.useState)(!1), 2),
            Z = $[0],
            tt = $[1],
            et = Et(Object(r.useState)([]), 2),
            nt = et[0],
            rt = et[1],
            ot = Et(Object(r.useState)(""), 2),
            at = ot[0],
            it = ot[1],
            ct = Et(Object(r.useState)(!1), 2),
            st = ct[0],
            lt = ct[1],
            pt = Object(c.e)(function (t) {
              var e;
            ...
            dt = {
              1: "".concat(V("option.print.qualityNormal")),
              2: "".concat(V("option.print.qualityHigh")),
            },
            ut = function (t) {
              E(t);
            },
            mt = Object(N.a)("Modal PrintModal", { isOpen: p }),
            ft = o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement("span", null, V("option.print.specifyPages")),
                st &&
                  o.a.createElement(
                    "span",
                    { className: "specifyPagesExampleLabel" },
                    "- ",
                    V("option.thumbnailPanel.multiSelectPagesExample"),
                  ),
              ),
              st &&
                o.a.createElement(
                  ...
                  o.a.createElement(kt.a, {
                    ...
                    selectedPageNumbers: nt,
                    pageCount: l.a.getTotalPages(),
                    ...
                    onError: function (t) {
                      t &&
                        it(
                          ""
                            .concat(V("message.errorPageNumber"), " ")
                            .concat(l.a.getTotalPages()),
                        );
                    },
                    pageNumberError: at,
                    customPageLabels: z,
          ...
          var ht = function () {
            var t,
              ...
              c = [];
            if (
              (y(null === (t = X.current) || void 0 === t ? void 0 : t.checked),
              lt(null === (e = K.current) || void 0 === e ? void 0 : e.checked),
              (null !== (n = Y.current) && void 0 !== n && n.checked) ||
                (null !== (r = X.current) && void 0 !== r && r.checked && Z))
            )
              for (var s = 1; s <= l.a.getTotalPages(); s++) c.push(s);
            else if (null !== (o = q.current) && void 0 !== o && o.checked) {
              var p = l.a.getTotalPages();
              switch (F) {
                case I.a.FacingCover:
                case I.a.FacingCoverContinuous:
                  1 === m || (m === p && p % 2 == 0)
                    ? c.push(m)
                    : (c = m % 2 ? [m - 1, m] : [m, m + 1]);
                  break;
                case I.a.FacingContinuous:
                case I.a.Facing:
                  m === p && p % 2 == 1
                    ? c.push(m)
                    : (c = m % 2 ? [m, m + 1] : [m - 1, m]);
              ...
              null !== (a = K.current) && void 0 !== a && a.checked
                ? (c = nt)
                : null !== (i = X.current) &&
                  void 0 !== i &&
                  i.checked &&
          ...
          Object(r.useEffect)(function () {
            return (
              ht(),
              l.a.getWatermark().then(function (t) {
                W(null == t || 0 === Object.keys(t).length), (C.current = t);
              }),
              function () {
                l.a.setWatermark(C.current), E(!1);
              }
            );
          }, []),
            Object(r.useEffect)(
              function () {
                "xod" !== l.a.getDocument().getType() && R ? tt(!0) : tt(!1);
              },
              [R],
            );
          var bt = Object(Pt.a)(function () {
            D || ut(!0);
          });
          return n
            ? null
            : o.a.createElement(
                ...
                o.a.createElement(xt, {
                  ...
                  formSubmitted: function (t) {
                    return G(a.a.setWatermarkModalOptions(t));
                  },
                  watermarkLocations: O,
                  isCustomizableUI: pt,
                }),
                o.a.createElement(
                  "div",
                  { className: mt, "data-element": s.a.PRINT_MODAL },
                  o.a.createElement(
                    H.a,
                    {
                      isOpen: p && !P,
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement(
                          ...
                          o.a.createElement(wt.a, {
                            ...
                            name: "pages",
                            radio: !0,
                            label: V("option.print.view"),
                            disabled: g,
                            center: !0,
                            title: V("option.print.printCurrentDisabled"),
                          }),
                          o.a.createElement(wt.a, {
                          ...
                          o.a.createElement(wt.a, {
                            ...
                            name: "annotations",
                            label: V("option.print.includeAnnotations"),
                            disabled: D,
                            onChange: function () {
                              return w(function (t) {
                                return !t;
                              ...
                              u &&
                                o.a.createElement(
                                  ...
                                  o.a.createElement(wt.a, {
                                    ...
                                    id: "print-grayscale",
                                    name: "grayscale",
                                    label: V("option.print.printGrayscale"),
                                    disabled: D,
                                    onChange: function () {
                                      return b(function (t) {
                                        return !t;
                                  ...
                                  o.a.createElement(wt.a, {
                                    ...
                                    id: "include-comments",
                                    name: "comments",
                                    label: V("option.print.includeComments"),
                                    onChange: function () {
                                      return k(function (t) {
                                        return !t;
                                      });
                      ...
                      !Z &&
                        o.a.createElement(
                          ...
                          o.a.createElement(
                            ...
                            "".concat(V("option.print.pageQuality"), ":"),
                          ),
                          o.a.createElement(Q.a, {
                            id: "printQualityOptions",
                            labelledById: "print-quality-options-label",
                            dataElement: "printQualityOptions",
                            items: Object.keys(dt),
                            getDisplayValue: function (t) {
                              return dt[t];
                            },
                            onClickItem: function (t) {
                              G(a.a.setPrintQuality(Number(t)));
                            },
                            currentSelectionKey:
                              null == f ? void 0 : f.toString(),
                            width: 274,
                          }),
                          o.a.createElement(
                            "div",
                ...
                return new e(function (o, i) {
                  !(function r(o, a, i, c) {
                    ...
                    if ("throw" !== s.type) {
                      var l = s.arg,
                        d = l.value;
                      return d && "object" == St(d) && n.call(d, "__await")
                        ? e.resolve(d.__await).then(
                            function (t) {
                              r("next", t, i, c);
                            },
      ...
      var Dt = function () {
        var t = Object(c.d)(),
          ...
          A = e[14],
          L = Object(r.useRef)(),
          _ = jt(Object(r.useState)(!1), 2),
          j = _[0],
          M = _[1],
          D = jt(Object(r.useState)(-1), 2),
          T = D[0],
          N = D[1],
          I = jt(Object(r.useState)(!1), 2),
          F = I[0],
          R = I[1],
          z = jt(Object(r.useState)([]), 2),
          B = z[0],
          G = z[1],
          V = jt(Object(r.useState)(!1), 2),
          H = V[0],
          U = V[1],
          Q = jt(Object(r.useState)(!1), 2),
          Y = Q[0],
          q = Q[1],
          K = jt(Object(r.useState)(!0), 2),
          J = K[0],
          X = K[1],
          $ = jt(Object(r.useState)(!1), 2),
          Z = $[0],
          tt = $[1],
          et = jt(Object(r.useState)(!1), 2),
          nt = et[0],
          rt = et[1],
          ot = jt(Object(r.useState)(!1), 2),
          at = ot[0],
          it = ot[1];
        Object(r.useEffect)(
          function () {
            var t, e, n;
            y &&
              (X(null !== (t = y.includeAnnotations) && void 0 !== t ? t : J),
              tt(null !== (e = y.includeComments) && void 0 !== e ? e : Z),
              R(
                null !== (n = y.maintainPageOrientation) && void 0 !== n
                  ? n
                  : F,
              ));
          },
        ...
        var st = function () {
            if (!at) {
              var t = l.a.getDisplayModeObject().getVisiblePages(0, 0);
              (null == t ? void 0 : t.length) > 1 ? it(!0) : it(!1);
            }
          },
          lt = (function () {
            var t = _t(
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        return (
                          (n = l.a.getDocument()),
                          (r = l.a.getAnnotationManager()),
                          (o = {
                            isCurrentView: nt,
                            includeAnnotations: J,
                            includeComments: Z,
                          }),
                          (t.next = 7),
                          O(n, r, B, o, E)
          ...
          pt = function (t) {
            if ((t.preventDefault(), !(B.length < 1))) {
              N(0), j ? l.a.setWatermark(E) : l.a.setWatermark(L.current);
              var e = {
                  includeComments: Z,
                  includeAnnotations: J,
                  maintainPageOrientation: F,
                  printQuality: b,
                  sortStrategy: x,
                  colorMap: w,
                  printedNoteDateFormat: k,
                  isCurrentView: nt,
                  language: P,
                  timezone: C,
                  createCanvases: !1,
          ...
          dt = function () {
            N(-1), t(a.a.closeElement(s.a.PRINT_MODAL));
          },
          ut = Object(Wt.a)(dt);
        return o.a.createElement(Ct, {
          ...
          isFullAPIEnabled: l.a.isFullPDFEnabled(),
          currentPage: h,
          printQuality: b,
          isGrayscale: H,
          setIsGrayscale: U,
          setIsCurrentView: rt,
          isCurrentViewDisabled: at,
          checkCurrentView: st,
          includeAnnotations: J,
          setIncludeAnnotations: X,
          includeComments: Z,
          setIncludeComments: tt,
          isWatermarkModalVisible: Y,
          setIsWatermarkModalVisible: q,
          watermarkModalOptions: E,
          existingWatermarksRef: L,
          setAllowWatermarkModal: M,
          closePrintModal: dt,
          createPagesAndPrint: function (t) {
            var e = l.a.getDocument().getType();
            A &&
              "xod" === e &&
              console.warn(
                "Falling back to raster printing, XOD files and Embedded Printing is not supported",
              ),
              A && "xod" !== e ? lt(m.h && m.n ? window.open() : null) : pt(t);
          },
          pagesToPrint: B,
          setPagesToPrint: G,
          count: T,
