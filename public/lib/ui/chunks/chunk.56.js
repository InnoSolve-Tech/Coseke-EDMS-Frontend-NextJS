        ...
        insert: function (o) {
          ...
          (t = document.getElementsByTagName("apryse-webviewer")),
            t.length ||
              (t = (function o(t, e = document) {
                const r = [];
                return (
                  e.querySelectorAll(t).forEach((o) => r.push(o)),
                  e.querySelectorAll("*").forEach((e) => {
                    e.shadowRoot && r.push(...o(t, e.shadowRoot));
                  }),
                  r
                );
              })("apryse-webviewer"));
          ...
          for (let r = 0; r < t.length; r++) {
            ...
            if (0 === r)
              ...
              n.shadowRoot.appendChild(t), e.push(t);
            }
          }
        },
        singleton: !1,
    ...
    1919: function (o, t, e) {
      ...
      function x(o, t) {
        return (
          ...
          (function (o, t) {
            if (!o) return;
            if ("string" == typeof o) return y(o, t);
      ...
      function y(o, t) {
        ...
        for (var e = 0, r = new Array(t); e < t; e++) r[e] = o[e];
        return r;
      }
      e(1432).d.prototype.componentDidUpdate = function (o, t) {
        if (
          this.props.value !== this.state.value &&
          (o.value !== this.props.value || t.value !== this.state.value)
        ) {
          var e = document.activeElement;
          Object(h.a)() && (e = Object(h.a)().activeElement),
            this.input === e
              ? this.setState({
      ...
      var v = function (o) {
        var t = o.isDisabled,
          ...
          v = y[0],
          w = y[1],
          g = d()({ Modal: !0, ColorPickerModal: !0, open: e, closed: !e });
      ...
      function D(o, t) {
        return (
          ...
          (function (o, t) {
            if (!o) return;
            if ("string" == typeof o) return T(o, t);
            var e = Object.prototype.toString.call(o).slice(8, -1);
            "Object" === e && o.constructor && (e = o.constructor.name);
            if ("Map" === e || "Set" === e) return Array.from(o);
            if (
