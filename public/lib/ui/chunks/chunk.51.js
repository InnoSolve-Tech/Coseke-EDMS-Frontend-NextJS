  ...
  [51],
  {
    ...
    1908: function (e, t, n) {
      ...
      var o = n(0),
        ...
        b = n(129),
        h = n(43),
        y = (n(60), n(45), n(112), n(35), n(124), n(436)),
        g = (n(1634), n(1810), n(1717)),
        w = n(59),
        v = n(333);
      function x(e) {
        return (x =
      ...
      var k = r.a.forwardRef(function (e, t) {
        var n = e.closeThisModal,
          i = e.clearLoadedFile,
          a = e.pageIndicesToReplace,
          l = e.sourceDocument,
          ...
          _ = F[0],
          T = F[1],
          R = O(Object(o.useState)(null), 2),
          I = R[0],
          D = R[1],
          C = O(Object(o.useState)(null), 2),
          M = C[0],
          H = C[1],
          ...
          X = function () {
            var e = [];
            for (var t in N) N[t] && e.push(parseInt(t));
            return e;
          };
        Object(o.useEffect)(
          function () {
          ...
          Object(o.useEffect)(
            function () {
              ...
              if (l) {
                ...
                z(t), D(e(l.getFilename())), H(e(d.getFilename()));
              }
            },
            [l],
          );
            ...
            r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(y.a, {
                  ...
                  pageCount: G,
                  onSelectedPageNumbersChange: function (e) {
                    e.length > 0 ? (k(e), Q(e)) : X();
                  },
                  onBlurHandler: Q,
                  onError: function (e) {
                    e &&
                      Y("".concat(m("message.errorPageNumber"), " ").concat(G));
                  },
                  pageNumberError: $,
                }),
                r.a.createElement(
              ...
              r.a.createElement(
                "div",
                { className: p()("modal-body-container", { isLoading: _ }) },
                r.a.createElement(g.a, {
                  document: l,
                  onThumbnailSelected: function (e) {
                    void 0 === N[e] ? (N[e] = !0) : (N[e] = !N[e]), L(S({}, N));
                  },
                  selectedThumbnails: N,
                  onfileLoadedHandler: T,
                }),
              ),
            ),
            r.a.createElement("div", { className: "page-replacement-divider" }),
            r.a.createElement(
              "div",
              { className: p()("footer", { isFileSelected: !_ }) },
              r.a.createElement(
                "button",
                {
                  className: p()("deselect-thumbnails", { disabled: _ }),
                  onClick: function () {
                    L({});
                  },
                  disabled: _,
              ...
              r.a.createElement(h.a, {
                ...
                onClick: function () {
                  return (e = X()), c(l, b, e), void n();
                  var e;
                },
                label: m("action.replace"),
                disabled: (function () {
                  if (b.length < 1 || V || $) return !0;
      ...
      var F = r.a.forwardRef(function (e, t) {
      ...
      function D() {
        ...
        var h = Object.getPrototypeOf,
          y = h && h(h(j([])));
        y && y !== t && n.call(y, i) && (b = y);
        var g = (f.prototype = u.prototype = Object.create(b));
        function w(e) {
        ...
        function x(e, t, n) {
          ...
          return function (r, i) {
            ...
            for (n.method = r, n.arg = i; ; ) {
              ...
              if ("normal" === c.type) {
                if (
                  ((o = n.done ? "completed" : "suspendedYield"), c.arg === s)
                )
                  continue;
        ...
        return (
          ...
          w(v.prototype),
          c(v.prototype, a, function () {
            return this;
          }),
          (e.AsyncIterator = v),
          (e.async = function (t, n, o, r, i) {
            void 0 === i && (i = Promise);
            var a = new v(p(t, n, o, r), i);
      ...
      var G = new RegExp(
        ...
        W = function (e) {
          var t = e.closeModal,
            ...
            y = e.selectedTab,
            g = H(Object(s.a)(), 1)[0],
            w = H(Object(o.useState)({}), 2),
            x = w[0],
            P = w[1],
            S = H(Object(o.useState)(null), 2),
            E = S[0],
            O = S[1],
            j = H(Object(o.useState)(!1), 2),
            k = j[0],
            A = j[1],
            L = H(Object(o.useState)(null), 2),
            F = L[0],
            R = L[1],
            C = Object(l.d)(),
            B = Object(l.e)(function (e) {
              var t;
              return null === (t = i.a.getFeatureFlags(e)) || void 0 === t
                ? void 0
                : t.customizableUI;
            });
          Object(o.useEffect)(
          ...
          var W = function () {
              O(null), A(!1);
              var e = Object(T.a)().querySelector(
                "#".concat("pageReplacementFileInputId"),
              );
              e && (e.value = null), t(), R(null), P({});
            },
            V = function () {
              return Object(N.d)(W, C);
            },
            U = p()({
              Modal: !0,
                  ...
                  return D().wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if (
                            (A(!0), !q || "customFileListPanelButton" !== F)
                          ) {
                            e.next = 9;
                            break;
                          }
                        ...
                        case 9:
                          ...
                          return (e.next = 12), d.a.createDocument(q, z);
                        case 12:
                          (t = e.sent), O(t);
                        case 14:
                        case "end":
                  ...
                  return D().wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if (
                            !(t instanceof Object(T.c)().instance.Core.Document)
                          ) {
                            e.next = 4;
                            break;
                          }
                          ...
                          break;
                        case 4:
                          return (e.next = 6), d.a.createDocument(t, z);
                        case 6:
                          n = e.sent;
                        case 7:
                          O(n), A(!0);
            ...
            J = void 0 === q;
          "urlInputPanelButton" !== F || G.test(q) || (J = !0);
          var K,
            X = function () {
              O(null), A(!1);
            };
                  ...
                  : ((K = n && n.length > 0),
                    r.a.createElement(
                      ...
                      r.a.createElement(
                        ...
                        {
                          isOpen: a,
                          title: g("component.pageReplaceModalTitle"),
                          closeButtonDataElement: "pageReplacementModalClose",
                          onCloseClick: W,
                          swipeToClose: !0,
                          closeHandler: W,
                            ...
                            r.a.createElement(
                              ...
                              r.a.createElement(
                                ...
                                r.a.createElement(
                                  "button",
                                  { className: "tab-options-button" },
                                  g("option.pageReplacementModal.localFile"),
                                ),
                              ),
                            ),
                          ),
                          ...
                          r.a.createElement(
                            ...
                            r.a.createElement(
                              ...
                              r.a.createElement(m.a, {
                                ...
                                defaultValue: x.urlInputPanelButton,
                              }),
                            ),
                          ),
                          r.a.createElement(
                        ...
                        r.a.createElement(
                          ...
                          { className: "footer" },
                          r.a.createElement(h.a, {
                            className: p()("modal-btn", { noFile: J }),
                            onClick: function () {
                              return J ? null : $();
                            },
                            label: g("action.select"),
                            disabled: J,
                          }),
                        ),
                      ),
      ...
      var re = function (e) {
        var t = Object(l.d)(),
          n = Object(l.e)(function (e) {
            return i.a.getPageReplacementFileList(e);
          }),
          o = ne(
            Object(l.e)(function (e) {
              return [i.a.isElementOpen(e, X.a.PAGE_REPLACEMENT_MODAL)];
            }),
            1,
          )[0],
          c = Object(l.e)(function (e) {
            return i.a.getSelectedThumbnailPageIndexes(e);
          }),
          p = Object(l.e)(function (e) {
            return i.a.getSelectedTab(e, X.a.PAGE_REPLACEMENT_MODAL);
          }),
          d = ee(
            ee({}, e),
            {},
            {
              closePageReplacement: function () {
                t(a.a.closeElement(X.a.PAGE_REPLACEMENT_MODAL));
              },
              selectableFiles: n,
              isOpen: o,
