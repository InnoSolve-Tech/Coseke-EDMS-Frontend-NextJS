  ...
  [4],
  {
    1439: function (e, t, n) {
      ...
      var m = function (e, t, n) {
        ...
        v = [
          m(y.OPENFORMFIELDPANEL, "icon-edit-form-field", "action.edit"),
          m(y.OPENFILE, "icon-portfolio-file", "portfolio.openFile"),
          m(y.RENAME, "ic_edit_page_24px", "action.rename"),
          m(y.SETDEST, "icon-thumbtack", "action.setDestination"),
          m(y.DOWNLOAD, "icon-download", "action.download"),
          m(y.DELETE, "icon-delete-line", "action.delete"),
          m(y.MOVE_UP, "icon-page-move-up", "action.moveUp"),
          m(y.MOVE_DOWN, "icon-page-move-down", "action.moveDown"),
          m(y.MOVE_LEFT, "icon-page-move-left", "action.moveLeft"),
            ...
            Object(r.useLayoutEffect)(function () {
              var e = {
                ...
                items: v.map(function (e) {
                  ...
                  return (
                    r === y.DELETE && (o = c),
                    [y.DOWNLOAD, y.OPENFILE].includes(r) &&
                      (o = "portfolio" !== t),
                    r === y.SETDEST && (o = "outline" !== t),
                    r === y.OPENFORMFIELDPANEL &&
                      (o = ["portfolio", "bookmark"].includes(t)),
                    [y.MOVE_UP, y.MOVE_DOWN].includes(r) &&
                      (o = !["portfolio"].includes(t)),
                    [
                      y.MOVE_LEFT,
                      y.MOVE_RIGHT,
                      y.MOVE_UP,
                      y.MOVE_DOWN,
                    ].includes(r) && (o = "outline" !== t),
                    f(
                      f({}, e),
                      {},
                      {
                      ...
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            s(
                              a
                                ? i.a.updateFlyout(e.dataElement, e)
                                : i.a.addFlyout(e),
                            );
                          case 1:
                          case "end":
    ...
    1496: function (e, t, n) {
      ...
      var v = function (e, t) {
        ...
        return (
          Object(r.useEffect)(
            function () {
              for (var n = -1, r = null == e ? void 0 : e.current; r; )
                n++, (r = r.parentElement.closest(t));
              i(n);
            },
            [e],
          ),
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              o.a.createElement(p.a, {
                style: { color: l || "inherit" },
                ariaLabel: n,
                label: n,
                onDoubleClick: r,
                onClick: i,
                className: c()({ "set-focus": u }),
                useI18String: a,
              }),
            ),
          ),
      ...
      (E.displayName = "PanelItemContent"),
        (E.propTypes = {
          iconGlyph: a.a.string,
          labelHeader: a.a.string.isRequired,
          onDoubleClick: a.a.func,
          onClick: a.a.func,
          useI18String: a.a.bool,
      ...
      var x = function (e) {
        var t = e.checkboxOptions,
          n = e.children,
          i = e.contentMenuFlyoutOptions,
          a = void 0 === i ? {} : i,
          l = e.contextMenuMoreButtonOptions,
          h = void 0 === l ? {} : l,
          m = e.description,
          y = e.enableMoreOptionsContextMenuFlyout,
          b = e.iconGlyph,
          x = e.labelHeader,
          O = e.useI18String,
          L = void 0 === O || O,
          ...
          D = e.expanded,
          C = e.setIsExpandedHandler,
          P = e.textColor,
          M = e.isActive,
          F = Object(r.useRef)(),
          _ = v(F),
          T = g(Object(r.useState)(null != D && D), 2),
          I = T[0],
          A = T[1],
          B = Object(u.a)().t,
          R = a.shouldHideDeleteButton,
          H = void 0 !== R && R,
          G = a.currentFlyout,
          V = a.flyoutSelector,
          U = a.type,
          W = a.handleOnClick,
          q = h.flyoutToggleElement,
          z = h.moreOptionsDataElement,
          J = (t && !t.disabled) || !1;
        return o.a.createElement(
          "div",
          {
          ...
          o.a.createElement(
            "div",
            {
              className: c()({
                ...
                "grid-with-2-rows": m,
                "grid-with-1-row": !m,
                "grid-with-3-columns": !b && !t,
                "grid-with-4-columns": b || t,
                "grid-with-5-columns": b && t,
              }),
            },
            o.a.createElement(
              "div",
              ...
              J &&
                o.a.createElement(
                  "div",
                  {
                    style: { "--checkbox-left": "".concat(-32 * _ + 4, "px") },
                    className: "checkbox",
                  },
              ...
              o.a.createElement(
                ...
                o.a.createElement(p.a, {
                  ...
                  ariaExpanded: I,
                  ariaLabel: ""
                    .concat(B(I ? "action.collapse" : "action.expand"), " ")
                    .concat(x),
                }),
              ),
              o.a.createElement(E, {
              ...
              y &&
                o.a.createElement(
                  ...
                  o.a.createElement(s.a, {
                    ...
                    title: ""
                      .concat(B("option.searchPanel.moreOptions"), " ")
                      .concat(x),
                    toggleElement: q,
                    dataElement: z,
                    img: "icon-tool-more",
          ...
          I && o.a.createElement(w, null, n),
        );
      };
      x.propTypes = {
        checkboxOptions: a.a.shape({
          id: a.a.string,
          checked: a.a.bool,
          onChange: a.a.func,
        ...
        enableMoreOptionsContextMenuFlyout: a.a.bool,
        children: a.a.node,
        onDoubleClick: a.a.func,
        onClick: a.a.func,
        expanded: a.a.bool,
        textColor: a.a.string,
        setIsExpandedHandler: a.a.func,
        contentMenuFlyoutOptions: a.a.shape({
          shouldHideDeleteButton: a.a.bool,
          currentFlyout: a.a.object,
          flyoutSelector: a.a.string,
          type: a.a.string,
          handleOnClick: a.a.func,
        }),
        contextMenuMoreButtonOptions: a.a.shape({
          flyoutToggleElement: a.a.string,
          moreOptionsDataElement: a.a.string,
        }),
        isActive: a.a.bool,
      };
      t.a = x;
