  ...
  [69],
  {
    ...
    1715: function (e, t, n) {
      ...
      var w = function () {
          var e = Object(i.d)(),
            t = S(Object(o.a)(), 1)[0],
            n = Object(v.a)(function () {
              e(u.a.openElement(b.a.CUSTOM_STAMP_MODAL));
            });
          return a.a.createElement(
            h.a,
            { dataElement: b.a.CREATE_RUBBER_STAMP_BUTTON_WRAP },
            a.a.createElement(y.a, {
              className: "CreateRubberStampButton",
              dataElement: b.a.CREATE_RUBBER_STAMP_BUTTON,
      ...
      var L = a.a.memo(function (e) {
        var t = e.imgSrc,
          ...
          l = e.isActive,
          u = j(Object(o.a)(), 1)[0],
          s = "rubberStamp.".concat(n.Icon);
        return a.a.createElement(
          "button",
          {
            tabIndex: 0,
            key: r,
            className: p()("rubber-stamp", { active: l }),
            "aria-label": u(s),
            onClick: function () {
              return i(n, r);
            },
          ...
          a.a.createElement("img", { src: t, alt: "" }),
        );
      });
      (L.displayName = "RubberStamp"),
        (L.propTypes = {
          imgSrc: k.a.string,
          annotation: k.a.object,
          index: k.a.number,
          onClick: k.a.func,
          isActive: k.a.bool,
        });
      var I = function (e) {
        var t = e.standardStamps,
          n = e.selectedStampIndex,
          u = e.setSelectedRubberStamp,
          s = j(Object(o.a)(), 1)[0],
          c = Object(R.b)(),
          p = j(
            Object(i.e)(function (e) {
              return [
                l.a.getMobilePanelSize(e),
                l.a.getLastSelectedStampIndex(e),
              ];
            }),
            2,
          ),
          ...
          f = t.map(function (e, t) {
            var r = e.imgSrc,
              o = e.annotation,
              i = n === t,
              l = t === (d || 0) && Object(E.isNull)(n);
            return !c ||
              (c && b !== m.a.SMALL_SIZE) ||
              (c && b === m.a.SMALL_SIZE && (i || l))
              ? a.a.createElement(L, {
                  key: t,
                  index: t,
                  imgSrc: r,
          ...
          h = Object(r.useCallback)(
            function () {
              return s("rubberStampPanel.standard");
            },
            [s],
          );
        return a.a.createElement(
          A.a,
          {
            header: h,
            headingLevel: 2,
            ariaControls: "rubber-stamps-list",
            expansionDescription: s("rubberStampPanel.standard"),
          },
          a.a.createElement(
            "div",
            { className: "rubber-stamps-list", id: "rubber-stamps-list" },
            f,
          ),
        );
      };
      I.displayName = "StandardRubberStamps";
      var C = a.a.memo(I);
      n(35);
      function T(e, t) {
        return (
      ...
      var B = a.a.memo(function (e) {
        var t,
          ...
          l = e.onClick,
          u = e.deleteHandler,
          s = e.standardStampsOffset,
          c = e.isActive,
          b = T(Object(o.a)(), 1)[0],
          m = r.getCustomData("trn-custom-stamp");
        try {
          t = JSON.parse(m);
        } catch (e) {
          t = { title: "".concat(b("annotation.defaultCustomStampTitle")) };
        }
        return a.a.createElement(
          "div",
          { className: "custom-rubber-stamp-row", tabIndex: "-1" },
          a.a.createElement(
            "button",
            {
              key: i,
              className: p()("rubber-stamp", { active: c }),
              "aria-label": ""
                .concat(b("annotation.stamp"), " ")
                .concat(t.title, " ")
                .concat(t.author, " ")
                .concat(r.DateCreated),
              onClick: function () {
                return l(r, i + s);
              },
              "aria-current": c,
      ...
      (B.displayName = "CustomRubberStamp"),
        (B.propTypes = {
          imgSrc: k.a.string,
          annotation: k.a.object,
          index: k.a.number,
          onClick: k.a.func,
          deleteHandler: k.a.func,
          standardStampsOffset: k.a.number,
          isActive: k.a.bool,
        });
      var M = function (e) {
        var t = e.customStamps,
          n = e.selectedStampIndex,
          o = e.setSelectedRubberStamp,
          c = e.standardStampsOffset,
          p = s.a.getToolsFromAllDocumentViewers("AnnotationCreateRubberStamp"),
          b = Object(R.b)(),
          d = Object(i.d)(),
          f = T(
            Object(i.e)(function (e) {
          ...
          v = Object(r.useCallback)(function (e) {
            ...
            try {
              for (r.s(); !(t = r.n()).done; ) {
                var a = t.value,
                  o = a.getCustomStamps();
                a.deleteCustomStamps([o[e]]);
                var i =
                  ((n = e),
                  0 === a.getCustomStamps().length
                    ? null
                    : 0 === n
                      ? c
                      : n - 1 >= 0
                        ? n - 1 + c
                        : n + c);
                d(u.a.setSelectedStampIndex(null)),
                  d(u.a.setLastSelectedStampIndex(i));
              }
            } catch (e) {
              r.e(e);
            } finally {
          ...
          S = b && h !== m.a.SMALL_SIZE,
          g = b && h === m.a.SMALL_SIZE,
          w = t.map(function (e, r) {
            var i = e.imgSrc,
              l = e.annotation,
              u = r + c,
              s = n === u,
              p = g && ((Object(E.isNull)(n) && t.length && u === y) || s);
            return !b || S || p || (g && s)
              ? a.a.createElement(B, {
                  key: r,
                  index: r,
        ...
        return 0 === t.length
          ? null
          : a.a.createElement("div", { className: "rubber-stamps-list" }, w);
      };
      (M.displayName = "CustomRubberStamps"),
        (M.propTypes = {
          customStamps: k.a.array,
          selectedStampIndex: k.a.number,
          setSelectedRubberStamp: k.a.func,
          standardStampsOffset: k.a.number,
        });
      var z = a.a.memo(M),
        D = n(100);
      ...
      function G() {
        ...
        var h = Object.getPrototypeOf,
          y = h && h(h(P([])));
        y && y !== t && n.call(y, o) && (f = y);
        var v = (d.prototype = b.prototype = Object.create(f));
        function S(e) {
          ...
          (E.prototype = {
            ...
            finish: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                ...
                if (n.finallyLoc === e)
                  return this.complete(n.completion, n.afterLoc), R(n), p;
              }
            },
            catch: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
      ...
      var $ = function () {
        var e,
          t = V(Object(o.a)(), 1)[0],
          n = Object(i.d)(),
          c = s.a.getToolsFromAllDocumentViewers("AnnotationCreateRubberStamp"),
          y = Object(R.b)(),
          v = Object(i.e)(l.a.getStandardStamps, i.c),
          S = Object(i.e)(l.a.getCustomStamps, i.c),
          g = Object(i.e)(l.a.getSelectedStampIndex),
          A = Object(i.e)(l.a.getMobilePanelSize),
          E = Object(i.e)(l.a.getFeatureFlags, i.c),
          P = Object(i.f)(),
          k = E.customizableUI,
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              s.a.setToolMode("AnnotationCreateRubberStamp"),
                                (o = F(c)),
                                (e.prev = 2),
                                o.s();
                            case 4:
                              ...
                              return (
                                (l = i.value),
                                (p = t("rubberStamp.".concat(r.Icon))),
                                (e.next = 9),
                                l.setRubberStamp(r, p)
                              );
                            case 9:
                              l.showPreview();
                            case 10:
                            ...
                            case 12:
                              ...
                              break;
                            case 14:
                              (e.prev = 14), (e.t0 = e.catch(2)), o.e(e.t0);
                            case 17:
                              return (e.prev = 17), o.f(), e.finish(17);
                            case 20:
                              n(u.a.setSelectedStampIndex(a)),
                                y &&
                                  A !== m.a.SMALL_SIZE &&
                                  n(u.a.setMobilePanelSize(m.a.SMALL_SIZE));
                            case 22:
                            case "end":
                              return e.stop();
                          }
        ...
        return (
          Object(r.useEffect)(function () {
            n(u.a.setSelectedStampIndex(null));
          }, []),
          Object(r.useEffect)(function () {
            var e = function (e) {
              var t = s.a.getToolMode(),
              ...
              a !== m.e.RUBBER_STAMP ||
                o ||
                ("AnnotationCreateRubberStamp" !== n && n !== d.a) ||
                Object(D.a)(P, d.a);
            };
            return (
              window.addEventListener(f.a.VISIBILITY_CHANGED, e),
              function () {
                window.removeEventListener(f.a.VISIBILITY_CHANGED, e);
              }
            );
          }, []),
          a.a.createElement(
            h.a,
            {
              dataElement: b.a.RUBBER_STAMP_PANEL,
              className: p()(
                ((e = { Panel: !0, RubberStampPanel: !0 }),
                U(e, A, y),
                U(e, "modular-ui-panel", k),
                e),
              ),
            },
            a.a.createElement(
            ...
            a.a.createElement(
              "div",
              { className: p()(U({ "rubber-stamps-container": !0 }, A, y)) },
              a.a.createElement(z, {
                selectedStampIndex: g,
                standardStampsOffset: v.length,
                setSelectedRubberStamp: j,
                customStamps: S,
              }),
