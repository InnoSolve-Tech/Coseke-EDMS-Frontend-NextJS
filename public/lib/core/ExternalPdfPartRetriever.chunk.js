      ...
      584: function (ya, ua, n) {
        ...
        n = (function () {
          function fa(x, y) {
            this.d$ = function (w) {
              w = w.split(".");
              return w[w.length - 1].match(/(jpg|jpeg|png|gif)$/i);
            };
            y = y || {};
            this.url = x;
            this.filename = y.filename || x;
            this.Of = y.customHeaders;
            this.PNa = !!y.useDownloader;
          ...
          fa.prototype.getFileData = function (x) {
            ...
            b.responseType = f;
            this.Of &&
              Object.keys(this.Of).forEach(function (e) {
                b.setRequestHeader(e, y.Of[e]);
              });
                    ...
                    switch (ha.label) {
                      case 0:
                        if (200 !== this.status && (h || 0 !== this.status))
                          return [3, 10];
                        w.trigger(fa.Events.DOCUMENT_LOADING_PROGRESS, [
                          e.loaded,
                          e.loaded,
                        ]);
                        if ("blob" !== this.responseType) return [3, 4];
                        a = this.response;
                        return w.d$(w.filename) ? [4, Object(ka.b)(a)] : [3, 2];
                      case 1:
                        return (
                          (r = ha.aa()),
                          (w.fileSize = r.byteLength),
                          x(new Uint8Array(r)),
                          [3, 3]
                        );
                      case 2:
                        (z = new FileReader()),
                          (z.onload = function (ca) {
                            ca = new Uint8Array(ca.target.result);
                            w.fileSize = ca.length;
                            x(ca);
                          }),
                      ...
                      case 6:
                        (w.fileSize = aa.length), x(aa), (ha.label = 7);
                      case 7:
                        return [3, 9];
                      case 8:
                        return (
                          ha.aa(),
                          w.trigger(fa.Events.ERROR, [
                            "pdfLoad",
                            "Out of memory",
                          ]),
                          [3, 9]
            ...
            b.addEventListener(
              "error",
              function () {
                w.trigger(fa.Events.ERROR, ["pdfLoad", "Network failure"]);
                w.PG = null;
              },
              !1,
            );
          ...
          fa.prototype.abort = function () {
            this.PG && (this.PG.abort(), (this.PG = null));
          };
          fa.Events = {
