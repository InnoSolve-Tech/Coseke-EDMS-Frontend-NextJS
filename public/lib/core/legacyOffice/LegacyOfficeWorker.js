  ...
  function (e, t, n) {
    ...
    var P,
      ...
      O =
        ...
        (j = M.navigator.userAgent.match(/Maxthon/)),
        (x = M.navigator.userAgent.match(/Edge/)),
        M.navigator.userAgent.match(/Chrome\/(.*?) /) && !_ && !j && !x),
      I =
        ((function () {
          if (!O) return null;
      ...
      L =
        ...
        (/^((?!chrome|android).)*$/.test(M.navigator.userAgent) && E),
      R =
        (L &&
