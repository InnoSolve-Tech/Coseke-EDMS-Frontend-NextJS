        ...
        n = (function () {
          function fa(x) {
            ...
            this.wBa = function (w) {
              return (
                w &&
                ("image" === w.type.split("/")[0].toLowerCase() ||
                  (w.name && !!w.name.match(/.(jpg|jpeg|png|gif)$/i)))
              );
            };
            this.file = x;
            this.MBa = new Promise(function (w) {
              return Object(pa.b)(y, void 0, void 0, function () {
                var b;
                return Object(pa.d)(this, function (f) {
                  switch (f.label) {
                    case 0:
                      return this.wBa(this.file)
                        ? [4, Object(na.b)(x)]
                        : [3, 2];
                    case 1:
                      (b = f.aa()),
                        (this.file = ka.q
                          ? new Blob([b], { type: x.type })
                          : new File(
                              [b],
          ...
          fa.prototype.getFileData = function (x) {
            ...
            w.onload = function (b) {
              ...
              x(new Uint8Array(b.target.result));
            };
            w.onprogress = function (b) {
              b.lengthComputable &&
                y.trigger(fa.Events.DOCUMENT_LOADING_PROGRESS, [
                  b.loaded,
                  0 < b.total ? b.total : 0,
