(function () {
  ...
  var $jscomp$lookupPolyfilledValue = function (e, c, d) {
    if (!d || null != e) {
      d = $jscomp.propertyToPolyfillSymbol[c];
      if (null == d) return e[c];
      d = e[d];
      return void 0 !== d ? d : e[c];
    }
  };
  $jscomp.polyfill = function (e, c, d, g) {
    c &&
      ($jscomp.ISOLATE_POLYFILLS
        ? $jscomp.polyfillIsolated(e, c, d, g)
        : $jscomp.polyfillUnisolated(e, c, d, g));
  };
  $jscomp.polyfillUnisolated = function (e, c, d, g) {
    d = $jscomp.global;
    e = e.split(".");
  ...
  $jscomp.polyfillIsolated = function (e, c, d, g) {
    var b = e.split(".");
    e = 1 === b.length;
    g = b[0];
    g = !e && g in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global;
    ...
    b = b[b.length - 1];
    d = $jscomp.IS_SYMBOL_NATIVE && "es6" === d ? g[b] : null;
    c = c(d);
    null != c &&
      (e
        ...
        : c !== d &&
          (void 0 === $jscomp.propertyToPolyfillSymbol[b] &&
            ...
            ($jscomp.propertyToPolyfillSymbol[b] = $jscomp.IS_SYMBOL_NATIVE
              ...
              : $jscomp.POLYFILL_PREFIX + d + "$" + b)),
          $jscomp.defineProperty(g, $jscomp.propertyToPolyfillSymbol[b], {
            configurable: !0,
            writable: !0,
            value: c,
          })));
  ...
  $jscomp.polyfill(
    ...
    function (e) {
      ...
      for (
        ...
        var g = $jscomp.global[c[d]];
        "function" === typeof g &&
          "function" != typeof g.prototype[e] &&
          $jscomp.defineProperty(g.prototype, e, {
            configurable: !0,
            writable: !0,
            value: function () {
  ...
  $jscomp.polyfill(
    ...
    function (e) {
      ...
      b.prototype.settle_ = function (a, f) {
        if (0 != this.state_)
          throw Error(
            "Cannot settle(" +
              a +
      ...
      b.prototype.notifyUnhandledRejection_ = function () {
        ...
        "function" === typeof a
          ...
          : "function" === typeof f
            ? (a = new f("unhandledrejection", { cancelable: !0 }))
      ...
      b.prototype.settleSameAsThenable_ = function (a, f) {
      ...
      b.prototype.then = function (a, f) {
        ...
        var l,
          p,
          q = new b(function (m, t) {
            l = m;
            p = t;
          });
        this.callWhenSettled_(h(a, l), h(f, p));
        return q;
      };
      b.prototype.catch = function (a) {
        return this.then(void 0, a);
      };
      b.prototype.callWhenSettled_ = function (a, f) {
        function h() {
          switch (l.state_) {
            case 1:
              a(l.result_);
      ...
      b.race = function (a) {
        return new b(function (f, h) {
          for (
            var l = $jscomp.makeIterator(a), p = l.next();
            !p.done;
            p = l.next()
          )
            d(p.value).callWhenSettled_(f, h);
        });
      };
      b.all = function (a) {
        ...
        return h.done
          ...
          : new b(function (l, p) {
              ...
              do
                m.push(void 0),
                  t++,
                  d(h.value).callWhenSettled_(q(m.length - 1), p),
                  (h = f.next());
              while (!h.done);
            });
      };
    ...
    $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign
      ...
      : function (e, c) {
          for (var d = 1; d < arguments.length; d++) {
            var g = arguments[d];
            if (g) for (var b in g) $jscomp.owns(g, b) && (e[b] = g[b]);
          }
          return e;
        };
  $jscomp.polyfill(
      ...
      return e
        ...
        : function (c, d, g) {
            ...
            if ("function" == typeof k) {
              c = k.call(c);
              for (var a = 0; !(k = c.next()).done; )
                b.push(d.call(g, k.value, a++));
            } else
              for (k = c.length, a = 0; a < k; a++) b.push(d.call(g, c[a], a));
            return b;
          };
    },
    "es6",
  ...
  (function (e) {
    function c(g) {
      ...
      var b = (d[g] = { i: g, l: !1, exports: {} });
      e[g].call(b.exports, b, b.exports, c);
      b.l = !0;
      return b.exports;
    }
    var d = {};
    ...
    c.c = d;
    c.d = function (g, b, k) {
      c.o(g, b) || Object.defineProperty(g, b, { enumerable: !0, get: k });
    };
    c.r = function (g) {
      "undefined" !== typeof Symbol &&
        Symbol.toStringTag &&
    ...
    c.t = function (g, b) {
      b & 1 && (g = c(g));
      if (b & 8 || (b & 4 && "object" === typeof g && g && g.__esModule))
        return g;
      var k = Object.create(null);
      c.r(k);
      Object.defineProperty(k, "default", { enumerable: !0, value: g });
      if (b & 2 && "string" != typeof g)
        for (var a in g)
          c.d(
            k,
            a,
      ...
      var g = d(1),
        b = function (a, f) {
          Object(g.a)("disableLogs") ||
            (f ? console.warn("".concat(a, ": ").concat(f)) : console.warn(a));
        },
        k = function (a, f) {};
    },
    function (e, c, d) {
    ...
    function (e, c, d) {
      ...
      var g = d(6),
        ...
        l = !1,
        p = function (w, v) {
          l || (h("".concat(f.basePath, "decode.min.js")), (l = !0));
          w = self.BrotliDecode(Object(a.b)(w));
          return v ? w : Object(a.a)(w);
        },
        q = function (w, v) {
          return Object(g.a)(void 0, void 0, Promise, function () {
            var u;
            return Object(g.b)(this, function (x) {
              switch (x.label) {
                case 0:
                  return l
                    ? [3, 2]
                ...
                case 1:
                  x.sent(), (l = !0), (x.label = 2);
                case 2:
                  return (
                    (u = self.BrotliDecode(Object(a.b)(w))),
                    [2, v ? u : Object(a.a)(u)]
                  );
              }
            });
      ...
      (function () {
        ...
        w.prototype.processRaw = function (v) {
          return v;
        };
        w.prototype.processBrotli = function (v) {
          this.remainingDataArrays.push(v);
          return null;
        };
        w.prototype.GetNextChunk = function (v) {
          this.decodeFunction ||
            (this.decodeFunction =
        ...
        w.prototype.End = function () {
          if (this.remainingDataArrays.length) {
            for (var v = this.arrays, u = 0, x = 0; x < v.length; ++x)
              u += v[x].length;
            u = new Uint8Array(u);
            var y = 0;
      ...
      var m = function (w) {
          var v = !w.shouldOutputArray,
            u = new XMLHttpRequest();
          u.open("GET", w.url, w.isAsync);
          var x = v && u.overrideMimeType;
          u.responseType = x ? "text" : "arraybuffer";
          x && u.overrideMimeType("text/plain; charset=x-user-defined");
          u.send();
          var y = function () {
            var C = Date.now();
            var z = x ? u.responseText : new Uint8Array(u.response);
            Object(b.a)("worker", "Result length is ".concat(z.length));
            z.length < w.compressedMaximum
              ? ((z = w.decompressFunction(z, w.shouldOutputArray)),
                Object(b.b)(
                ...
                h &&
                  Object(b.a)(
                    "worker",
                    "Decompressed length is ".concat(z.length),
                  ))
              : v && (z = Object(a.a)(z));
            h &&
              Object(b.a)(
                "worker",
                "".concat(w.url, " Decompression took ").concat(Date.now() - C),
              );
            return z;
          };
          if (w.isAsync)
            var A = new Promise(function (C, z) {
              u.onload = function () {
                200 === this.status || 0 === this.status
                  ? C(y())
                  : z("Download Failed ".concat(w.url));
              };
              u.onerror = function () {
                z("Network error occurred ".concat(w.url));
              };
            });
          else {
            if (200 === u.status || 0 === u.status) return y();
            throw Error("Failed to load ".concat(w.url));
          }
          return A;
        },
        t = function (w) {
          var v = w.lastIndexOf("/");
          -1 === v && (v = 0);
          var u = w.slice(v).replace(".", ".br.");
          h ||
            (u.endsWith(".js.mem")
              ? (u = u.replace(".js.mem", ".mem"))
              : u.endsWith(".js") && (u = u.concat(".mem")));
          return w.slice(0, v) + u;
        },
        n = function (w, v) {
          v.url = t(w);
          v.decompressFunction = h ? p : q;
          return m(v);
        },
        r = function (w, v, u, x) {
          return w.catch(function (y) {
            Object(b.b)(y);
            return x(v, u);
          });
        },
        B = function (w, v, u, x) {
          a: {
            var y = [n];
            v = { compressedMaximum: v, isAsync: u, shouldOutputArray: x };
            if (v.isAsync) {
              var A = y[0](w, v);
              for (u = 1; u < y.length; ++u) A = r(A, w, v, y[u]);
            } else {
    ...
    function (e, c, d) {
      ...
      var g = function (k) {
          if ("string" === typeof k) {
            for (
              var a = new Uint8Array(k.length), f = k.length, h = 0;
              h < f;
              h++
            )
              a[h] = k.charCodeAt(h);
        ...
        b = function (k) {
          if ("string" !== typeof k) {
            for (var a = "", f = 0, h = k.length, l; f < h; )
              (l = k.subarray(f, f + 1024)),
                (f += 1024),
    ...
    function (e, c, d) {
      function g(k, a, f) {
        return new Promise(function (h) {
          ...
          l.src = k;
          f.document.getElementsByTagName("head")[0].appendChild(l);
        });
      }
      d.d(c, "a", function () {
        return g;
      ...
      function g(f, h, l) {
        function p(t) {
          ...
          return t
            ...
            : Object(k.b)(f, l, !0, !0).then(function (n) {
                q = Date.now();
                Object(b.a)("load", "Request took ".concat(q - m, " ms"));
                return WebAssembly.instantiate(n, h);
              });
        }
        var q, m;
        return p(!!WebAssembly.instantiateStreaming).then(function (t) {
          Object(b.a)(
            "load",
            "WASM compilation took ".concat(Date.now() - (q || m), " ms"),
          );
          return t;
        });
      }
    ...
    function (e, c, d) {
      function g(k, a, f, h) {
        ...
        return new (f || (f = Promise))(function (p, q) {
          function m(r) {
            try {
              n(h.next(r));
            } catch (B) {
          ...
          function n(r) {
            r.done ? p(r.value) : l(r.value).then(m, t);
          }
          n((h = h.apply(k, a || [])).next());
        });
      }
      function b(k, a) {
        function f(n) {
                ...
                q &&
                  (m =
                    n[0] & 2
                      ? q["return"]
                      : n[0]
                        ? q["throw"] || ((m = q["return"]) && m.call(q), 0)
                        : q.next) &&
                  !(m = m.call(q, n[1])).done)
              )
                return m;
              if (((q = 0), m)) n = [n[0] & 2, m.value];
              switch (n[0]) {
                case 0:
                case 1:
                  m = n;
                ...
                default:
                  if (
                    !((m = l.trys), (m = 0 < m.length && m[m.length - 1])) &&
                    (6 === n[0] || 2 === n[0])
                  ) {
                    l = 0;
                    continue;
                  }
                  if (3 === n[0] && (!m || (n[1] > m[0] && n[1] < m[3])))
                    l.label = n[1];
                  else if (6 === n[0] && l.label < m[1])
                    (l.label = m[1]), (m = n);
                  else if (m && l.label < m[2]) (l.label = m[2]), l.ops.push(n);
                  else {
                    m[2] && l.ops.pop();
                    l.trys.pop();
                    continue;
    ...
    function (e, c, d) {
      ...
      var g = d(2),
        ...
        a = (function () {
          function h(l) {
            var p = this;
            this.promise = l.then(function (q) {
              p.response = q;
              p.status = 200;
            });
          }
          h.prototype.addEventListener = function (l, p) {
            this.promise.then(p);
          };
          return h;
        })(),
        f = function (h, l, p) {
          if (Object(k.a)() && !p) {
            self.Module.instantiateWasm = function (m, t) {
              return Object(b.a)(
                "".concat(h, "Wasm.wasm"),
                m,
                l["Wasm.wasm"],
            ...
            self.Module.memoryInitializerRequest = new a(q);
          }
          p = new Blob([p], { type: "application/javascript" });
          importScripts(URL.createObjectURL(p));
        };
    },
    function (e, c, d) {
      d.d(c, "a", function () {
      ...
      e = (function () {
        ...
        return (r =
          /(msie) ([\w.]+)/.exec(r) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(r))
          ? parseInt(r[2], 10)
          : r;
      })();
      var k = (function () {
        var r = b.navigator.userAgent.match(/OPR/),
          B = b.navigator.userAgent.match(/Maxthon/),
          w = b.navigator.userAgent.match(/Edge/);
        return b.navigator.userAgent.match(/Chrome\/(.*?) /) && !r && !B && !w;
      })();
      (function () {
        if (!k) return null;
        var r = b.navigator.userAgent.match(/Chrome\/([0-9]+)\./);
        return r ? parseInt(r[1], 10) : r;
      })();
      var a =
      ...
      (function () {
        if (!a) return null;
        var r = b.navigator.userAgent.match(/Edg\/([0-9]+)\./);
        return r ? parseInt(r[1], 10) : r;
      })();
      c =
      ...
      var f = (function () {
          var r = b.navigator.userAgent.match(
            /.*\/([0-9\.]+)\s(Safari|Mobile).*/i,
          );
          return r ? parseFloat(r[1]) : r;
        })(),
        h =
          /^((?!chrome|android).)*safari/i.test(b.navigator.userAgent) ||
          (/^((?!chrome|android).)*$/.test(b.navigator.userAgent) && c);
      h &&
        /^((?!chrome|android).)*safari/i.test(navigator.userAgent) &&
        parseInt(
          null === (g = navigator.userAgent.match(/Version\/(\d+)/)) ||
            void 0 === g
            ? void 0
            : g[1],
          10,
        );
      var l = b.navigator.userAgent.match(/Firefox/);
      (function () {
        if (!l) return null;
        var r = b.navigator.userAgent.match(/Firefox\/([0-9]+)\./);
        return r ? parseInt(r[1], 10) : r;
      })();
    ...
    function (e, c, d) {
      function g(k, a) {
        ...
        for (var f = 0, h = Array(a); f < a; f++) h[f] = k[f];
        return h;
      }
      d.r(c);
      e = d(7);
      ...
      location.search
        ...
        .forEach(function (k) {
          k = k.split("=");
          var a;
          var f = Array.isArray(k) ? k : void 0;
          if (!f)
            a: {
              var h =
                null == k
      ...
      (function () {
        function k() {
          if (self.runtimeInitialized)
            try {
              ...
              postMessage({ action: "error", data: q.toString() });
            }
          setTimeout(k, 200);
        }
        function a() {
          if (h && self.runtimeInitialized) {
            var q = h;
            h = null;
        ...
        onmessage = function (q) {
          if (self.runtimeInitialized) {
            a();
            var m = Module["_".concat(q.data.action)];
            if (!m)
              throw Error(
            ...
            if (t) {
              ...
              Module.HEAP8.set(t, l);
            }
            self.workerCallbackId = q.data.callbackId;
            try {
              t ? m(l, t.length) : m(0, 0);
            } catch (n) {
              postMessage({
                callbackId: self.workerCallbackId,
                data: { error: n.toString() },
              });
            }
          } else h || ((h = []), setTimeout(f, 100)), h.push(q);
        };
      })();
      Object(e.a)(
        "OfficeEditorWorker",
