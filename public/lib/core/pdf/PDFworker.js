(function () {
  ...
  $jscomp.arrayIteratorImpl = function (u) {
    var z = 0;
    return function () {
      return z < u.length ? { done: !1, value: u[z++] } : { done: !0 };
    };
  };
  ...
  var $jscomp$lookupPolyfilledValue = function (u, z, v) {
    if (!v || null != u) {
      v = $jscomp.propertyToPolyfillSymbol[z];
      if (null == v) return u[z];
      v = u[v];
      return void 0 !== v ? v : u[z];
    }
  };
  $jscomp.polyfill = function (u, z, v, t) {
    z &&
      ($jscomp.ISOLATE_POLYFILLS
        ? $jscomp.polyfillIsolated(u, z, v, t)
        : $jscomp.polyfillUnisolated(u, z, v, t));
  };
  $jscomp.polyfillUnisolated = function (u, z, v, t) {
    v = $jscomp.global;
    u = u.split(".");
    ...
    z != t &&
      null != z &&
      $jscomp.defineProperty(v, u, {
        configurable: !0,
        writable: !0,
        value: z,
      });
  };
  $jscomp.polyfillIsolated = function (u, z, v, t) {
    var r = u.split(".");
    u = 1 === r.length;
    t = r[0];
    t = !u && t in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global;
    ...
    r = r[r.length - 1];
    v = $jscomp.IS_SYMBOL_NATIVE && "es6" === v ? t[r] : null;
    z = z(v);
    null != z &&
      (u
  ...
  $jscomp.polyfill(
    ...
    function (u) {
      ...
      for (
        ...
        var t = $jscomp.global[z[v]];
        "function" === typeof t &&
          "function" != typeof t.prototype[u] &&
          $jscomp.defineProperty(t.prototype, u, {
            configurable: !0,
            writable: !0,
            value: function () {
    ...
    function (u) {
      function z() {
        ...
        try {
          ...
          if (2 != k.get(m) || 3 != k.get(e)) return !1;
          k.delete(m);
          k.set(e, 4);
          return !k.has(m) && 4 == k.get(e);
        } catch (g) {
          return !1;
        }
      }
      ...
      function t(m) {
        var e = typeof m;
        return ("object" === e && null !== m) || "function" === e;
      }
      function r(m) {
        if (!$jscomp.owns(m, l)) {
          var e = new v();
          $jscomp.defineProperty(m, l, { value: e });
        }
      }
      function A(m) {
        if (!$jscomp.ISOLATE_POLYFILLS) {
          ...
          e &&
            (Object[m] = function (k) {
              if (k instanceof v) return k;
              Object.isExtensible(k) && r(k);
              return e(k);
            });
        }
      }
      if ($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS) {
        if (u && $jscomp.ES6_CONFORMANCE) return u;
      } else if (z()) return u;
      ...
      var d = 0,
        h = function (m) {
          ...
          if (m) {
            ...
            for (var e; !(e = m.next()).done; )
              (e = e.value), this.set(e[0], e[1]);
          }
        };
      h.prototype.set = function (m, e) {
        if (!t(m)) throw Error("Invalid WeakMap key");
        r(m);
      ...
      h.prototype.get = function (m) {
        return t(m) && $jscomp.owns(m, l) ? m[l][this.id_] : void 0;
      };
      h.prototype.has = function (m) {
        return t(m) && $jscomp.owns(m, l) && $jscomp.owns(m[l], this.id_);
      };
  ...
  $jscomp.polyfill(
    ...
    function (u) {
      function z() {
        ...
        try {
          var h = Object.seal({ x: 4 }),
            m = new u($jscomp.makeIterator([[h, "s"]]));
          if (
            "s" != m.get(h) ||
            1 != m.size ||
            m.get({ x: 4 }) ||
          ...
          var e = m.entries(),
            k = e.next();
          if (k.done || k.value[0] != h || "s" != k.value[1]) return !1;
          k = e.next();
          return k.done ||
            4 != k.value[0].x ||
            "t" != k.value[1] ||
      ...
      t.prototype.has = function (h) {
        return !!r(this, h).entry;
      };
      t.prototype.get = function (h) {
        return (h = r(this, h).entry) && h.value;
      };
      ...
      t.prototype.forEach = function (h, m) {
        for (var e = this.entries(), k; !(k = e.next()).done; )
          (k = k.value), h.call(m, k[1], k[0], this);
      };
      ...
      var r = function (h, m) {
          ...
          "object" == e || "function" == e
            ...
            : (e = "p_" + m);
          var k = h.data_[e];
          if (k && $jscomp.owns(h.data_, e))
            for (h = 0; h < k.length; h++) {
              var g = k[h];
              if ((m !== m && g.key !== g.key) || m === g.key)
                return { id: e, list: k, index: h, entry: g };
            }
        ...
        A = function (h, m) {
          ...
          return $jscomp.iteratorPrototype(function () {
            if (e) {
              for (; e.head != h.head_; ) e = e.previous;
              for (; e.next != e.head; )
                return (e = e.next), { done: !1, value: m(e) };
              e = null;
            }
  ...
  $jscomp.polyfill(
    ...
    function (u) {
      ...
      r.prototype.executeOnSettledCallbacks_ = function () {
        if (null != this.onSettledCallbacks_) {
          for (var l = 0; l < this.onSettledCallbacks_.length; ++l)
            A.asyncExecute(this.onSettledCallbacks_[l]);
      ...
      r.prototype.then = function (l, d) {
        ...
        var m,
          e,
          k = new r(function (g, w) {
            m = g;
            e = w;
          });
        this.callWhenSettled_(h(l, m), h(d, e));
        return k;
      };
      ...
      r.race = function (l) {
        return new r(function (d, h) {
          for (
            var m = $jscomp.makeIterator(l), e = m.next();
            !e.done;
            e = m.next()
          )
            v(e.value).callWhenSettled_(d, h);
        });
      };
      r.all = function (l) {
        ...
        return h.done
          ...
          : new r(function (m, e) {
              ...
              do
                g.push(void 0),
                  w++,
                  v(h.value).callWhenSettled_(k(g.length - 1), e),
                  (h = d.next());
              while (!h.done);
            });
      };
  ...
  $jscomp.checkStringArgs = function (u, z, v) {
    if (null == u)
      throw new TypeError(
    ...
    function (u) {
      return u
        ...
        : function (z, v) {
            ...
            z += "";
            void 0 === v && (v = t.length);
            v = Math.max(0, Math.min(v | 0, t.length));
            for (var r = z.length; 0 < r && 0 < v; )
              if (t[--v] != z[--r]) return !1;
            return 0 >= r;
          };
    },
  ...
  $jscomp.findInternal = function (u, z, v) {
    u instanceof String && (u = String(u));
    for (var t = u.length, r = 0; r < t; r++) {
      var A = u[r];
      if (z.call(v, A, r, u)) return { i: r, v: A };
    }
    return { i: -1, v: void 0 };
  };
  $jscomp.polyfill(
    ...
    function (u) {
      return u
        ? u
        : function (z, v) {
            return $jscomp.findInternal(this, z, v).v;
          };
    },
    "es6",
    "es3",
    ...
    $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign
      ...
      : function (u, z) {
          for (var v = 1; v < arguments.length; v++) {
            var t = arguments[v];
            if (t) for (var r in t) $jscomp.owns(t, r) && (u[r] = t[r]);
          }
          return u;
        };
  $jscomp.polyfill(
    ...
    function (u) {
      function z() {
        ...
        try {
          ...
          var A = r.entries(),
            l = A.next();
          if (l.done || l.value[0] != t || l.value[1] != t) return !1;
          l = A.next();
          return l.done ||
            l.value[0] == t ||
            4 != l.value[0].x ||
      ...
      v.prototype.keys = v.prototype.values;
      v.prototype[Symbol.iterator] = v.prototype.values;
      v.prototype.forEach = function (t, r) {
        var A = this;
        this.map_.forEach(function (l) {
          return t.call(r, l, l, A);
        });
      };
      return v;
    },
  ...
  $jscomp.iteratorFromArray = function (u, z) {
  ...
  (function (u) {
    function z(t) {
      ...
      u[t].call(r.exports, r, r.exports, z);
      r.l = !0;
      return r.exports;
    }
    var v = {};
    ...
    z.c = v;
    z.d = function (t, r, A) {
      z.o(t, r) || Object.defineProperty(t, r, { enumerable: !0, get: A });
    };
    z.r = function (t) {
      ...
      var t = v(2),
        r = function (m, e) {
          Object(t.a)("disableLogs") ||
            (e ? console.warn("".concat(m, ": ").concat(e)) : console.warn(m));
        },
        A = function (m, e) {
          Object(t.a)("disableLogs") ||
            (e ? console.log("".concat(m, ": ").concat(e)) : console.log(m));
        },
        l = function (m) {
          if (!Object(t.a)("disableLogs")) throw (console.error(m), Error(m));
        },
        d = function (m, e) {},
        h = function (m, e) {};
    },
      ...
      var t = v(14),
        ...
        d = function (g) {
          ...
          g
            ...
            : ((console.log = r), (console.warn = A), (console.error = l));
        },
        h = function () {
        ...
        k = function (g, w) {
          w ? console.warn("".concat(g, ": ").concat(w)) : console.warn(g);
        };
    },
    function (u, z, v) {
      v.d(z, "a", function () {
    ...
    function (u, z, v) {
      ...
      var t = v(11),
        ...
        m = !1,
        e = function (D, x) {
          m || (h("".concat(d.basePath, "decode.min.js")), (m = !0));
          D = self.BrotliDecode(Object(l.b)(D));
          return x ? D : Object(l.a)(D);
        },
        k = function (D, x) {
          return Object(t.a)(void 0, void 0, Promise, function () {
            var E;
            return Object(t.b)(this, function (F) {
              switch (F.label) {
                case 0:
                  return m
                    ? [3, 2]
                ...
                case 2:
                  return (
                    (E = self.BrotliDecode(Object(l.b)(D))),
                    [2, x ? E : Object(l.a)(E)]
                  );
              }
            });
      ...
      (function () {
        ...
        D.prototype.processRaw = function (x) {
          return x;
        };
        D.prototype.processBrotli = function (x) {
          this.remainingDataArrays.push(x);
          return null;
        };
        D.prototype.GetNextChunk = function (x) {
          this.decodeFunction ||
            (this.decodeFunction =
        ...
        D.prototype.End = function () {
          if (this.remainingDataArrays.length) {
            for (var x = this.arrays, E = 0, F = 0; F < x.length; ++F)
              E += x[F].length;
            E = new Uint8Array(E);
            var H = 0;
      ...
      var g = function (D) {
          var x = !D.shouldOutputArray,
            E = new XMLHttpRequest();
          E.open("GET", D.url, D.isAsync);
          var F = x && E.overrideMimeType;
          E.responseType = F ? "text" : "arraybuffer";
          F && E.overrideMimeType("text/plain; charset=x-user-defined");
          E.send();
          var H = function () {
            var b = Date.now();
            var c = F ? E.responseText : new Uint8Array(E.response);
            Object(r.a)("worker", "Result length is ".concat(c.length));
            c.length < D.compressedMaximum
              ? ((c = D.decompressFunction(c, D.shouldOutputArray)),
                Object(r.e)(
            ...
            h &&
              Object(r.a)(
                "worker",
                "".concat(D.url, " Decompression took ").concat(Date.now() - b),
              );
            return c;
          };
          if (D.isAsync)
            var a = new Promise(function (b, c) {
              E.onload = function () {
                200 === this.status || 0 === this.status
                  ? b(H())
                  : c("Download Failed ".concat(D.url));
              };
              E.onerror = function () {
                c("Network error occurred ".concat(D.url));
              };
            });
          else {
            if (200 === E.status || 0 === E.status) return H();
            throw Error("Failed to load ".concat(D.url));
          }
          return a;
        },
        w = function (D) {
          var x = D.lastIndexOf("/");
          -1 === x && (x = 0);
          var E = D.slice(x).replace(".", ".br.");
          h ||
            (E.endsWith(".js.mem")
              ? (E = E.replace(".js.mem", ".mem"))
              : E.endsWith(".js") && (E = E.concat(".mem")));
          return D.slice(0, x) + E;
        },
        n = function (D, x) {
          x.url = w(D);
          x.decompressFunction = h ? e : k;
          return g(x);
        },
        p = function (D, x, E, F) {
        ...
        y = function (D, x, E, F) {
          a: {
            var H = [n];
            x = { compressedMaximum: x, isAsync: E, shouldOutputArray: F };
            if (x.isAsync) {
              var a = H[0](D, x);
              for (E = 1; E < H.length; ++E) a = p(a, D, x, H[E]);
            } else {
    ...
    function (u, z, v) {
      ...
      var t = function (A) {
          if ("string" === typeof A) {
            for (
              var l = new Uint8Array(A.length), d = A.length, h = 0;
              h < d;
              h++
            )
              l[h] = A.charCodeAt(h);
        ...
        r = function (A) {
          if ("string" !== typeof A) {
            for (var l = "", d = 0, h = A.length, m; d < h; )
              (m = A.subarray(d, d + 1024)),
                (d += 1024),
    ...
    function (u, z, v) {
      ...
      var A = (function () {
        var p = r.navigator.userAgent.match(/OPR/),
          ...
          D = r.navigator.userAgent.match(/Edge/);
        return r.navigator.userAgent.match(/Chrome\/(.*?) /) && !p && !y && !D;
      })();
      (function () {
        if (!A) return null;
      ...
      var m = r.navigator.userAgent.match(/Firefox/);
      (function () {
        if (!m) return null;
      ...
      var e = /Mac OS X 10_13_6.*\(KHTML, like Gecko\)$/.test(
        ...
        k = r.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)
          ? 14 <=
            parseInt(
    ...
    function (u, z, v) {
      ...
      var r, A, l;
      !(function (d) {
        "object" === t(z) && "undefined" !== typeof u
          ? (u.exports = d())
          : !((A = []),
            (r = d),
            (l = "function" === typeof r ? r.apply(z, A) : r),
            void 0 !== l && (u.exports = l));
      })(function () {
        return (function k(h, m, e) {
          function g(p, y) {
            if (!m[p]) {
              if (!h[p]) {
                if (w) return w(p, !0);
          ...
          for (var w = !1, n = 0; n < e.length; n++) g(e[n]);
          return g;
        })(
          {
            1: [
              function (h, m, e) {
                var k = {}.hasOwnProperty,
                  g = function (w, n) {
                    ...
                    for (var y in n) k.call(n, y) && (w[y] = n[y]);
                    p.prototype = n.prototype;
                    w.prototype = new p();
                    w.__super__ = n.prototype;
                    return w;
                  };
                e = h("./PriorityQueue/AbstractPriorityQueue");
                ...
                e = (function (w) {
                  function n(p) {
                    ...
                    p.comparator ||
                      (p.comparator = function (y, D) {
                        return (y || 0) - (D || 0);
                      });
                    n.__super__.constructor.call(this, p);
                  }
                  g(n, w);
                  return n;
                })(e);
            ...
            2: [
              function (h, m, e) {
                m.exports = (function () {
                  ...
                  k.prototype.queue = function (g) {
                    this.length++;
                    this.priv.queue(g);
                  };
                  k.prototype.dequeue = function (g) {
                    if (!this.length) throw "Empty queue";
                    this.length--;
                    return this.priv.dequeue();
                  };
                  k.prototype.peek = function (g) {
                    if (!this.length) throw "Empty queue";
                  ...
                  k.prototype.find = function (g) {
                    return 0 <= this.priv.find(g);
                  };
                  k.prototype.removeAllMatching = function (g, w) {
                    g = this.priv.removeAllMatching(g, w);
                    this.length -= g;
                  };
                  return k;
                })();
            ...
            3: [
              function (h, m, e) {
                ...
                m.exports = (function () {
                  ...
                  g.prototype.queue = function (w) {
                    var n = k(this.data, w, this.comparator);
                    this.data.splice(n, 0, w);
                  };
                  ...
                  g.prototype.find = function (w) {
                    var n = k(this.data, w, this.comparator) - 1;
                    return 0 <= n && !this.comparator(this.data[n], w) ? n : -1;
                  };
                  g.prototype.remove = function (w) {
                    w = this.find(w);
                    return 0 <= w ? (this.data.splice(w, 1), !0) : !1;
                  };
                  g.prototype.removeAllMatching = function (w, n) {
                    for (var p = 0, y = this.data.length - 1; 0 <= y; --y)
                      if (w(this.data[y])) {
                        var D = this.data.splice(y, 1)[0];
                        n && n(D);
                        ++p;
                      }
                    return p;
    ...
    function (u, z, v) {
      (function (t) {
        ...
        z.setTimeout = function () {
          return new r(l.call(setTimeout, A, arguments), clearTimeout);
        };
        z.setInterval = function () {
          return new r(l.call(setInterval, A, arguments), clearInterval);
        };
    ...
    function (u, z, v) {
      function t(A, l, d) {
        return new Promise(function (h) {
          if (!A) return h();
          var m = d.document.createElement("script");
      ...
      function t(d, h, m) {
        function e(w) {
          ...
          return w
            ...
            : Object(A.b)(d, m, !0, !0).then(function (n) {
                k = Date.now();
                Object(r.a)("load", "Request took ".concat(k - g, " ms"));
                return WebAssembly.instantiate(n, h);
              });
        }
        var k, g;
        return e(!!WebAssembly.instantiateStreaming).then(function (w) {
          Object(r.a)(
            "load",
            "WASM compilation took ".concat(Date.now() - (k || g), " ms"),
          );
          return w;
        });
      }
    ...
    function (u, z, v) {
      function t(A, l, d, h) {
        ...
        return new (d || (d = Promise))(function (e, k) {
          ...
          function n(p) {
            p.done ? e(p.value) : m(p.value).then(g, w);
          }
          n((h = h.apply(A, l || [])).next());
        });
      }
      function r(A, l) {
        function d(n) {
                ...
                k &&
                  (g =
                    n[0] & 2
                      ? k["return"]
                      : n[0]
                        ? k["throw"] || ((g = k["return"]) && g.call(k), 0)
                        : k.next) &&
                  !(g = g.call(k, n[1])).done)
              )
                return g;
              if (((k = 0), g)) n = [n[0] & 2, g.value];
              switch (n[0]) {
                case 0:
                case 1:
                  g = n;
                  break;
                case 4:
                  return m.label++, { value: n[1], done: !1 };
                case 5:
                  m.label++;
                  k = n[1];
                  n = [0];
                ...
                default:
                  if (
                    !((g = m.trys), (g = 0 < g.length && g[g.length - 1])) &&
                    (6 === n[0] || 2 === n[0])
                  ) {
                    m = 0;
                    continue;
                  ...
                  if (3 === n[0] && (!g || (n[1] > g[0] && n[1] < g[3])))
                    m.label = n[1];
                  else if (6 === n[0] && m.label < g[1])
                    (m.label = g[1]), (g = n);
                  else if (g && m.label < g[2]) (m.label = g[2]), m.ops.push(n);
                  else {
                    g[2] && m.ops.pop();
                    m.trys.pop();
                    continue;
    ...
    function (u, z) {
      ...
      function r(y) {
        if (e === setTimeout) return setTimeout(y, 0);
        if ((e === v || !e) && setTimeout)
        ...
        try {
          ...
          try {
            ...
            return e.call(this, y, 0);
          }
        }
      }
      function A(y) {
        if (k === clearTimeout) return clearTimeout(y);
        if ((k === t || !k) && clearTimeout)
          return (k = clearTimeout), clearTimeout(y);
        try {
          return k(y);
        } catch (D) {
          try {
            return k.call(null, y);
          } catch (x) {
      ...
      function l() {
        w &&
          n &&
          ((w = !1), n.length ? (g = n.concat(g)) : (p = -1), g.length && d());
      }
      function d() {
        if (!w) {
          var y = r(l);
      ...
      u = u.exports = {};
      try {
        var e = "function" === typeof setTimeout ? setTimeout : v;
      } catch (y) {
        e = v;
      }
      try {
        var k = "function" === typeof clearTimeout ? clearTimeout : t;
      } catch (y) {
        k = t;
      }
      var g = [],
        ...
        n,
        p = -1;
      u.nextTick = function (y) {
        var D = Array(arguments.length - 1);
        if (1 < arguments.length)
          for (var x = 1; x < arguments.length; x++) D[x - 1] = arguments[x];
        g.push(new h(y, D));
        1 !== g.length || w || r(d);
      };
      ...
      u.listeners = function (y) {
        return [];
      };
      u.binding = function (y) {
    ...
    function (u, z, v) {
      (function (t) {
        function r(E) {
          "function" !== typeof E && (E = new Function("".concat(E)));
          for (var F = Array(arguments.length - 1), H = 0; H < F.length; H++)
            F[H] = arguments[H + 1];
          n[w] = { callback: E, args: F };
          D(w);
          return w++;
        }
        function A(E) {
        ...
        function m() {
          var E = "setImmediate$".concat(Math.random(), "$"),
            F = function (H) {
              (H.source !== g && H.source !== g.parent) ||
                "string" !== typeof H.data ||
                0 !== H.data.indexOf(E) ||
                l(+H.data.slice(E.length));
            };
          g.addEventListener
            ? g.addEventListener("message", F, !1)
            : g.attachEvent("onmessage", F);
          D = function (H) {
            g.postMessage(E + H, "*");
          };
        }
        ...
        var g = "undefined" === typeof window ? self : window,
          ...
          y = g.document,
          D,
          x = Object.getPrototypeOf && Object.getPrototypeOf(g);
        x = x && x.setTimeout ? x : g;
        ...
        x.setImmediate = r;
        x.clearImmediate = A;
        z.a = { setImmediate: r, clearImmediate: A };
      }).call(this, v(12));
    },
    function (u, z, v) {
      var t = v(0),
      ...
      u = (function () {
        ...
        A.prototype.clearActionHandlers = function () {
          this.actionHandler = {};
        ...
        A.prototype.replace = function (l, d, h) {
          this.actionHandler[l] = [d, h];
        };
        A.prototype.onAsync = function (l, d, h) {
        ...
        A.prototype.replaceAsync = function (l, d, h) {
          var m = this.actionHandlerAsync,
            e = this.actionHandler;
          e[l] && delete e[l];
          m[l] = [d, h];
        };
        A.prototype.onNextAsync = function (l) {
          this.nextAsync = l;
        };
        A.prototype.send = function (l, d) {
          this.postMessage({ action: l, data: d });
        };
        A.prototype.getNextId = function () {
          return this.callbackIndex++;
        };
        A.prototype.sendWithPromise = function (l, d, h) {
          var m = this.getNextId();
          l = { action: l, data: d, callbackId: m, priority: h };
          d = window.createPromiseCapability();
          this.callbacksCapabilities[m] = d;
          try {
            this.postMessage(l);
          } catch (e) {
            d.reject(e);
        ...
        A.prototype.sendWithPromiseReturnId = function (l, d, h) {
          var m = this.getNextId();
          l = { action: l, data: d, callbackId: m, priority: h };
          d = window.createPromiseCapability();
          this.callbacksCapabilities[m] = d;
          ...
          return { promise: d.promise, callbackId: m };
        };
        A.prototype.sendWithPromiseWithId = function (l, d, h) {
          ...
          l = { action: l, data: h, callbackId: d };
          h = window.createPromiseCapability();
          this.callbacksCapabilities[d] = h;
          try {
            this.postMessage(l);
          } catch (m) {
            h.reject(m);
        ...
        A.prototype.sendError = function (l, d) {
        ...
        A.prototype.getPromise = function (l) {
          if (l in this.callbacksCapabilities)
            return this.callbacksCapabilities[l];
          Object(t.c)("Cannot get promise for callback ".concat(l));
        };
        A.prototype.cancelPromise = function (l) {
          if (l in this.callbacksCapabilities) {
          ...
          } else Object(t.b)("Cannot cancel callback ".concat(l));
        };
        A.prototype.postMessage = function (l) {
        ...
        A.prototype.getObjectTransfers = function (l, d) {
          var h = this;
          null !== l &&
            "object" === typeof l &&
            (l instanceof Uint8Array
              ...
              : l instanceof ArrayBuffer
                ...
                : Object.keys(l).forEach(function (m) {
                    l.hasOwnProperty(m) && h.getObjectTransfers(l[m], d);
                  }));
        };
        A.prototype.getTransfersArray = function (l) {
          var d = [];
          this.getObjectTransfers(l, d);
          return 0 === d.length ? void 0 : d;
        };
        A.prototype.handleMessage = function (l) {
          var d = this,
            h = l.data;
          "officeeditor" !== this.name &&
            Object(r.a)("enableWorkerLogs") &&
          ...
          if (h.isReply)
            (m = h.callbackId),
              m in l
                ? ((e = l[m]),
                  delete l[m],
                  k.has(m) && k.delete(m),
                  "error" in h ? e.reject(h.error) : e.resolve(h.data))
                : Object(t.a)("Cannot resolve callback ".concat(m));
          else if (h.action in m) {
            var g = m[h.action];
            h.callbackId
              ? Promise.resolve()
                  .then(function () {
                    return g[0].call(g[1], h.data);
                  })
                  .then(
                    function (w) {
                      d.postMessage({
            ...
            h.action in e
              ...
              : Object(t.c)("Unknown action from worker: ".concat(h.action));
        };
        return A;
      })();
      z.a = u;
    ...
    function (u, z, v) {
      ...
      var t = v(3),
        ...
        l = (function () {
          function h(m) {
            var e = this;
            this.promise = m.then(function (k) {
              e.response = k;
              e.status = 200;
            });
          }
          h.prototype.addEventListener = function (m, e) {
            this.promise.then(e);
          };
          return h;
        })(),
        d = function (h, m, e) {
          if (Object(A.a)() && !e) {
            self.Module.instantiateWasm = function (g, w) {
              return Object(r.a)(
                "".concat(h, "Wasm.wasm"),
                g,
                m["Wasm.wasm"],
            ...
            if (m.disableObjectURLBlobs) {
              importScripts("".concat(h, "Wasm.js"));
              return;
            }
            e = Object(t.b)(
              "".concat(h, "Wasm.js.mem"),
              m["Wasm.js.mem"],
              !1,
              !1,
            );
            ...
            if (m.disableObjectURLBlobs) {
              importScripts(
                "".concat(
                  (self.Module.asmjsPrefix ? self.Module.asmjsPrefix : "") + h,
                  ".js",
                ),
              );
              return;
            ...
            self.Module.memoryInitializerRequest = new l(k);
          }
        ...
        "undefined" === typeof t.crypto &&
          (t.crypto = {
            getRandomValues: function (r) {
              for (var A = 0; A < r.length; A++) r[A] = 256 * Math.random();
            },
          });
    ...
    function (u, z, v) {
      (function (t, r) {
        ...
        (function (l) {
          function d() {
            for (var B = 0; B < C.length; B++) C[B][0](C[B][1]);
            C = [];
            G = !1;
          }
          function h(B, I) {
          ...
          function k(B, I) {
            ...
            try {
              ...
              if (I && ("function" === typeof I || "object" === A(I))) {
                var L = I.then;
                if ("function" === typeof L)
                  return (
                    L.call(
          ...
          function w(B, I) {
            B.state_ === H && ((B.state_ = a), (B.data_ = I), h(y, B));
          }
          function n(B, I) {
            B.state_ === H && ((B.state_ = a), (B.data_ = I), h(D, B));
          }
          function p(B) {
            var I = B.then_;
            B.then_ = void 0;
            for (B = 0; B < I.length; B++) e(I[B]);
          }
          function y(B) {
            B.state_ = b;
            p(B);
          ...
          "undefined" !== typeof exports && exports
            ? ((exports.Promise = F ? E : x), (exports.Polyfill = x))
            : "function" === typeof define && v(24)
              ? define(function () {
                  return F ? E : x;
                })
              : F || (l.Promise = x);
          ...
          x.all = function (B) {
            ...
            return new this(function (I, J) {
              ...
              for (var K = [], N = 0, M = 0, Q; M < B.length; M++)
                (Q = B[M]) && "function" === typeof Q.then
                  ? Q.then(L(M), J)
                  : (K[M] = Q);
              N || I(K);
            });
          ...
          x.race = function (B) {
            ...
            return new this(function (I, J) {
              for (var L = 0, K; L < B.length; L++)
                (K = B[L]) && "function" === typeof K.then
                  ? K.then(I, J)
                  : I(K);
            });
          };
          x.resolve = function (B) {
            return B && "object" === A(B) && B.constructor === this
              ? B
              : new this(function (I) {
                  I(B);
                });
      ...
      }).call(this, v(10), v(7).setImmediate);
    },
    function (u, z, v) {
      (function (t, r) {
        (function (A, l) {
            ...
            var H = "setImmediate$" + Math.random() + "$",
              a = function (b) {
                b.source === A &&
                  ...
                  0 === b.data.indexOf(H) &&
                  h(+b.data.slice(H.length));
              };
            A.addEventListener
              ? A.addEventListener("message", a, !1)
              : A.attachEvent("onmessage", a);
            E = function (b) {
              A.postMessage(H + b, "*");
            };
          }
    ...
    function (u, z, v) {
      (function (t) {
        var r = function (A, l) {
          ...
          return { cancel: l, promise: A, then: h.bind(A), catch: d.bind(A) };
        };
        t.CancellablePromise = function (A, l) {
          var d = !1,
            h,
            m = new Promise(function (e, k) {
              h = function () {
                d || (l(), k("cancelled"));
              };
              new Promise(A).then(
        ...
        t.CancellablePromise.all = function (A) {
          var l = Promise.all(A);
          return r(l, function () {
    ...
    function (u, z, v) {
      (function (t, r) {
        ...
        function d(m) {
          for (var e = 1; e < arguments.length; e++) {
            ...
            e % 2
              ? l(Object(k), !0).forEach(function (g) {
                  var w = k[g];
                  a: if ("object" === A(g) && null !== g) {
                    var n = g[Symbol.toPrimitive];
                    if (void 0 !== n) {
                      g = n.call(g, "string");
                      if ("object" !== A(g)) break a;
                      throw new TypeError(
        ...
        (function (m) {
          m.Module = {
            ...
            postProgressiveRenderingStartEvent: function (e, k) {
              Module.postEvent(e, "progressiveRenderingStart", { pageNum: k });
            },
            postPagesUpdatedEvent: function (e, k, g, w) {
              e = { pageDimensions: Module.GetPageDimensions(e) };
              if (g)
                for (var n = 0; n < g.length; ++n)
                  g[n] in e.pageDimensions
                    ? ((e.pageDimensions[g[n]].contentChanged = !0),
                      w && (e.pageDimensions[g[n]].annotationsUnchanged = !0))
                    : console.warn("Invalid Page Number ".concat(g[n]));
              Module.postEvent(k, "pagesUpdated", e);
              return e;
            },
            postPagesRenamedEvent: function (e, k) {
              var g = {};
              e = Module.PDFDocGetPageIterator(e, 1);
              for (var w = 1; Module.IteratorHasNext(e); ++w) {
                var n = Module.stackSave(),
                  p = Module.IteratorCurrent(e);
                g[w] = Module.PageGetId(p);
                Module.IteratorNext(e);
                Module.stackRestore(n);
              }
              Module.postEvent(k, "pagesRenamed", { pageNumToId: g });
            },
            GetIndividualPageDimensions: function (e, k, g) {
              e = Module.PageGetPageInfo(g);
              e.id = Module.PageGetId(g);
              return e;
            },
            GetPageDimensionsRange: function (e, k, g) {
              for (
                var w = {}, n = Module.PDFDocGetPageIterator(e, k);
                k < g && Module.IteratorHasNext(n);
                ++k
              ) {
                var p = Module.stackSave(),
                  y = Module.IteratorCurrent(n);
                w[k] = this.GetIndividualPageDimensions(e, k, y);
                Module.IteratorNext(n);
                Module.stackRestore(p);
              }
              return w;
            },
            GetPageDimensionsContentChangedList: function (e, k) {
              k.sort(function (E, F) {
                return E - F;
              });
              for (
                var g = {},
                  ...
                  n = k[k.length - 1],
                  p = 0,
                  y = Module.PDFDocGetPageIterator(e, w);
                w <= n && Module.IteratorHasNext(y);
                ++w
              ) {
                if (k[p] == w) {
                  for (++p; k[p] == w; ) ++p;
                  var D = Module.stackSave(),
                    x = Module.IteratorCurrent(y);
                  x = this.GetIndividualPageDimensions(e, w, x);
                  x.contentChanged = !0;
                  g[w] = x;
            ...
            loadDoc: function (e, k) {
              ...
              try {
                ...
                k = Module.CreateDoc(e, k);
                var n = Module.GetDoc(k);
            ...
            loadCanvas: function (e, k, g, w, n, p, y, D) {
              var x = Module.GetDoc(e),
                E = Module.docs[e].chunkStorage,
                F = Promise.resolve();
              if (E && 2 === D.overprintMode) {
                var H = Module.GetDownloadData(x);
                if (!H.docInfoRequested) {
                  var a = Module.allocate(4, "i8", Module.ALLOC_STACK);
                  REX(Module._TRN_DownloaderPrefetchDocInfo(H.downloader, a));
                  0 == Module.getValue(a, "i8") &&
                    (F = H.docInfoPromiseCapability.promise);
                  H.docInfoRequested = !0;
                }
              }
              return new Promise(function (b, c) {
                var q = k + 1,
                  f = function () {
                    b(
                      F.then(function () {
                        return Module.RasterizePage(x, q, g, w, p, n, y, D, e);
                      }),
                    );
                  };
                if (E) {
                  var C = Module.GetDownloadData(x).downloader,
                    G = E.getRequiredChunkOffsetArrays(C, q);
                  E.keepChunks(G.have);
                  C = function () {
                    var B = E.getChunks(G.missing);
                    Module.loadPromise = B.then(function () {
                      var I = Module.loadPromise.cancelled;
                      Module.loadPromise = null;
                      I || f();
                    })["catch"](function (I) {
                      "cancelled" !== I ? c(I) : (Module.loadPromise = null);
                    });
                  };
            ...
            loadResources: function (e, k) {
              Module.Initialize(k);
              Object(h.b)("worker", "PDFNet initialized!");
            ...
            onRuntimeInitialized: function () {
              ...
              (function (e) {
                e.PDFDocExportXFDF = function (k, g) {
                  k = Module.GetDoc(k);
                  var w = Module.stackSave();
                  try {
                    var n = g
                      ? Module.PDFDocFDFExtract(k, g)
                      : Module.PDFDocFDFExtract(k);
                    var p = Module.FDFDocSaveAsXFDF(n);
                    Module.stackRestore(w);
                  } catch (y) {
                    throw (Module.stackRestore(w), y);
                  }
                  return p;
                };
                e.PageArrayToPageSet = function (k) {
                  var g = Module.stackSave();
                  try {
                    var w = Module.PageSetCreate();
                    for (var n = 0; n < k.length; ++n)
                      Module.PageSetAddPage(w, k[n]);
                ...
                e.cancelCurrent = function () {
                  ...
                  return k
                    ...
                    : (k = Module.cleanupState)
                      ? (t(k.timeout),
                        k.cleanupArr.reverse().forEach(function (g) {
                          g();
                        }),
                ...
                e.SetWorkerRestartCallback = function (k) {
                  Module.workerRestartCallback = k;
                };
                e.XFDFMerge = function (k, g, w) {
                  if (g) {
                    var n = Module.GetDoc(k),
                      p = [];
                    try {
                      ...
                      REX(Module._TRN_FDFDocCreateFromXFDF(y, D));
                      var x = Module.getValue(D, "i8*");
                      p.push(function () {
                        Module.FDFDocDestroy(x);
                      });
                      var E = Module.PDFDocFDFUpdate(n, x, w);
                      E &&
                        E.length &&
                      ...
                      p.reverse().forEach(function (F) {
                        F();
                      });
                    }
                  }
                };
                e.MergeXFDF = function (k, g, w) {
                ...
                e.CreateBufferFile = function (k, g, w) {
                  Module.MakeDev(k);
                  var n = new ArrayBuffer(g);
                  n = new Uint8Array(n);
                  w = w ? 0 : 255;
                  for (var p = 0; p < g; ++p) n[p] = w;
                  Module.docs[k] = { buffer: n };
                };
                e.ReadBufferFile = function (k, g) {
                  var w = Module.docs[k].buffer;
                  g &&
                    (Module.docs[k].buffer = new Uint8Array(w.buffer.slice(0)));
                  return w;
                };
                e.RemoveBufferFile = function (k) {
                  Module.docs[k] = null;
                };
                e.SaveHelper = function (k, g, w) {
                  w = "undefined" === typeof w ? 2 : w;
                  Module.MakeDev(g);
                  ...
                  REX(n);
                  w & 16 && Module.postPagesRenamedEvent(k, g);
                  return Module.docs[g].buffer.buffer;
                };
                e.SaveDoc = function (k, g, w, n, p, y, D, x, E) {
                  return new Promise(function (F, H) {
                    var a = [];
                    try {
                      var b = Module.GetDoc(k),
                        c = Module.stackSave();
                      a[a.length] = function () {
                        Module.stackRestore(c);
                      };
                      Module.XFDFMerge(k, g, D);
                      var q = Module.allocate(8, "i8", Module.ALLOC_STACK),
                        f = Module.allocate(
                      ...
                      Module.setValue(q, f, "i8*");
                      Module.setValue(q + 4, 0, "i32");
                      Module._TRN_PDFDocRefreshAnnotAppearances(b, q);
                      if (y) {
                        q = function (O) {
                          O = new Uint8Array(O);
                          m.FS.writeFile("watermarkFile", O);
                        ...
                        var G = Module.ElementWriterCreate();
                        a.push(function () {
                          Module.ElementWriterDestroy(G);
                        });
                        try {
                          ...
                          var B = q(y["default"]),
                            I = Module.PDFDocGetPageIterator(b, 1);
                          for (f = -1; Module.IteratorHasNext(I); ) {
                            var J = Module.IteratorCurrent(I);
                            ...
                            try {
                              ...
                              Module.ElementWriterBegin(G, J);
                              Module.ElementWriterWritePlacedElement(G, Q);
                              Module.ElementWriterEnd(G);
                            } catch (O) {
                              console.warn(
                                "Watermark for page " +
                                  L +
                      ...
                      if (x) {
                        var R = Module.SecurityHandlerCreate(E);
                        R &&
                      ...
                      if (n) {
                        ...
                        (B = Module.ObjFindObj(P, "OpenAction")) &&
                          Module.ObjPut(P, "__OpenActionBackup__", B);
                ...
                e.SaveDocFromFixedElements = function (k, g, w, n, p, y) {
                  k = Module.PDFDocCreateFromLayoutEls(k);
                  k = Module.CreateDoc({ type: "ptr", value: k });
                  return Module.SaveDoc(k, g, !0, !1, w, n, p, y);
                };
                e.GetCurrentCanvasData = function (k) {
                  var g = Module.currentRenderData;
                  if (!g) return null;
                  k && REX(Module._TRN_PDFRasterizerUpdateBuffer(g.rast));
                  var w = Date.now();
                  if (g.bufPtr) {
                    k = new Uint8Array(new ArrayBuffer(g.buf_size));
                    for (var n = 0, p = 0; p < g.out_height; ++p)
                      for (
                        var y = g.bufPtr + g.stride * p, D = 0;
                        D < g.out_width;
                        ++D
                      )
                        (k[n++] = Module.HEAPU8[y + 2]),
                          (k[n++] = Module.HEAPU8[y + 1]),
                          (k[n++] = Module.HEAPU8[y]),
                          (k[n++] = Module.HEAPU8[y + 3]),
                          (y += 4);
                  } else k = Module.ReadBufferFile("b", k);
                  Object(h.b)(
                    "bufferTiming",
                    "Copy took ".concat(Date.now() - w),
                  );
                  return {
                    pageBuf: k.buffer,
                ...
                e.RasterizePage = function (k, g, w, n, p, y, D, x, E) {
                  return new Promise(function (F, H) {
                    Module.currentRenderData = {};
                    var a = Module.currentRenderData;
                    a.out_width = parseInt(w, 10);
                    ...
                    try {
                      ...
                      var q = Module.GetPage(k, g),
                        f = Module.PageGetPageWidth(q),
                        C = Module.PageGetPageHeight(q);
                      a.stride = 4 * a.out_width;
                      a.buf_size = a.out_width * a.out_height * 4;
                      Object(h.b)("Memory", "Created rasterizer");
                      a.rast = Module.PDFRasterizerCreate();
                      b.push(function () {
                        Object(h.b)("Memory", "Destroyed rasterizer");
                        Module._TRN_PDFRasterizerDestroy(a.rast);
                      });
                      if (D) {
                        var G = Module.EMSCreateUpdatedLayersContext(k, D);
                        0 !== G &&
                          (REX(
                            Module._TRN_PDFRasterizerSetOCGContext(a.rast, G),
                          ),
                          b.push(function () {
                            Module._TRN_OCGContextDestroy(G);
                          }));
                      }
                      var B = !1;
                      x.hasOwnProperty("renderAnnots")
                        ? (x.renderAnnots && (B = !0),
                          REX(
                      ...
                      x.hasOwnProperty("highlightFields") &&
                        (x.highlightFields && (B = !0),
                        REX(
                      ...
                      if (x.hasOwnProperty("thinLinePixelGridFit")) {
                        var I = !0;
                        x.hasOwnProperty("thinLineStrokeAdjust") &&
                          (I = x.thinLineStrokeAdjust);
                        REX(
                          Module._TRN_PDFRasterizerSetThinLineAdjustment(
                            a.rast,
                            x.thinLinePixelGridFit,
                            I,
                          ),
                        );
                      } else
                        x.hasOwnProperty("thinLineStrokeAdjust") &&
                          REX(
                            Module._TRN_PDFRasterizerSetThinLineAdjustment(
                              a.rast,
                              !1,
                              x.thinLineStrokeAdjust,
                            ),
                          );
                      x.hasOwnProperty("thinLineScaling") &&
                        REX(
                      ...
                      if (
                        x.hasOwnProperty("nightModeTuningContrast") ||
                        x.hasOwnProperty("nightModeTuningSaturation") ||
                        x.hasOwnProperty("nightModeTuningFlipness")
                      ) {
                        var J = x.hasOwnProperty("nightModeTuningContrast")
                            ? x.nightModeTuningContrast
                            : 0.9,
                          L = x.hasOwnProperty("nightModeTuningSaturation")
                            ? x.nightModeTuningSaturation
                            : 0.8,
                          K = x.hasOwnProperty("nightModeTuningFlipness")
                            ? x.nightModeTuningFlipness
                            : 1;
                        REX(
                      ...
                      x.hasOwnProperty("imageSmoothing")
                        ? ((I = !1),
                          x.hasOwnProperty("hqImageResampling") &&
                            (I = x.hqImageResampling),
                          REX(
                      ...
                      x.hasOwnProperty("expGamma") &&
                        REX(
                          Module._TRN_PDFRasterizerSetGamma(a.rast, x.expGamma),
                        );
                      x.hasOwnProperty("isPrinting") &&
                        (x.isPrinting && (B = !0),
                        REX(
                      ...
                      x.hasOwnProperty("colorPostProcessMode") &&
                        (x.colorPostProcessMode && (B = !0),
                        REX(
                          Module._TRN_PDFRasterizerSetColorPostProcessMode(
                            a.rast,
                            x.colorPostProcessMode,
                          ),
                        ));
                      var N = Module.PageGetRotation(q);
                      I = 1 === y || 3 === y;
                      N = (1 === N || 3 === N) !== I;
                      ...
                      if (p) {
                        ...
                        p.x2 = p[2];
                        p.y2 = p[3];
                        var Q = Module.PageGetDefaultMatrix(q, 0),
                        ...
                        var T = Module.GetDefaultMatrixBox(q, p, y);
                      } else
                        (T = Module.PageGetDefaultMatrix(q, y)),
                          (S = a.out_width / (I ? C : f));
                      ...
                      x.useProgress &&
                        Module.postProgressiveRenderingStartEvent(E, g);
                      var da = r(function W() {
                        try {
                          if (
                            (REX(
                ...
                e.InsertBlankPages = function (k, g, w, n) {
                  return new Promise(function (p, y) {
                    ...
                    try {
                      ...
                      for (var F = g.length - 1; 0 <= F; --F) {
                        var H = Module.PDFDocGetPageIterator(x, g[F]),
                          a = Module.PDFDocPageCreate(x, w, n);
                        Module.PDFDocPageInsert(x, H, a);
                      }
                      var b = Module.postPagesUpdatedEvent(x, k);
                ...
                e.InsertPages = function (k, g, w, n, p, y) {
                  return new Promise(function (D, x) {
                    ...
                    try {
                      ...
                      for (
                        var c = w.length, q = Module.PageSetCreate(), f = 0;
                        f < c;
                        ++f
                      )
                        Module.PageSetAddPage(q, w[f]);
                      y
                        ? Module.PDFDocInsertPages2(F, n, b, q, p)
                        : Module.PDFDocInsertPages(F, n, b, q, p);
                      var C;
                      y || (C = Module.postPagesUpdatedEvent(F, k));
                      E.reverse().forEach(function (G) {
                        G();
                      });
                      D(C);
                    } catch (G) {
                ...
                e.MovePages = function (k, g, w) {
                  return new Promise(function (n, p) {
                    ...
                    try {
                      ...
                      for (
                        var E = g.length, F = Module.PageSetCreate(), H = 0;
                        H < E;
                        ++H
                      )
                        Module.PageSetAddPage(F, g[H]);
                      Module.PDFDocMovePages(D, w, F);
                ...
                e.RemovePages = function (k, g, w) {
                  return new Promise(function (n, p) {
                    var y = Module.GetDoc(k),
                      D = [];
                    try {
                      var x = Module.stackSave();
                      D[D.length] = function () {
                      ...
                      for (var E = g.length - 1; 0 <= E; --E) {
                        var F = Module.PDFDocGetPageIterator(y, g[E]);
                        Module.IteratorHasNext(F) &&
                          (w
                            ? Module.PDFDocPageRemove2(y, F)
                            : Module.PDFDocPageRemove(y, F));
                      }
                      var H;
                      w || (H = Module.postPagesUpdatedEvent(y, k));
                ...
                e.RotatePages = function (k, g, w) {
                  return new Promise(function (n, p) {
                    ...
                    try {
                      ...
                      var E = g.length,
                        F = 0,
                        H = Module.PDFDocGetPageIterator(y, g[0]),
                        a = [];
                      D.push(function () {
                        Module._TRN_IteratorDestroy(H);
                      });
                      for (
                        var b = g[0];
                        Module.IteratorHasNext(H) && F < g[E - 1];
                        ++b
                      ) {
                        if (b === g[F]) {
                          var c = Module.IteratorCurrent(H),
                            q = (Module.PageGetRotation(c) + w) % 4;
                          Module.PageSetRotation(c, q);
                          a.push(b);
                          F++;
                        }
                        Module.IteratorNext(H);
                      }
                      var f = Module.postPagesUpdatedEvent(y, k, a, !0);
                      D.reverse().forEach(function (C) {
                        C();
                      });
                      n(f);
                    } catch (C) {
                      D.reverse().forEach(function (G) {
                        G();
                      }),
                        p(C);
                    }
                ...
                e.ExtractPages = function (k, g, w, n, p, y) {
                  return new Promise(function (D, x) {
                    var E = [];
                    try {
                      ...
                      Module.XFDFMerge(k, w, p);
                      var a = Module.CreateEmptyDoc();
                      E[E.length] = function () {
                        Module.DeleteDoc(a);
                      };
                      var b = Module.InsertPages(a, k, g, 1, !0, y)
                        .then(function () {
                ...
                e.CropPages = function (k, g, w, n, p, y) {
                  return new Promise(function (D, x) {
                    var E = Module.GetDoc(k),
                      F = [];
                    try {
                      var H = Module.stackSave();
                      F[F.length] = function () {
                      ...
                      var a = g.length,
                        b = 0,
                        c = Module.PDFDocGetPageIterator(E, g[0]);
                      F.push(function () {
                      ...
                      for (
                        ...
                        if (f === g[b]) {
                          var C = Module.IteratorCurrent(c),
                            G = Module.allocate(8, "i8", Module.ALLOC_STACK);
                          REX(Module._TRN_PageGetCropBox(C, G));
                          var B = Module.PageGetRotation(C),
                            I = Module.getValue(G, "double"),
                            J = Module.getValue(G + 8, "double"),
                            L = Module.getValue(G + 16, "double"),
                            K = Module.getValue(G + 24, "double");
                          0 === B % 4
                            ? (Module.setValue(G, I + p, "double"),
                              Module.setValue(G + 8, J + n, "double"),
                              Module.setValue(G + 16, L - y, "double"),
                              Module.setValue(G + 24, K - w, "double"))
                            : 1 === B % 4
                              ? (Module.setValue(G, I + w, "double"),
                                Module.setValue(G + 8, J + p, "double"),
                                Module.setValue(G + 16, L - n, "double"),
                                Module.setValue(G + 24, K - y, "double"))
                              : 2 === B % 4
                                ? (Module.setValue(G, I + y, "double"),
                                  Module.setValue(G + 8, J + w, "double"),
                                  Module.setValue(G + 16, L - p, "double"),
                                  Module.setValue(G + 24, K - n, "double"))
                                : 3 === B % 4 &&
                                  (Module.setValue(G, I + n, "double"),
                                  Module.setValue(G + 8, J + y, "double"),
                                  Module.setValue(G + 16, L - w, "double"),
                                  Module.setValue(G + 24, K - p, "double"));
                          Module.setValue(G + 32, 0, "double");
                          REX(Module._TRN_PageSetBox(C, 0, G));
                          REX(Module._TRN_PageSetBox(C, 1, G));
                          q.push(f);
                          b++;
                        }
                        Module.IteratorNext(c);
                      }
                      var N = Module.postPagesUpdatedEvent(E, k, q, !0);
                      F.reverse().forEach(function (M) {
                        M();
                      });
                      D(N);
                    } catch (M) {
                      F.reverse().forEach(function (Q) {
                        Q();
                      }),
                        x(M);
                    }
      ...
      }).call(this, v(7).clearImmediate, v(7).setImmediate);
    },
    function (u, z, v) {
      (function (t) {
        function r(d) {
        ...
        (function (d) {
          ...
          var g = function (a, b, c, q, f) {
              ...
              return CancellablePromise(
                function (G, B) {
                  ...
                  C.onerror = function () {
                    B("Network error occurred");
                  };
                  C.onload = function () {
                    if (206 === this.status && C.response.byteLength === c) {
                      var J = new Int8Array(C.response);
                      G(J);
                    } else B("Download Failed");
                  };
                  var I = ["bytes=", b, "-", b + c - 1].join("");
                  C.setRequestHeader("Range", I);
                  f && (C.withCredentials = f);
                  q &&
                    Object.keys(q).forEach(function (J) {
                      C.setRequestHeader(J, q[J]);
                    });
                  C.send();
                },
                function () {
          ...
          n.prototype = {
            read: function (a, b, c) {
              ...
              b = c;
              for (
                var q = this.filePosition % this.chunkSize,
                  f = this.filePosition - q,
                  C = 0;
                0 < c;
                ...
                var B = G.length,
                  I = q + c;
                I <= B
                  ? (a.set(G.subarray(q, I), C),
                    (this.filePosition += c),
                    (c = 0))
                  : (a.set(G.subarray(q), C),
                    (this.filePosition += B - q),
                    (q = 0),
                    (f = this.filePosition),
                    (c = I - B),
                    (C = b - c));
          ...
          y.prototype = {
            ...
            getChunk: function (a) {
              ...
              if (this.chunkMap[a]) this.lruUpdate(a);
                ...
                q.open("GET", this.url, !1);
                q.responseType = "arraybuffer";
                q.setRequestHeader("Range", ["bytes=", a, "-", c].join(""));
                this.withCredentials &&
                  (q.withCredentials = this.withCredentials);
                this.customHeaders &&
                  Object.keys(this.customHeaders).forEach(function (f) {
                    q.setRequestHeader(f, b.customHeaders[f]);
                  });
                q.send();
                if (200 === q.status || 206 === q.status)
                  this.writeChunk(new Int8Array(q.response), a);
            ...
            getRequiredChunkOffsetArrays: function (a, b) {
              ...
              try {
                ...
                var C = Module.getValue(f, "i8*");
                if (C) {
                  var G = Module._malloc(8 * C);
                  REX(Module._TRN_DownloaderGetRequiredChunks(a, b, G, C));
                  for (a = 0; a < C; ++a) {
                    var B = Module.getValue(G + 8 * a, "double");
                    this.hasChunk(B)
                      ? c.have.push(B)
                      : this.hadChunk(B)
                        ? c.missing.push(B)
                        : c.downloading.push(B);
                  }
                }
              } finally {
                G && Module._free(G), Module.stackRestore(q);
              }
              return c;
            },
            keepVisibleChunks: function (a, b) {
              for (
                var c = b.length, q = Module.chunkMax / 2, f = 0, C = 0;
                C < c;
                ++C
              ) {
                var G = this.getRequiredChunkOffsetArrays(a, b[C]),
                  B = G.have,
                  I = B.length;
                f += I;
                if (f > q) {
                  this.keepChunks(B.slice(0, I - f + q));
                  break;
                }
            ...
            getChunks: function (a) {
              for (var b = a.length, c = Array(b), q = 0; q < b; ++q)
                c[q] = this.getChunkAsync(a[q]);
            ...
            writeChunk: function (a, b, c) {
              c = c || 0;
              var q = this.chunkMap[b],
                f = a.length,
                C = this.lruList.length >= Module.chunkMax && !q;
              1048576 !== f || a.buffer.byteLength !== f
                ? (C
                    ? ((q = this.lruList.shift()),
                      (C = this.chunkMap[q]),
                      1048576 > C.length && (C = new Int8Array(1048576)),
                      (this.chunkMap[q] = null))
                    : (C = q ? this.chunkMap[b] : new Int8Array(1048576)),
                  C.subarray(c, c + f).set(a),
                  (a = C))
                : C && ((q = this.lruList.shift()), (this.chunkMap[q] = null));
              this.lruUpdate(b);
              this.chunkMap[b] = a;
            },
          };
          ...
          D.prototype = {
            read: function (a, b, c) {
              var q = this.position + c <= this.length,
                f = q ? c : this.length - this.position;
              if (this.position < this.length) {
                var C;
                for (C = 0; C < f; ) {
                  var G = this.position % 1048576;
                  var B = this.position - G;
                  var I = f - C,
                    J = a.subarray(b + C, b + C + I);
                  if (this.chunkStorage.hadChunk(B))
                    (B = this.chunkStorage.getChunk(B).subarray(G, G + I)),
                      J.set(B),
                      (J = B.length),
                      (C += J),
                      (this.position += J);
                  else for (this.position += I; C < f; ++C) J[C] = 0;
                }
              }
              if (!q) {
                b += f;
                if ((c -= f))
                  (q = this.chunkStorage.getCacheData()),
            ...
            write: function (a, b, c) {
              ...
              this.chunkStorage.writeChunk(C, this.position - G, G);
              this.position += f;
              if (!q) {
                C = b + f;
                if ((c -= f))
                  (b = this.chunkStorage.getCacheData()),
                    ...
                    (q = this.position - this.length),
                    (C = a.subarray(C, C + c)),
                    b.subarray(q, q + c).set(C);
                this.position += c;
                return f + c;
              }
              return f;
          ...
          x.prototype = {
            ...
            write: function (a, b, c) {
              for (var q = this.position + c, f = this.data.length; q > f; ) {
                f = Math.max(f * (16777216 < f ? 1.5 : 2), q);
          ...
          var E = {
            ...
            open: function (a) {
              ...
              this.IsSink(a)
                ? ((a.provider = new x(b)), (Module.docs[b].sink = a.provider))
            ...
            read: function (a, b, c, q, f) {
              return a.provider.read(b, c, q);
            },
            ...
            write: function (a, b, c, q, f) {
              return q ? a.provider.write(b, c, q) : 0;
            },
          };
          l.THROW = function (a) {
            ...
            try {
              ...
              if (c) {
                ...
                (G = Module.ImageGetImageWidth(b)),
                  (B = Module.ImageGetImageHeight(b)),
                  (c = G / B),
                  c > 612 / 792
                    ? ((G = 612), (B = parseInt(G / c, 10)))
                    : ((B = 792), (G = parseInt(B * c, 10)));
              var I = Module.ElementBuilderCreateImage(f, b, 0, 0, G, B),
                J = Module.PDFDocPageCreate(a, G, B);
              Module.ElementWriterBegin(C, J);
              Module.ElementWriterWritePlacedElement(C, I);
              Module.ElementWriterEnd(C);
              Module.PDFDocPagePushBack(a, J);
            } finally {
              q.reverse().forEach(function (L) {
                L();
              });
            }
          };
          ...
          d.DownloaderHint = function (a, b) {
            var c = Module.GetDoc(a),
              q = downloadDataMap[c];
            b.currentPage && (q.m_current_page = b.currentPage);
            if (b.visiblePages) {
              var f = b.visiblePages;
              for (b = 0; b < f.length; ++b) ++f[b];
              Object.keys(q.requirePageCallbacks).forEach(function (G) {
                q.requirePageCallbacks.hasOwnProperty(G) &&
                  f.push(parseInt(G, 10));
              });
              (b = Module.docs[a].chunkStorage) &&
                b.keepVisibleChunks(q.downloader, f);
              a = f.length;
              var C = Module.allocate(4 * a, "i8", Module.ALLOC_STACK);
              for (b = 0; b < a; ++b) Module.setValue(C + 4 * b, f[b], "i32");
              REX(Module._TRN_PDFDocDownloadPages(c, C, a, 1, 0));
            }
          };
          d.RequirePage = function (a, b) {
            return new Promise(function (c, q) {
              q = Module.GetDoc(a);
              var f = downloadDataMap[q];
              !f || f.m_finished_download || f.m_pages[b]
                ...
                : (b in f.requirePageCallbacks
                  ...
                  Module._TRN_PDFDocDownloadPages(q, c, 1, 0, 0));
            });
          };
              ...
              var b = function (c) {
                return function (q) {
                  ...
                  q in downloadDataMap
                    ? c.apply(this, f)
                    : t(function () {
                        q in downloadDataMap && c.apply(this, f);
                      }, 0);
                };
              };
              k = {
                downloadProc: Module.addFunction(function (c, q, f, C, G) {
                  ...
                  g(
                    ...
                    q,
                    f,
                    Module.customHeadersMap[B],
                    Module.withCredentials[B],
                  ).then(function (I) {
                    B in Module.docs &&
                      Module.docs[B].chunkStorage &&
                      Module.docs[B].chunkStorage.writeChunk(I, q);
                    Module._TRN_DownloadComplete(0, q, f, c);
                  });
                }, "vidiii"),
                notifyUpdatePage: Module.addFunction(
                  b(function (c, q, f, C) {
                    ...
                    G.m_pages[q] = !0;
                    var B = G.eventPageArray;
                    if (q in G.requirePageCallbacks)
                      for (
                        f = G.requirePageCallbacks[q], C = 0;
                        C < f.length;
                        ++C
                      )
                        f[C]();
                    G.timeout
                      ? B.push(q)
                      : ((B = G.eventPageArray = [q]),
                        (G.timeout = setTimeout(function () {
                          Module.postPagesDownloadedEvent(c, G.m_id, B);
                          G.timeout = null;
                        }, 100)));
                  }),
                  "viiii",
                ...
                notifyDocInfoDownloaded: Module.addFunction(
                  b(function (c, q) {
                    downloadDataMap[c].docInfoPromiseCapability.resolve();
                  }),
                  "vii",
                ),
                ...
                getCurrentPage: Module.addFunction(function (c, q) {
                  return downloadDataMap[c].m_current_page;
                }, "iii"),
              };
            }
            b = Module.allocate(44, "i8", Module.ALLOC_STACK);
            Module.setValue(b, k.downloadProc, "i8*");
            Module.setValue(b + 4, a, "i8*");
            Module.setValue(b + 8, k.notifyUpdatePage, "i8*");
            Module.setValue(b + 12, k.notifyUpdateOutline, "i8*");
            Module.setValue(b + 16, k.notifyUpdateNamedDests, "i8*");
            Module.setValue(b + 20, k.notifyDocInfoDownloaded, "i8*");
            Module.setValue(b + 24, k.notifyUpdateThumb, "i8*");
            Module.setValue(b + 28, k.notifyFinishedDownload, "i8*");
            Module.setValue(b + 32, k.notifyDocumentError, "i8*");
            Module.setValue(b + 36, k.getCurrentPage, "i8*");
          ...
          d.CreateDocDownloaderBackend = function (a, b, c) {
            var q = a.url,
              ...
              C = a.customHeaders,
              G = a.withCredentials,
              B = a.shouldUseMinimumDownloads;
            C && (Module.customHeadersMap[c] = C);
            G && (Module.withCredentials[c] = G);
            var I = a.downloadData
              ? new H(a.downloadData, q, c)
              : new H(a.size, q, c);
            var J = Module.createCallbacksStruct(I.downloadUserData),
              L = Module.allocate(4, "i8", Module.ALLOC_STACK);
            Module.MakeDev(c);
            a.chunkStorage
              ? (q = new y(a.chunkStorage))
              : ((a = new Int8Array(
                  new ArrayBuffer(
            ...
            I.downloader = Module.getValue(L, "i8*");
            I.docInfoPromiseCapability = createPromiseCapability();
            I.docInfoRequested = !1;
            if ((f = Module._TRN_PDFDocCreateFromFilter(I.downloader, b)))
              Module._TRN_FilterDestroy(I.downloader), REX(f);
            b = Module.getValue(b, "i8*");
            Module.docs[c].ptr = b;
            Module.PDFDocInitSecurityHandler(b) &&
              REX(Module._TRN_PDFDocDownloaderInitialize(b, I.downloader));
            downloadDataMap[b] = I;
          };
            ...
            try {
              if (c)
                if ("ptr" === f) Module.docs[b] = { ptr: c };
                  ...
                  var B = "object" === r(c) && c.url;
                  f = q && "pdf" !== q;
                  if (B) d.CreateDocDownloaderBackend(c, C, b);
                  else {
                    var I = c instanceof ArrayBuffer;
                    B = I ? "buffer" : "file";
                    if (
                      I &&
                      ((c = new Uint8Array(c)), 10485760 > c.length + h && !f)
                    ) {
                      h += c.length;
                      var J = c.length,
                        L = Module._malloc(c.length);
                      Module.HEAPU8.set(c, L);
                      REX(Module._TRN_PDFDocCreateFromBuffer(L, J, C));
                      var K = Module.getValue(C, "i8*");
                      Module.docs[b] = {
                        ptr: K,
                        bufPtr: L,
                        bufPtrSize: J,
                    ...
                    if (f) {
                      ...
                      REX(Module._TRN_PDFDocCreateFromFilePath(R, C));
                      K = Module.getValue(C, "i8*");
                    }
                    Module.docs[b].extension = q;
                    Module.docs[b].ptr = K;
          ...
          d.ChangeDocBackend = function (a, b) {
            ...
            c
              ? (c.bufPtr &&
                  c.ownership &&
                  (Module._free(c.bufPtr), (h -= c.bufPtrSize)),
          ...
          d.DeleteDoc = function (a) {
            ...
            b
              ? (b.ptr &&
                ...
                b.bufPtr &&
                  b.ownership &&
                  (Module._free(b.bufPtr), (h -= b.bufPtrSize)),
                delete Module.docs[a])
              : Object(A.d)(
                  "Trying to delete document ".concat(
                    a,
          ...
          d.PDFDocCreateFromLayoutEls = function (a) {
            ...
            var c = Module.stackSave(),
              q = Module.allocate(4, "i8", Module.ALLOC_STACK);
            Module.HEAPU8.set(b, a);
            b = Module._TRN_PDFDocCreateFromLayoutEls(a, b.length, q);
            q = Module.getValue(q, "i8*");
            Module._free(a);
            Module.stackRestore(c);
            REX(b);
            return q;
          ...
          d.PDFRasterizerRasterizeSeparations = function (a, b, c, q, f, C, G) {
            var B = Module.allocate(8, "i8", Module.ALLOC_STACK);
            REX(
            ...
            c = Array(b);
            for (q = 0; q < b; ++q)
              (f = Module.VectorGetAt(a, q)),
                (c[q] = Module.ExtractSeparationData(f));
          ...
          d.GetDefaultMatrixBox = function (a, b, c) {
            ...
            REX(Module._TRN_PageGetRotation(a, q));
            a = (Module.getValue(q, "i32") + c) % 4;
          ...
          d.Matrix2DMultBBox = function (a, b) {
            ...
            Module.setValue(q, b.y1, "double");
            REX(Module._TRN_Matrix2DMult(a, c, q));
            b.x1 = Module.getValue(c, "double");
            b.y1 = Module.getValue(q, "double");
            Module.setValue(c, b.x2, "double");
            Module.setValue(q, b.y2, "double");
            REX(Module._TRN_Matrix2DMult(a, c, q));
            b.x2 = Module.getValue(c, "double");
            b.y2 = Module.getValue(q, "double");
            return b;
          };
          d.Matrix2DMult = function (a, b) {
            ...
            Module.setValue(q, b.y, "double");
            REX(Module._TRN_Matrix2DMult(a, c, q));
            b.x = Module.getValue(c, "double");
            b.y = Module.getValue(q, "double");
            return b;
          };
          d.Matrix2DConcat = function (a, b) {
            var c = Module.getValue(b, "double"),
              q = Module.getValue(b + 8, "double"),
              f = Module.getValue(b + 16, "double"),
              C = Module.getValue(b + 24, "double"),
              G = Module.getValue(b + 32, "double");
            b = Module.getValue(b + 40, "double");
            REX(Module._TRN_Matrix2DConcat(a, c, q, f, C, G, b));
          };
          d.Matrix2DSet = function (a, b, c, q, f, C, G) {
            REX(Module._TRN_Matrix2DSet(a, b, c, q, f, C, G));
          };
          ...
          d.GetJSDoubleArrFromCore = function (a, b) {
            for (var c = Array(b), q = 0; q < b; ++q)
              (c[q] = Module.getValue(a, "double")), (a += 8);
            return c;
          };
          d.GetJSIntArrayFromCore = function (a, b) {
            for (var c = Array(b), q = 0; q < b; ++q)
              (c[q] = Module.getValue(a, "i32")), (a += 4);
            return c;
          };
          ...
          d.ObjPutName = function (a, b, c) {
            ...
            var q = Module.allocate(4, "i8", Module.ALLOC_STACK);
            REX(Module._TRN_ObjPutName(a, b, c, q));
            return Module.getValue(q, "i8*");
          };
          ...
          d.ObjPutString = function (a, b, c) {
            ...
            var q = Module.allocate(4, "i8", Module.ALLOC_STACK);
            REX(Module._TRN_ObjPutString(a, b, c, q));
            return Module.getValue(q, "i8*");
          };
          d.ObjPut = function (a, b, c) {
            ...
            var q = Module.allocate(4, "i8", Module.ALLOC_STACK);
            REX(Module._TRN_ObjPut(a, b, c, q));
            return Module.getValue(q, "i8*");
          };
          ...
          d.PDFDocInsertPages = function (a, b, c, q, f) {
            REX(Module._TRN_PDFDocInsertPageSet(a, b, c, q, f ? 1 : 0, 0));
          };
          d.PDFDocInsertPages2 = function (a, b, c, q, f) {
            REX(Module._TRN_PDFDocInsertPageSet2(a, b, c, q, f ? 1 : 0, 0));
          };
          ...
          d.PDFDocPageCreate = function (a, b, c) {
            var q = Module.allocate(40, "i8", Module.ALLOC_STACK);
            Module.setValue(q, 0, "double");
            Module.setValue(q + 8, 0, "double");
            Module.setValue(q + 16, b, "double");
            Module.setValue(q + 24, c, "double");
            Module.setValue(q + 32, 0, "double");
            b = Module.allocate(4, "i8", Module.ALLOC_STACK);
            REX(Module._TRN_PDFDocPageCreate(a, q, b));
            return Module.getValue(b, "i8*");
          };
          ...
          d.ElementBuilderCreateImage = function (a, b, c, q, f, C) {
            var G = Module.allocate(4, "i8", Module.ALLOC_STACK);
            REX(
              Module._TRN_ElementBuilderCreateImageScaled(a, b, c, q, f, C, G),
            );
          ...
          d.ImageCreateFromMemory2 = function (a, b, c) {
            var q = Module.allocate(4, "i8", Module.ALLOC_STACK);
            REX(Module._TRN_ImageCreateFromMemory2(a, b, c, 0, q));
            return Module.getValue(q, "i8*");
          };
            ...
            if (c) {
              for (
                ...
                var B = 8 * G,
                  I = q[G],
                  J = Module.GetDoc(c[I]);
                I = Module.GetUStringFromJSString(I);
                Module.setValue(C + B, J, "i8*");
                Module.setValue(C + B + 4, I, "i8*");
              }
              c = Module.allocate(8, "i8", Module.ALLOC_STACK);
              REX(Module._TRN_PDFDocFDFUpdateAppearanceDocs(a, b, C, f, c));
              a = Module.getValue(c, "i8*");
              b = Module.VectorGetSize(a);
              f = Array(b);
              for (C = 0; C < b; ++C)
                (c = Module.VectorGetAt(a, C)),
                  (f[C] = Module.ExtractApRefChangeData(c));
              Module.VectorDestroy(a);
              if (b) return f;
    ...
    function (u, z, v) {
      ...
      (function (r) {
        r.SetupPDFNetFunctions = function (A) {
          Module._IB_ = [];
          for (
            var l = function D(y) {
                if ("object" === t(y) && null !== y)
                  if ("undefined" !== typeof y.byteLength) {
                    var x = Module._IB_.length;
                    Module._IB_[x] = new Uint8Array(y);
                    y = { handle: x, isArrayBufferRef: !0 };
                  } else
                    Object.keys(y).forEach(function (E) {
                      y.hasOwnProperty(E) && (y[E] = D(y[E]));
                    });
                return y;
              },
              d = function x(D) {
                  ...
                  (D.buffer
                    ...
                    : D.isArrayBufferRef
                      ...
                      : Object.keys(D).forEach(function (E) {
                          D.hasOwnProperty(E) && (D[E] = x(D[E]));
                        }));
                return D;
              },
              h = Module._TRN_EMSCreateSharedWorkerInstance(),
              m,
              e = Module._TRN_EMSWorkerInstanceGetFunctionIterator(h),
              k = function (D, x) {
                return new Promise(function (E, F) {
                  D = l(D);
                  var H = D.docId;
                  H = H ? Module.GetDoc(H) : 0;
                  (H = Module.EMSCallSharedFunction(h, x, H))
                    ? F({
                        type: "PDFWorkerError",
                        message: Module.GetErrToString(H),
                      })
                    : ((F = Module.EMSGetLastResponse(h)), (F = d(F)), E(F));
                });
              };
            (m = Module._TRN_EMSFunctionIteratorGetNextCommandName(e));

          )
            (m = Module.GetJSStringFromCString(m)), r.queue.onAsync(m, k);
          Module._TRN_EMSFunctionIteratorDestroy(e);
          if (Module._TRN_EMSCreatePDFNetWorkerInstance) {
            ...
            r.queue.onAsync("PDFDoc.RequirePage", function (p) {
              return Module.RequirePage(w(p.docId), p.pageNum);
            });
            e("pdfDocCreateFromBuffer", function (p) {
              p = Module.CreateDoc({ type: "array", value: p.buf });
              var y = Module.GetDoc(p).toString(16);
              Module.docPtrStringToIdMap[y] = p;
              return y;
            });
            e("PDFDoc.destroy", function (p) {
              p = w(p.auto_dealloc_obj);
              Module.DeleteDoc(p);
            });
            e("PDFDoc.saveMemoryBuffer", function (p) {
              var y = w(p.doc);
              return Module.SaveHelper(Module.GetDoc(y), y, p.flags).slice(0);
            });
            e("pdfDocCreate", function () {
              var p = Module.CreateDoc({ type: "new" }),
                y = Module.GetDoc(p).toString(16);
              Module.docPtrStringToIdMap[y] = p;
              return y;
            });
            e("GetPDFDoc", function (p) {
              p = p.docId;
              var y = Module.GetDoc(p).toString(16);
              Module.docPtrStringToIdMap[y] = p;
              return y;
            });
            e("ExtractPDFNetLayersContext", function (p) {
              var y = p.layers;
              p = Module.GetDoc(p.docId);
              var D = 0;
              y
                ? (D = Module.EMSCreateUpdatedLayersContext(p, y))
                : Module.PDFDocHasOC(p) &&
                  ((y = Module.PDFDocGetOCGConfig(p)),
                  (D = Module.OCGContextCreate(y)));
              return D.toString(16);
            });
            var n = Module._TRN_EMSCreatePDFNetWorkerInstance();
            e = Module._TRN_EMSWorkerInstanceGetFunctionIterator(n);
            for (
              k = function (p) {
                return new Promise(function (y, D) {
                  p = l(p);
                  var x = Module.EMSCallPDFNetFunction(n, p);
                  x
                    ? D(Module.GetErrToString(x))
                    : ((D = Module.EMSGetLastResponse(n)), (D = d(D)), y(D));
                });
              };
              (m = Module._TRN_EMSFunctionIteratorGetNextCommandName(e));

            )
              if (((m = Module.GetJSStringFromCString(m)), !g[m]))
                A.onAsync(m, k);
            Module._TRN_EMSFunctionIteratorDestroy(e);
          }
        };
    ...
    function (u, z, v) {
      ...
      (function (e) {
        ...
        e.basePath = "../";
        var g = function () {
          var n = e.pdfWorkerPath || "";
          e.workerBasePath && (e.basePath = e.workerBasePath);
          var p = e.isFull,
            y = p ? "full/" : "lean/";
          e.useOptimizedWorker && (y += m.a);
          var D = e.wasmDisabled,
            x = e.disableObjectURLBlobs;
          Object(h.c)();
          e.overriddenPdfWorkerPath &&
            ((n = e.overriddenPdfWorkerPath),
            (e.basePath = "../"),
            !Object(l.a)() || D) &&
            (n = "");
          ...
          OnInitialized: function (n) {
            Module.loaded
              ...
              : ((Module.initCb = function () {
                ...
                Object(h.b)("worker", "PDFNet is not initialized yet!"));
          },
          NewDoc: function (n, p) {
            return new Promise(function (y, D) {
              try {
                y(Module.loadDoc(n, p));
              } catch (x) {
                D(x);
              }
            });
          },
          Initialize: function (n, p, y, D) {
        ...
        var w = {
          setup: function (n) {
            function p(f) {
              ...
              if (B) {
                k = f;
                var I = f.asyncCallCapability;
                Object(h.b)("Memory", "Worker running command: ".concat(G));
                F.actionMap[G](C, f).then(
                  function (J) {
              ...
              } else e.deferredQueue.queue(f), x();
            }
            function y(f) {
              f.asyncCallCapability = createPromiseCapability();
              k || F.length ? F.queue(f) : p(f);
            ...
            function x() {
              r.a.setImmediate(function () {
                if ((!k || "BeginOperation" !== k.action) && F.length && !k) {
                  var f = F.dequeue();
                  p(f);
                }
              });
            }
            var E = new e.EmscriptenPDFManager(),
              F,
              H = !1,
              a = !1;
            Module.workerMessageHandler = n;
            var b = function () {
              H ? a || (n.send("workerLoaded", {}), (a = !0)) : (H = !0);
            };
            E.OnInitialized(b);
            (function () {
              e.queue = F = new t.a({
                ...
                comparator: function (f, C) {
                  return f.priority === C.priority
                    ? f.callbackId - C.callbackId
                    : C.priority - f.priority;
                },
              });
              e.deferredQueue = new t.a({
                strategy: t.a.ArrayStrategy,
                comparator: function (f, C) {
                  return f.priority === C.priority
                    ? f.callbackId - C.callbackId
            ...
            n.on("InitWorker", D);
            var c = function (f) {
                k && f(k) && (Module.cancelCurrent(), (k = null));
                F.removeAllMatching(f, function (C) {
                  C.asyncCallCapability.reject({
                    type: "Cancelled",
                    message:
              ...
              q = function (f) {
                c(function (C) {
                  return C.data && C.data.docId === f;
                });
              };
            n.on("UpdatePassword", function (f) {
              return Module.UpdatePassword(f.docId, f.password);
            });
            n.on("UpdateCustomHeader", function (f) {
              return Module.UpdateCustomHeader(f.docId, f.customHeader);
            });
            n.on("LoadRes", function (f) {
              Module.loadResources(f.array, f.l);
              return {};
            });
            n.on("DownloaderHint", function (f) {
              Module.DownloaderHint(f.docId, f.hint);
            });
            n.on("IsLinearized", function (f) {
              return Module.IsLinearizationValid(f.docId);
            });
            n.onNextAsync(x);
            F.onAsync("NewDoc", function (f) {
              return E.NewDoc(f);
            });
            F.onAsync("GetCanvas", function (f) {
              Object(h.b)(
                "workerdetails",
            ...
            F.onAsync("GetCanvasPartial", function (f) {
              Object(h.b)(
                "Memory",
            ...
            F.onAsync("SaveDocFromFixedElements", function (f) {
            ...
            F.onAsync("MergeXFDF", function (f) {
              return Module.MergeXFDF(f.docId, f.xfdf, f.apdocs);
            });
            F.onAsync("InsertPages", function (f) {
            ...
            F.onAsync("MovePages", function (f) {
              return Module.MovePages(f.docId, f.pageArray, f.destPos);
            });
            F.onAsync("RemovePages", function (f) {
            ...
            F.onAsync("RotatePages", function (f) {
              return Module.RotatePages(f.docId, f.pageArray, f.rotation);
            });
            F.onAsync("ExtractPages", function (f) {
            ...
            F.onAsync("CropPages", function (f) {
            ...
            F.onAsync("TriggerFullDownload", function (f) {
              return Module.TriggerFullDownload(f.docId);
            });
            F.onAsync("InsertBlankPages", function (f) {
            ...
            F.onAsync("BeginOperation", function () {
              return Promise.resolve();
            });
            F.onAsync("RequirePage", function (f, C) {
              return Module.RequirePage(f.docId, f.pageNum);
            });
            n.on("FinishOperation", function () {
              if (k && "BeginOperation" === k.action) (k = null), x();
              else throw { message: "Operation has not started." };
            });
            n.on("DeleteDocument", function (f) {
              f = f.docId;
              q(f);
              Module.DeleteDoc(f);
            });
            n.on("GetCanvasProgressive", function (f) {
              if (k && k.callbackId === f.callbackId) {
                Object(h.b)("worker", "Progressive request in progress");
                var C = Module.GetCurrentCanvasData(!0);
              } else {
                if (F.find({ priority: 0, callbackId: f.callbackId }))
                  throw (
                    (Object(h.b)("worker", "Progressive request Queued"),
                    {
                      type: "Queued",
                ...
                if (
                  e.deferredQueue.find({
                    priority: 0,
                    callbackId: f.callbackId,
                  })
                )
                  throw (
                    (Object(h.b)("worker", "Progressive request Deferred"),
                    {
                      type: "Queued",
                      message: "Rendering has not started yet.",
                    })
            ...
            n.on("actionCancel", function (f) {
              k && k.callbackId === f.callbackId
                ? (Object(h.b)("workerdetails", "Cancelled Current Operation"),
                  Module.cancelCurrent() && ((k = null), x()))
                : (Object(h.b)("workerdetails", "Cancelled queued operation"),
                  F.remove({ priority: 0, callbackId: f.callbackId }),
        ...
        e.onmessage = function (n) {
          if ("init" === n.data.action) {
            var p = n.data.shouldResize;
            e.shouldResize = p;
            e.isFull = n.data.isFull;
            e.wasmDisabled = !n.data.wasm;
            e.externalPath = n.data.externalPath;
            e.useOptimizedWorker = n.data.useOptimizedWorker;
            e.disableObjectURLBlobs = n.data.disableObjectURLBlobs;
            if ((n = n.data.pdfWorkerPath)) e.overriddenPdfWorkerPath = n;
            p || g();
            p = new A.a("worker_processor", self);
            Object(h.a)(p);
            w.setup(p);
          }
        };
