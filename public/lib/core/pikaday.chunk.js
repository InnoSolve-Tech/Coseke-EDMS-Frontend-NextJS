        ...
        !(function (n, pa) {
          ...
          function pa(ma) {
            ...
            la._onClick = function (ra) {
              ...
              if ((ra = qa)) {
                ...
                do if (a(ra, "pika-single") || ra === ja.trigger) return;
                while ((ra = ra.parentNode));
                la._v && qa !== ja.trigger && ra !== ja.trigger && la.hide();
              }
            };
          ...
          function na(ma, la, ja, ra, qa, sa) {
            ...
            for (sa = 0; 12 > sa; sa++)
              Oa.push(
                '<option value="' +
                  (ja === qa ? sa - la : 12 + sa - la) +
                  '"' +
                  (sa === ra ? ' selected="selected"' : "") +
                  ((Ca && sa < Aa.minMonth) || (za && sa > Aa.maxMonth)
                    ? ' disabled="disabled"'
                    : "") +
                  ">" +
                  Aa.i18n.months[sa] +
            ...
            qa =
              ...
              "</select></div>";
            f(Aa.yearRange)
              ? ((sa = Aa.yearRange[0]), (ta = Aa.yearRange[1] + 1))
              : ((sa = ja - Aa.yearRange), (ta = 1 + ja + Aa.yearRange));
            for (Oa = []; sa < ta && sa <= Aa.maxYear; sa++)
              sa >= Aa.minYear &&
                Oa.push(
                  '<option value="' +
                    sa +
            ...
            return (
              (va =
                ...
                Oa.join("") +
                "</select></div>"),
              Aa.showMonthAfterYear ? (Ga += va + qa) : (Ga += qa + va),
              Ca && (0 === ra || Aa.minMonth >= ra) && (Ea = !1),
              za && (11 === ra || Aa.maxMonth <= ra) && (Ja = !1),
              0 === la &&
                (Ga +=
          ...
          function fa(ma, la, ja) {
            var ra;
            ba.createEvent
              ? ((ra = ba.createEvent("HTMLEvents")).initEvent(la, !0, !1),
                (ra = x(ra, ja)),
                ma.dispatchEvent(ra))
          ...
          function x(ma, la, ja) {
            ...
            for (ra in la)
              ...
              void 0 === la[ra].nodeName
                ? b(la[ra])
                  ? ja && (ma[ra] = new Date(la[ra].getTime()))
                  : f(la[ra])
                    ? ja && (ma[ra] = la[ra].slice(0))
                    : (ma[ra] = x({}, la[ra], ja))
                : (!ja && qa) || (ma[ra] = la[ra]);
            return ma;
          }
          function y(ma) {
            b(ma) && ma.setHours(0, 0, 0, 0);
          }
          function w(ma, la) {
            return [
              31,
          ...
          function r(ma, la, ja, ra) {
            ea
              ? ma.removeEventListener(la, ja, !!ra)
              : ma.detachEvent("on" + la, ja);
          }
          function z(ma, la, ja, ra) {
            ea
              ? ma.addEventListener(la, ja, !!ra)
          ...
          return (
            (pa.prototype = {
              config: function (ma) {
                ...
                b(ma.minDate) || (ma.minDate = !1),
                b(ma.maxDate) || (ma.maxDate = !1),
                ma.minDate &&
                  ma.maxDate &&
              ...
              setDate: function (ma, la) {
                ...
                if (
                  ...
                  var ja = this._o.minDate,
                    ra = this._o.maxDate;
                  b(ja) && ma < ja ? (ma = ja) : b(ra) && ma > ra && (ma = ra);
              ...
              adjustDate: function (ma, la) {
                ...
                "add" === ma
                  ...
                  : "subtract" === ma && (ja = new Date(ra.valueOf() - la));
                this.setDate(ja);
              },
              ...
              adjustPosition: function () {
                var ma, la, ja, ra, qa, sa, ta, va, Aa;
                if (!this._o.container) {
                  if (
                    ...
                    var Ca =
                      ...
                      window.pageXOffset;
                    var za = la.bottom + window.pageYOffset;
                  } else
                    for (
                      Ca = la.offsetLeft, za = la.offsetTop + la.offsetHeight;
                      (la = la.offsetParent);

                    )
                      (Ca += la.offsetLeft), (za += la.offsetTop);
                  ((this._o.reposition && Ca + ja > qa) ||
                    (-1 < this._o.position.indexOf("right") &&
                      0 < Ca - ja + ma.offsetWidth)) &&
                    ((Ca = Ca - ja + ma.offsetWidth), (va = !1));
                  ((this._o.reposition && za + ra > sa + ta) ||
                    (-1 < this._o.position.indexOf("top") &&
                      0 < za - ra - ma.offsetHeight)) &&
                    ((za = za - ra - ma.offsetHeight), (Aa = !1));
                  0 > Ca && (Ca = 0);
                  0 > za && (za = 0);
                  this.el.style.left = Ca + "px";
                  this.el.style.top = za + "px";
                  e(this.el, va ? "left-aligned" : "right-aligned");
                  e(this.el, Aa ? "bottom-aligned" : "top-aligned");
                  h(this.el, va ? "right-aligned" : "left-aligned");
              ...
              render: function (ma, la, ja) {
                ...
                for (
                  ...
                  Na -= 7;
                Oa += 7 - Na;
                for (var Ra = !1, Ua = (Na = 0); Na < Oa; Na++) {
                  var Fa = new Date(ma, la, Na - ta + 1),
                    db = !!b(this._d) && Fa.getTime() === this._d.getTime(),
                    cb = Fa.getTime() === qa.getTime(),
                    La = -1 !== ra.events.indexOf(Fa.toDateString()),
                    Pa = Na < ta || Na >= sa + ta,
                    Ma = Na - ta + 1,
                    Wa = la,
                    Xa = ma,
                    ab =
                      ra.startRange && ra.startRange.getTime() === Fa.getTime(),
                    fb = ra.endRange && ra.endRange.getTime() === Fa.getTime(),
                    Qa =
                      ra.startRange &&
                      ra.endRange &&
                      ra.startRange < Fa &&
                  ...
                  Pa &&
                    (Na < ta
                      ? ((Ma = Ja + Ma), (Wa = Ca), (Xa = Ga))
                      : ((Ma -= sa), (Wa = za), (Xa = Ea)));
                  var eb = db,
                    bb;
                  !(bb =
                    (ra.minDate && Fa < ra.minDate) ||
                    (ra.maxDate && Fa > ra.maxDate)) &&
                    (bb = ra.disableWeekends) &&
                    ((bb = Fa.getDay()), (bb = 0 === bb || 6 === bb));
                  Pa = {
                    day: Ma,
                    month: Wa,
                    year: Xa,
                    ...
                    isSelected: eb,
                    isToday: cb,
                    isDisabled: bb || (ra.disableDayFn && ra.disableDayFn(Fa)),
                    isEmpty: Pa,
                    isStartRange: ab,
                    isEndRange: fb,
                    isInRange: Qa,
                  ...
                  a: {
                    ...
                    if (ab.isEmpty) {
                      ...
                      fb.push("is-outside-current-month");
                      ab.enableSelectionDaysInNextAndPreviousMonths ||
                        fb.push("is-selection-disabled");
                    }
                    Pa =
                      (ab.isDisabled && fb.push("is-disabled"),
                      ab.isToday && fb.push("is-today"),
                      ab.isSelected && (fb.push("is-selected"), (Qa = "true")),
                      ab.hasEvent && fb.push("has-event"),
                      ab.isInRange && fb.push("is-inrange"),
                      ab.isStartRange && fb.push("is-startrange"),
                      ab.isEndRange && fb.push("is-endrange"),
                      '<td data-day="' +
                        ab.day +
                        '" class="' +
                        fb.join(" ") +
                  ...
                  7 == ++Ua &&
                    (ra.showWeekNumber &&
                      ...
                      (Fa = new Date(ma, la, Na - ta)),
                      aa
                        ? (Fa = n(Fa).isoWeek())
                        : (Fa.setHours(0, 0, 0, 0),
                          (fb = Fa.getDate()),
                          (Pa = ab - 1),
                          Fa.setDate(fb + Pa - ((Fa.getDay() + 7 - 1) % 7)),
                          (ab = new Date(Fa.getFullYear(), 0, ab)),
                          (Fa =
                            1 +
                            Math.round(
                              ((Fa.getTime() - ab.getTime()) / 864e5 -
                                Pa +
                                ((ab.getDay() + 7 - 1) % 7)) /
                                7,
                            ))),
                      db.call(Ua, '<td class="pika-week">' + Fa + "</td>")),
                    (Ua = va),
                    (db = Ua.push),
                    (Aa =
                      '<tr class="pika-row' +
              ...
              hide: function () {
                var ma = this._v;
                !1 !== ma &&
                  (this._o.bound && r(ba, "click", this._onClick),
                  this._o.container ||
              ...
              destroy: function () {
                ...
                ma.keyboardInput && r(ba, "keydown", this._onKeyChange);
                ma.field &&
                  (r(ma.field, "change", this._onInputChange),
                  ma.bound &&
                    (r(ma.trigger, "click", this._onInputClick),
                    r(ma.trigger, "focus", this._onInputFocus),
                    r(ma.trigger, "blur", this._onInputBlur)));
