        ...
        (function () {
          ya.exports = {
            Ma: function () {
              ...
              function pa(h, e) {
                if ("Y" === e) return h.clientHeight + f < h.scrollHeight;
                if ("X" === e) return h.clientWidth + f < h.scrollWidth;
              }
              function oa(h, e) {
                h = fa.getComputedStyle(h, null)["overflow" + e];
              ...
              function ka(h) {
                var e = (b() - h.startTime) / 468;
                var a = 0.5 * (1 - Math.cos(Math.PI * (1 < e ? 1 : e)));
                e = h.iG + (h.x - h.iG) * a;
                a = h.jG + (h.y - h.jG) * a;
                h.method.call(h.FN, e, a);
                (e === h.x && a === h.y) ||
                  fa.requestAnimationFrame(ka.bind(fa, h));
              }
              function ia(h, e, a) {
                var r = b();
                if (h === x.body) {
                  ...
                  (z = h), (aa = h.scrollLeft), (h = h.scrollTop), (ea = ua);
                ka({
                  FN: z,
                  method: ea,
                  startTime: r,
              ...
              if (
                ...
                var y = fa.HTMLElement || fa.Element,
                  ...
                  f = RegExp("MSIE |Trident/|Edge/").test(
                    ...
                    ? 1
                    : 0;
                fa.scroll = fa.scrollTo = function (h, e) {
                  void 0 !== h &&
                    (!0 === n(h)
                      ? w.scroll.call(
                          fa,
                      ...
                      ? w.scrollBy.call(
                          ...
                          void 0 !== h.left
                            ...
                            : "object" !== typeof h
                              ? h
                              : 0,
                          void 0 !== h.top ? h.top : void 0 !== e ? e : 0,
                        )
                      : ia.call(
                          fa,
                          x.body,
                ...
                y.prototype.scroll = y.prototype.scrollTo = function (h, e) {
                  if (void 0 !== h)
                    if (!0 === n(h)) {
                      if ("number" === typeof h && void 0 === e)
                ...
                y.prototype.scrollBy = function (h, e) {
                  void 0 !== h &&
                    (!0 === n(h)
                      ? w.q6.call(
                          this,
                ...
                y.prototype.scrollIntoView = function (h) {
                  if (!0 === n(h))
                    w.scrollIntoView.call(this, void 0 === h ? !0 : h);
                  else {
                    for (h = this; h !== x.body && !1 === na(h); )
                    ...
                    h !== x.body
                      ? (ia.call(
                          this,
                          h,
                          h.scrollLeft + a.left - e.left,
                          h.scrollTop + a.top - e.top,
                        ),
