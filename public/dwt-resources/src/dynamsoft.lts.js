...
function asyncGeneratorStep(e, t, r, n, o, i, a) {
  ...
  s.done ? t(c) : Dynamsoft.Lib.Promise.resolve(c).then(n, o);
}
function _asyncToGenerator(e) {
  return function () {
    var t = this,
      r = arguments;
    return new Dynamsoft.Lib.Promise(function (n, o) {
      var i = e.apply(t, r);
      function a(e) {
  ...
  function T(t, r, n) {
    ...
    return function (i, a) {
      ...
      for (n.method = i, n.arg = a; ; ) {
        ...
        var u = l(t, r, n);
        if ("normal" === u.type) {
          if (((o = n.done ? v : d), u.arg === m)) continue;
...
!(function () {
      ...
      if (!i) {
        ...
        for (var f in n) {
          var l = n[f] || {},
            ...
            p = l.verStr || t,
            v = l.verSearch || f;
          if ((v instanceof Array || (v = [v]), -1 != h.indexOf(d))) {
            s = f;
            var m,
              y = _createForOfIteratorHelper(v);
            try {
              for (y.s(); !(m = y.n()).done; ) {
                var g = m.value,
                  b = p.indexOf(g);
                if (-1 != b) {
                  c = parseFloat(p.substring(b + g.length + 1));
                  break;
                }
              }
            } catch (k) {
        ...
        "Linux" == u && -1 != t.indexOf("Windows NT") && (u = "HarmonyOS"),
          (o = { browser: s, version: c, OS: u });
      }
      i && (o = { browser: "ssr", version: 0, OS: "ssr" });
    })(),
    n && n.getUserMedia;
  var s =
    ("Chrome" === o.browser && o.version > 66) ||
    ("Safari" === o.browser && o.version > 13) ||
    ("OPR" === o.browser && o.version > 43) ||
    ("Edge" === o.browser && o.version > 15);
  var c = (function () {
    try {
      if ("undefined" != typeof indexedDB) return indexedDB;
  ...
  function x(e) {
    return "boolean" == typeof p
      ? Dynamsoft.Lib.Promise.resolve(p)
      : (function (e) {
          return new Dynamsoft.Lib.Promise(function (t) {
            var r = e.transaction(v, b),
              n = u([""]);
            r.objectStore(v).put(n, "key"),
  ...
  function w(e) {
    var t = m[e.name],
      r = {};
    (r.promise = new Dynamsoft.Lib.Promise(function (e, t) {
  ...
  function k(e, t) {
    return new Dynamsoft.Lib.Promise(function (r, n) {
      if (
        ((m[e.name] = m[e.name] || {
          forages: [],
          db: null,
        ...
        (i.onupgradeneeded = function (t) {
          ...
          try {
            r.createObjectStore(e.storeName),
              t.oldVersion <= 1 && r.createObjectStore(v);
          } catch (n) {
  ...
  function A(e, t, r, n) {
    ...
    try {
      ...
      if (
        n > 0 &&
        (!e.db || "InvalidStateError" === i.name || "NotFoundError" === i.name)
      )
  ...
  var L = {
      ...
      _initStorage: function (e) {
        ...
        return Promise.all(i)
          ...
          .then(function (e) {
            return (r.db = e), E(r, t._defaultConfig.version) ? T(r) : e;
          })
          .then(function (e) {
      ...
      getItem: function (e, t) {
        var r = this;
        e = h(e);
        var n = new Dynamsoft.Lib.Promise(function (t, n) {
          r.ready()
            .then(function () {
              A(r._dbInfo, g, function (o, i) {
                if (o) return n(o);
                try {
      ...
      setItem: function (e, t, r) {
        var n = this;
        e = h(e);
        var o = new Dynamsoft.Lib.Promise(function (r, o) {
          var i;
          n.ready()
            .then(function () {
              return (
                (i = n._dbInfo),
                "[object Blob]" === y.call(t)
                  ? x(i.db).then(function (e) {
                      return e
                        ? t
                        : ((r = t),
                          new Dynamsoft.Lib.Promise(function (e, t) {
      ...
      clear: function (e) {
        var t = this,
          r = new Dynamsoft.Lib.Promise(function (e, r) {
            t.ready()
              .then(function () {
                A(t._dbInfo, b, function (n, o) {
                  if (n) return r(n);
                  try {
        ...
        if (
          ...
          var o =
            e.name === n.name && this._dbInfo.db
              ? Dynamsoft.Lib.Promise.resolve(this._dbInfo.db)
              : C(e).then(function (t) {
                  var r = m[e.name],
                    n = r.forages;
                  r.db = t;
          ...
          r = e.storeName
            ? o.then(function (t) {
                if (t.objectStoreNames.contains(e.storeName)) {
                  ...
                  var s = new Dynamsoft.Lib.Promise(function (t, n) {
                    var o = c.open(e.name, r);
                  ...
                  return s
                    ...
                    ["catch"](function (t) {
                      throw (
                        ((S(e, t) || Dynamsoft.Lib.Promise.resolve())["catch"](
                          function () {},
                        ),
                        t)
                      );
            ...
            : o.then(function (t) {
                ...
                var i = new Dynamsoft.Lib.Promise(function (t, r) {
            ...
            for (;;)
              switch ((e.prev = e.next)) {
                case 0:
                  ...
                  (o = r.keyPrefix = P(t, this._defaultConfig)),
                    (this._dbInfo = r),
                    j.has(o) || j.set(o, new Map());
                case 5:
                case "end":
                  return e.stop();
              }
  ...
  var D = {
      ...
      getItem: function (e, t) {
        ...
        var n = this.ready().then(function () {
          return j.get(r._dbInfo.keyPrefix).get(e);
        });
        return f(n, t), n;
      },
      setItem: function (e, t, r) {
        ...
        var o = this.ready().then(function () {
          return (
            t === undefined && (t = null),
            j.get(n._dbInfo.keyPrefix).set(e, t),
            t
          );
        });
        return f(o, r), o;
      ...
      removeItem: function (e, t) {
        ...
        e = h(e);
        var n = this.ready().then(function () {
          j.get(r._dbInfo.keyPrefix)["delete"](e);
        });
        return f(n, t), n;
      },
      clear: function (e) {
      ...
      length: function (e) {
        var t = this,
          r = this.ready().then(function () {
            return j.get(t._dbInfo.keyPrefix).size;
          });
        return f(r, e), r;
      },
      keys: function (e) {
        var t = this,
          r = this.ready().then(function () {
            return _toConsumableArray(j.get(t._dbInfo.keyPrefix).keys());
          });
        return f(r, e), r;
      },
      dropInstance: function (e, t) {
        ...
        return (
          f(
            (r = e.name
              ? new Dynamsoft.Lib.Promise(function (t) {
                  e.storeName
                    ? t(P(e, n._defaultConfig))
                    : t("".concat(e.name, "/"));
                }).then(function (e) {
                  j["delete"](e);
                })
    ...
    U = {},
    F = {},
    B = { INDEXEDDB: L, TEMPSTORAGE: D },
    H = [B.INDEXEDDB._driver, B.TEMPSTORAGE._driver],
    G = ["dropInstance"],
    W = ["clear", "getItem", "keys", "length", "removeItem", "setItem"].concat(
      G,
    ),
    J = {
      description: "",
  ...
  var V = (function () {
      function e(t) {
        for (var r in (_classCallCheck(this, e), B))
          if (B.hasOwnProperty(r)) {
            var n = B[r],
              o = n._driver;
            (this[r] = o), U[o] || this.defineDriver(n);
          }
        (this._defaultConfig = q({}, J)),
          (this._config = q({}, this._defaultConfig, t)),
          (this._driverSet = null),
          (this._initDriver = null),
          (this._ready = !1),
          (this._dbInfo = null),
      ...
      return _createClass(e, [
        ...
        },
        {
          ...
          value: function (e, t, r) {
            var n = new Dynamsoft.Lib.Promise(function (t, r) {
              try {
                var n = e._driver,
                  o = new Error(
                ...
                for (
                  var i = W.concat("_initStorage"), a = 0, s = i.length;
                  a < s;
                  a++
                ) {
                  var c = i[a];
                  if ((!R(G, c) || e[c]) && "function" != typeof e[c])
                    return void r(o);
                }
                !(function () {
                  for (
        ...
        },
        {
          ...
          value: function (e, t, r) {
            var n = U[e]
              ? Dynamsoft.Lib.Promise.resolve(U[e])
                        ...
                        (n._initDriver = (function (e) {
                          return function () {
                            ...
                            return (function r() {
                              ...
                              return (
                                (n._driverSet = Promise.reject(s)), n._driverSet
                              );
                            })();
                          };
                        })(o));
        ...
        },
        {
          ...
          value: function () {
            for (var e = 0, t = W.length; e < t; e++) $(this, W[e]);
          },
        },
        {
          key: "createInstance",
    ...
    function r() {
      ...
      function d(e, t, r, n) {
        var o = t && t.prototype instanceof x ? t : x,
          ...
          a = new P(n || []);
        return s(i, "_invoke", { value: I(e, r, a) }), i;
      }
      function p(e, t, r) {
        try {
          return { type: "normal", arg: e.call(t, r) };
      ...
      var k = Object.getPrototypeOf,
        C = k && k(k(N([])));
      C && C !== i && a.call(C, u) && (S = C);
      var T = (_.prototype = x.prototype = Object.create(S));
      function E(e) {
        ["next", "throw", "return"].forEach(function (t) {
          h(e, t, function (e) {
            return this._invoke(t, e);
      ...
      function I(e, t, r) {
        ...
        return function (i, a) {
          ...
          for (r.method = i, r.arg = a; ; ) {
            ...
            var u = p(e, t, r);
            if ("normal" === u.type) {
              if (((o = r.done ? g : m), u.arg === b)) continue;
      ...
      function A(e, t) {
        ...
        if ("throw" === i.type)
          return (t.method = "throw"), (t.arg = i.arg), (t.delegate = null), b;
        var a = i.arg;
        return a
          ? a.done
      ...
      return (
        ...
        s(_, "constructor", { value: w, configurable: !0 }),
        ...
        E(O.prototype),
        h(O.prototype, f, function () {
          return this;
        }),
        (o.AsyncIterator = O),
        (o.async = function (e, t, r, n, i) {
          void 0 === i && (i = Promise);
          var a = new O(d(e, t, r, n), i);
        ...
        (P.prototype = {
          ...
          finish: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
              var r = this.tryEntries[t];
              if (r.finallyLoc === e)
                return this.complete(r.completion, r.afterLoc), j(r), b;
            }
          },
          catch: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
  ...
  var oe = (0, te.exports)(),
    ie = oe;
  try {
    regeneratorRuntime = oe;
  } catch (Nr) {
    "object" ===
    ("undefined" == typeof globalThis ? "undefined" : _typeof(globalThis))
      ? (globalThis.regeneratorRuntime = oe)
      : Function("r", "regeneratorRuntime = r")(oe);
  }
  var ae,
    se,
    ce = ee(ie);
  ...
  ae =
    "object" === ("undefined" == typeof window ? "undefined" : Z(window))
      ? window
      : {};
  var de = {
  ...
  function pe(e) {
    return he(e) || fe(e) ? String(e) : de[{}.toString.call(e)] || "object";
  }
  function ve(e) {
  ...
  function xe(e) {
    return Array.isArray ? Array.isArray(e) : "array" === pe(e);
  }
  function we(e) {
    if (null == e) return [];
    if (xe(e)) return e;
  ...
  function Ee(e, t, r, n) {
    if (ke.debug && Se && ve(Se.log)) {
      var o = ue(new Date().getTime()),
        i = we(arguments);
      Se.log(["[", o, "] ", i].join(""));
    }
  }
  function Oe(e, t, r, n) {
    if ((ke.debug || ke.showConsoleError) && Se && ve(Se.error)) {
      var o = ue(new Date().getTime()),
        i = we(arguments);
      Se.error(["[", o, "] ", i].join(""));
    }
  ...
  ae &&
    le(ae.console) &&
    (ve((Se = ae.console).log) && ve(Se.error)
      ? (_e = {
          log: Ee,
          error: Oe,
          info: Ae,
  ...
  var Le = {
      ...
      pushToDo: function (e, t, r) {
        Le.queue.push({ obj: e, method: t, args: r });
      },
      doNext: function () {
        if (Le.doNextStarted)
          if (0 != Le.queue.length) {
            var e = Le.queue[0],
              t = e.obj,
              r = e.method,
              n = e.args;
            if ((Le.queue.splice(0, 1), t && ve(t[r]))) {
              var o = !1;
              if (n.length > 2) {
                var i = n[n.length - 2],
                  a = n[n.length - 1];
                ve(i) &&
                  ...
                  ((n[n.length - 2] = function () {
                    ...
                    Le.timer = setTimeout(Le.doNext, 0);
                  }),
              ...
              o || (Le.timer = setTimeout(Le.doNext, 0));
            } else if (null === t && ve(r)) {
              try {
                r.apply(null, n);
              } catch (c) {}
      ...
      start: function () {
        Le.doNextStarted ||
          ((Le.doNextStarted = !0), (Le.timer = setTimeout(Le.doNext, 0)));
      },
      stop: function () {
  ...
  function Ne(e, t, r) {
    if (e) {
      var n,
        ...
        a = 0,
        s = e.length;
      if (((r = r || null), fe(s) || ve(e)))
        for (
          i = Object.keys(e);
          a < i.length && ((n = i[a]), t.call(r, e[n], n, e) !== Pe);
          a++
        );
      else for (o = e[0]; a < s && t.call(r, o, a, e) !== Pe; o = e[++a]);
    }
    return e;
  }
  var De,
  ...
  var Ue,
    ...
    Ge = navigator,
    We = !0;
  if ("userAgentData" in Ge) {
    var Je = Ge.userAgentData,
      $e = [];
    Je.platform &&
      "" != Je.platform &&
      ("brands" in Je && Array.isArray(Je.brands) && Je.brands.length > 0
        ? ($e = Je.brands)
        : "uaList" in Je &&
          Array.isArray(Je.uaList) &&
          Je.uaList.length > 0 &&
          ($e = Je.uaList),
      $e.length > 0 &&
        ((We = !1),
        (Fe = Je.platform.toLowerCase()),
        (Ue = (function (e, t, r) {
          var n,
            o,
            i,
          ...
          return (
            ...
            (l = /iphone/g.test(r)),
            i || c || s || l || (m = /macintel/g.test(r) && g > 1),
            (c || u || l || m) && (v = !0),
            {
              bUseUserAgent: !1,
              bWin: i,
  ...
  We &&
    (Be || (Be = Ge.userAgent.toLowerCase()),
    He || (He = Ge.platform.toLowerCase()),
    (Ue = (function (e, t) {
      var r,
        n = e.toLowerCase(),
        o = t.toLowerCase(),
      ...
      "linux" == o &&
        ...
        ((o = "harmonyos"), (i = !0));
      var a = !i && /cros/.test(n),
        s = (!i && /android/g.test(n)) || /android/g.test(o),
        c = /iphone/g.test(n) || /iphone/g.test(o),
        u = /macintosh/.test(n),
        f = navigator.maxTouchPoints || 0,
        l = /ipad/g.test(n) || ((u || "macintel" == o) && f > 1),
        h = /ucweb|ucbrowser/g.test(n),
        d = !h && /nexus/g.test(n) && /version\/[\d.]+.*safari\//g.test(n),
        p = /playbook/g.test(n),
        v = /hp-tablet/g.test(n),
        m = /blackberry|bb10/g.test(n),
        y = /symbian/g.test(n),
        g = /windows phone/g.test(n),
        b = /mobile/g.test(n),
        x = /arm64|aarch64/g.test(n),
        w = /mips64/g.test(n),
        _ = /huaweibrowser/g.test(n),
        S = /jsdom/g.test(n),
        k = p || l || v,
        C = !k && !a && (c || d || m || y || g || s || i || b),
        T = !C && !k && !a,
        E = T && /win32|win64|windows/.test(o),
        O = E && /win64|x64/.test(n),
        I = T && /mac68k|macppc|macintosh|macintel/.test(n),
        A = T && /linux/.test(o),
        L = "win64" == o || /wow64|x86_64|win64|x64/.test(n) || x || w,
        j = /wow64/g.test(n),
        P = Pe,
        N = /opera|opr/g.test(n),
        D = /360se/g.test(n),
        R = /maxthon/g.test(n),
        M = /tencenttraveler|qqbrowser/g.test(n),
        U = /the world/g.test(n),
        F = /metasr/g.test(n),
        B = /avant/g.test(n),
        H = /firefox|fxios/g.test(n),
        G = /gecko/g.test(n),
        W = !(H || _) && /edge\/|edga\/|edgios\/|edg\//g.test(n),
        J = !(m || p || h || N || W || _ || S) && /chrome|crios/g.test(n),
        $ = !1,
        q = Me,
        V = 0,
        z = 0,
      ...
      if (
        (!(I || c || l || E || m || p || d) ||
          ...
          ((r = n.match(/version\/([\d.]+).*safari\//)) &&
            (m || p || d || ((P = je), (J = Pe)), (Y = r[1]))),
        W)
      ) {
        var Q = n.indexOf("edge/");
        Q > -1
          ? (Q += 5)
          : (Q = n.indexOf("edg/")) > -1
            ? (Q += 4)
            : (Q = n.indexOf("edga/")) > -1
              ? (Q += 5)
              : (Q = n.indexOf("edgios/")) > -1 && (Q += 7),
          Q > -1 &&
            (r = (Y = n.slice(Q)).indexOf(" ")) > -1 &&
            (Y = Y.slice(0, r));
      } else if (H)
        if ((r = n.indexOf("firefox/")) > -1) {
          var ee = (r = n.slice(r + 8)).indexOf(" ");
          ee > -1 && (r = r.slice(0, ee)),
            (Y = r),
            (ee = r.indexOf(".")) > -1 && (r = Y.slice(0, ee));
        } else
          (c || l) &&
            (r = n.indexOf("fxios/")) > -1 &&
            (Y = r = (r = n.slice(r + 6)).slice(0, r.indexOf(" ")));
      else if ($) {
        var te = n.indexOf("msie "),
          re = n.indexOf("trident"),
          ne = n.indexOf("rv:");
        -1 != te
          ? (q = r = (r = n.slice(te + 5)).slice(0, r.indexOf(";")))
          : -1 != ne
            ? (q = r =
                (r = (r = n.slice(ne + 3)).slice(0, r.indexOf(";"))).slice(
                  0,
                  r.indexOf(")"),
                ))
            : -1 != re &&
              (q = r = (r = n.slice(re + 7)).slice(0, r.indexOf(";"))),
          (Y = r);
      } else if (P) (r = Y.indexOf(".")) > -1 && (r = Y.slice(0, r));
      else if (h)
        (r = n.indexOf("ucweb")) > -1
          ? (Y = n.slice(r + 5))
          : (r = n.indexOf("ucbrowser/")) > -1 &&
            (r = (Y = n.slice(r + 10)).indexOf(" ")) > -1 &&
            (Y = Y.slice(0, r));
      else if (N)
        (r = n.indexOf("version/")) > -1
          ? (Y = n.slice(r + 8))
          : (r = n.indexOf("opr/")) > -1 && (Y = n.slice(r + 4));
      else if (y) (r = n.indexOf("browserng/")) > -1 && (Y = n.slice(r + 10));
      else if (g) (r = n.indexOf("iemobile/")) > -1 && (Y = n.slice(r + 9));
      else if (J) {
        var oe = n.indexOf("chrome/");
        oe > -1
          ? (r = (Y = n.slice(oe + 7)).indexOf(" ")) > -1 && (Y = Y.slice(0, r))
          : (oe = n.indexOf("crios/")) > -1 &&
            (r = (Y = n.slice(oe + 6)).indexOf(" ")) > -1 &&
            (Y = Y.slice(0, r)),
          (r = Y.indexOf(".")) > -1 && (r = Y.slice(0, r));
      } else if (_) {
        var ie = n.indexOf("huaweibrowser");
        ie > -1 &&
          (r = (Y = n.slice(ie + 14)).indexOf(" ")) > -1 &&
          (Y = Y.slice(0, r));
      } else if (S) {
        var se = n.indexOf("jsdom");
        se > -1 &&
          (r = (Y = n.slice(se + 6)).indexOf(" ")) > -1 &&
          (Y = Y.slice(0, r));
      }
      if (W || $) {
        ...
        ce && ce.documentMode
          ? (V = ce.documentMode)
          : ((V = 5),
            ce.compatMode && "CSS1Compat" == ce.compatMode && (V = 7)),
          $ && (z = parseInt(Y));
      }
      (I || A) &&
        ((L = !0),
      ...
      if ($)
        if ("" === q || parseInt(q) >= 10) {
          var fe = ae.Dynamsoft;
          fe && fe.DWT && fe.DWT.IfUseActiveXForIE10Plus && (ue = Pe);
        } else ue = Pe;
      return {
        bUseUserAgent: !0,
        bWin: E,
    ...
    null ===
      (De =
        null === document || void 0 === document
          ? void 0
          : document.location) || void 0 === De
      ? void 0
      : De.protocol;
  function Ve(e) {
    return Ue.bGecko && "mousewheel" === e ? "DOMMouseScroll" : e;
  }
  function ze(e, t, r) {
    var n = Ve(t);
  ...
  function Ke(e, t) {
    var r = ae.document.createEvent("HTMLEvents");
    r.initEvent(e, je, je), t.dispatchEvent && t.dispatchEvent(r);
  }
  qe || (qe = "https:"),
    (Ue.protocol = qe),
    (Ue.bSSL = "https:" === qe),
    (Ue.bFileSystem = "https:" !== qe && "http:" !== qe);
  var Xe,
    Qe,
    et,
    tt,
  ...
  function ct(e, t, r, n) {
    ...
    if (
      !n &&
      ((t ? t.ownerDocument || t : rt) !== et && Qe(t),
      (t = t || et),
      11 !== c && (a = at.exec(e)))
    )
      if ((o = a[1])) {
        ...
        } else if (s && (i = s.getElementById(o)) && tt(t, i) && i.id === o)
          return r.push(i), r;
      } else {
        if (a[2]) return ot.apply(r, t.getElementsByTagName(e)), r;
        if ((o = a[3]) && t.getElementsByClassName)
          return ot.apply(r, t.getElementsByClassName(o)), r;
      }
    return r;
  }
  ot.apply(it.call(rt.childNodes), rt.childNodes),
    (Qe = ct.setDocument =
      function (e) {
        var t,
          r = e ? e.ownerDocument || e : rt;
        return r !== et && 9 === r.nodeType && r.documentElement
          ? (rt !== (et = r) &&
              (t = et.defaultView) &&
              t.top !== t &&
              (t.addEventListener
                ? t.addEventListener("unload", st, !1)
                : t.attachEvent && t.attachEvent("onunload", st)),
            (tt = function (e, t) {
    ...
    (ct.contains = function (e, t) {
      return (e.ownerDocument || e) !== et && Qe(e), tt(e, t);
    }),
    (ct.error = function (e) {
      ...
      function (e) {
        ...
        if (o) {
          if (1 === o || 9 === o || 11 === o) {
            ...
            for (e = e.firstChild; e; e = e.nextSibling) r += Xe(e);
          } else if (3 === o || 4 === o) return e.nodeValue;
        } else for (; (t = e[n++]); ) r += Xe(t);
        return r;
      }),
    Qe();
  var ut = {
    ...
    ft = {
      ...
      encode: function (e) {
        for (
          var t, r, n, o = this.UTF16ToUTF8(e), i = [], a = 0, s = o.length;
          a < s;

        ) {
          if (((t = 255 & o.charCodeAt(a++)), a == s)) {
            i.push(ut.encodeChars.charAt(t >> 2)),
              i.push(ut.encodeChars.charAt((3 & t) << 4)),
              i.push("==");
            break;
          }
          if (((r = o.charCodeAt(a++)), a == s)) {
            i.push(ut.encodeChars.charAt(t >> 2)),
              i.push(ut.encodeChars.charAt(((3 & t) << 4) | ((240 & r) >> 4))),
              i.push(ut.encodeChars.charAt((15 & r) << 2)),
              i.push("=");
            break;
          }
          (n = o.charCodeAt(a++)),
            i.push(ut.encodeChars.charAt(t >> 2)),
            i.push(ut.encodeChars.charAt(((3 & t) << 4) | ((240 & r) >> 4))),
            i.push(ut.encodeChars.charAt(((15 & r) << 2) | ((192 & n) >> 6))),
            i.push(ut.encodeChars.charAt(63 & n));
        }
        return i.join("");
      },
      encodeArray: function (e) {
        for (var t, r, n, o = [], i = 0, a = e.length; i < a; ) {
          if (((t = 255 & e[i++]), i == a)) {
            o.push(ut.encodeChars.charAt(t >> 2)),
              o.push(ut.encodeChars.charAt((3 & t) << 4)),
              o.push("==");
            break;
          }
          if (((r = 255 & e[i++]), i == a)) {
            o.push(ut.encodeChars.charAt(t >> 2)),
              o.push(ut.encodeChars.charAt(((3 & t) << 4) | ((240 & r) >> 4))),
              o.push(ut.encodeChars.charAt((15 & r) << 2)),
              o.push("=");
            break;
          }
          (n = 255 & e[i++]),
            o.push(ut.encodeChars.charAt(t >> 2)),
            o.push(ut.encodeChars.charAt(((3 & t) << 4) | ((240 & r) >> 4))),
            o.push(ut.encodeChars.charAt(((15 & r) << 2) | ((192 & n) >> 6))),
            o.push(ut.encodeChars.charAt(63 & n));
        }
        return o.join("");
      },
      decode: function (e, t) {
        for (var r, n, o, i, a = this, s = [], c = 0, u = e.length; c < u; ) {
          do {
            r = ut.decodeChars[255 & e.charCodeAt(c++)];
          } while (c < u && -1 == r);
          if (-1 == r) break;
          do {
            n = ut.decodeChars[255 & e.charCodeAt(c++)];
          } while (c < u && -1 == n);
          if (-1 == n) break;
          t
            ? s.push((r << 2) | ((48 & n) >> 4))
            : s.push(String.fromCharCode((r << 2) | ((48 & n) >> 4)));
          do {
            if (61 == (o = 255 & e.charCodeAt(c++)))
              return t ? s : a.UTF8ToUTF16(s.join(""));
            o = ut.decodeChars[o];
          } while (c < u && -1 == o);
          if (-1 == o) break;
          t
            ? s.push(((15 & n) << 4) | ((60 & o) >> 2))
            : s.push(String.fromCharCode(((15 & n) << 4) | ((60 & o) >> 2)));
          do {
          ...
          t
            ? s.push(((3 & o) << 6) | i)
            : s.push(String.fromCharCode(((3 & o) << 6) | i));
        }
        return t ? s : a.UTF8ToUTF16(s.join(""));
      },
    },
    ...
    ht = "undefined" != typeof self ? self : global,
    dt = ht.btoa
      ? function (e) {
          return ht.btoa(e);
        }
      : function (e) {
          for (
            var t, r, n = String(e), o = 0, i = ut.encodeChars, a = "";
            n.charAt(0 | o) || ((i = "="), o % 1);
            a += i.charAt(63 & (t >> (8 - (o % 1) * 8)))
          ) {
            if ((r = n.charCodeAt((o += 3 / 4))) > 255)
              throw new Error(
    ...
    pt = ht.atob
      ...
      : function (e) {
          ...
          for (
            ...
            n = ut.encodeChars.indexOf(n);
          return a;
        };
  function vt(e) {
    if (null == e || "object" != Z(e)) return e;
    var t, r, n;
    if (e instanceof Date) return (t = new Date()).setTime(e.getTime()), t;
    if (e instanceof Array) {
      for (t = [], n = e.length, r = 0; r < n; r++) t[r] = vt(e[r]);
      return t;
    }
    if (e instanceof Object) {
      for (r in ((t = {}), e)) e.hasOwnProperty(r) && (t[r] = vt(e[r]));
      return t;
    }
    return 0;
  }
  ...
  function yt(e) {
    var t = [mt(8), "-", mt(4), "-", mt(4), "-", mt(4), "-", mt(8)];
  ...
  function xt() {
    for (var e, t = gt() % 1e4, r = [], n = 0; n < 5; n++)
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 3:
                          ...
                          break;
                        case 6:
                          (e.prev = 6), (e.t0 = e["catch"](0)), (kt = null);
                        case 9:
                        case "end":
                          return e.stop();
                      }
  ...
  function Ot(e, t, r) {
    return Et.filter.call(e, t, r || this);
  }
  function It(e, t) {
    return Et.indexOf.call(t, e);
  }
  function At(e) {
    var t,
      r,
  ...
  var Nt = (function () {
        ...
        [
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              var r,
                n,
                o = Ot(e.split("/"), function (e) {
                  return !!e;
                }),
                i = [],
                a = Ot(t.split("/"), function (e) {
                  return !!e;
                }),
                s = Math.min(o.length, a.length);
              for (r = 0; r < s && o[r] === a[r]; r++);
    ...
    Dt = {}.hasOwnProperty;
  function Rt(e) {
    if (!e || "object" !== pe(e) || e.nodeType || e.window == e) return Pe;
    var t, r;
    try {
      if (
        (r = e.constructor) &&
        !Dt(e, "constructor") &&
        !Dt(r.prototype, "isPrototypeOf")
      )
        return Pe;
    } catch (n) {
      return Pe;
  ...
  var Mt =
    "object" ===
    ("undefined" == typeof HTMLElement ? "undefined" : Z(HTMLElement));
  function Ut(e) {
    return Mt
  ...
  function Ft(e) {
    var t = e;
    if (Ut(e)) for (; !t && t != document.body; ) t = t.parentNode;
    else t = 0;
    return !!t;
  }
  function Bt(e, t) {
  ...
  function Gt(e) {
    return null == e ? Me : String.prototype.trim.call(e);
  }
  function Wt(e) {
    var t;
    if (e) for (t in e) if (!fe(t)) return !1;
    return !0;
  }
  function Jt(e) {
    return me(e) ? e.replace(/[^\x20-\x7E]/g, "") : e;
  }
  function $t(e, t, r) {
          ...
          (a = s.scrollLeft),
            ...
            "BODY" === s.tagName
              ? h
                ? ((a = 0), (i = 0))
                : ((a |=
                    null === (n = d.documentElement) || void 0 === n
                      ? void 0
                      : n.scrollLeft),
                  (i |=
                    null === (o = d.documentElement) || void 0 === o
                      ? void 0
                      : o.scrollTop))
              : "fixed" === s.style.position && (h = !0),
            (c += s.offsetLeft - a),
            (u += s.offsetTop - i),
            (s = s.offsetParent);
        return (
          t && ((f = t.Left), (l = t.Top)),
          { x: (c = e.clientX - c - f), y: (u = e.clientY - u - l) }
        );
      },
  ...
  function Kt(e) {
    var t = me(e) ? Zt(e) : e;
    t && (t.length > 0 && (t = t[0]), (t.style.display = zt));
  }
  function Xt(e) {
    var t = me(e) ? Zt(e) : e;
    t && (t.length > 0 && (t = t[0]), (t.style.display = Me));
  }
  function Qt(e) {
    var t = me(e) ? Zt(e) : e;
    t &&
      (t.length > 0 && (t = t[0]),
      t.style.display === zt ? (t.style.display = Me) : (t.style.display = zt));
  }
  function er(e) {
  ...
  if (window.trustedTypes) {
    try {
      Vt = window.trustedTypes.createPolicy("d-create-script", {
  ...
  function nr(e) {
    return Vt ? Vt.createScriptURL(e) : e;
  }
  var or = !0,
    ir = document,
    ar = ir && ir.documentElement,
    sr = ir.getElementsByTagName("head")[0] || ar,
    cr = ir.createElement("script").readyState
      ? function (e, t) {
      ...
      : function (e, t) {
          e.addEventListener("load", t, Pe), e.addEventListener("error", t, Pe);
        };
  function ur(e, t, r) {
    return fr(e, t, !1, r);
  }
  function fr(e, t, r, n) {
    var o,
      i,
      a = n;
    if ((ve(a) || (a = function () {}), me(e) && e != Me))
      return (
        (o = ir.createElement("script")),
        (i = ["", e].join(Me)),
        (o.src = nr(i)),
        t && (o.async = or),
        (o.charset = "utf-8"),
        cr(o, a),
        r ? sr.appendChild(o) : sr.insertBefore(o, sr.firstChild),
        o
      );
    a();
  }
  ...
  function hr(e, t, r, n) {
    var o = n;
    if ((ve(o) || (o = function () {}), Ue.bJSDom)) o("ok");
    else if (xe(e)) {
      var i = e.length,
        a = function (e) {
          e && "load" == e.type
            ...
            : (e &&
                "error" == e.type &&
                Oe(["Failed to load resource: ", e.target.src, "."].join("")),
              o()),
            i <= 0 && o("ok");
        };
      i <= 0
  ...
  function pr(e, t, r) {
    var n,
      o = r;
    if ((ve(o) || (o = !1), me(e) && e != Me)) {
      if (!Ue.bJSDom)
        return (
          ((n = ir.createElement("link")).href = nr(e)),
          (n.rel = "stylesheet"),
          (n.async = or),
          o && cr(n, o),
          t ? sr.appendChild(n) : sr.insertBefore(n, sr.firstChild),
          n
        );
      o && o();
    } else o && o();
        ...
        o = function (e) {
          e && "load" == e.type && n--,
            e &&
              ...
              (e &&
                "error" == e.type &&
                Oe(["Failed to load resource: ", e.target.href, "."].join("")),
              r()),
            n <= 0 && r("ok");
        };
      Ne(e, function (e) {
  ...
  function yr(e) {
    ...
    if (!Ue.bJSDom) {
      var n = document;
      if (n && me((r = e.body)) && r != Me) {
        ((t = n.createElement("script")).charset = "utf-8"),
          Ue.bIE ? (t.text = r) : t.appendChild(n.createTextNode(r)),
  ...
  function br(e) {
    yr({ body: e, language: "vbscript", type: "text/vbscript" });
  }
  function xr(e) {
  ...
  var wr = new ((function () {
      return Q(
        function e() {
          Y(this, e),
            ...
            (this.toggle = Qt),
            (this.empty = er),
            (this.stringify = ae.JSON.stringify),
            (this.parse = ae.JSON.parse),
            (this.isDef = le),
            (this.isUndef = fe),
            (this.isUndefined = fe),
            (this.isNull = he),
            ...
            (this.endsWith = Ht),
            (this.replaceAll = $t),
            (this.upperCaseFirst = qt),
            (this.removeNonPrintableChar = Jt),
            (this.trim = Gt),
            (this.makeArray = we),
            (this.isEmptyObject = Wt),
            (this.Path = new Nt()),
            (this.DOM = Yt),
            (this.isWindow = xr),
            (this.obj = { customEvent: Re }),
            (this.addEventListener = ze),
            (this.removeEventListener = Ye),
            (this.stopPropagation = Ze),
            (this.fireEvent = Ke),
            (this.base64 = ft),
            (this.utf8 = lt),
            (this.btoa = dt),
            ...
            (this.asyncQueue = Le),
            (this.sizzle = ct),
            (this.toggleWakeLock = Ct),
            (this.getWakeLock = Tt),
            (this.urlEncode = tr),
            (this.urlDecode = rr),
            (this.scriptOnload = cr),
            (this.addAllCss = mr),
            (this.getAllCss = vr),
            (this.addCss = pr),
            (this.getCss = dr),
    ...
    Tr = /[#\/\?@]/g,
    Er = /[#\?]/g,
    Or = { scheme: 1, userInfo: 2, hostname: 3, port: 4, path: 5 },
    Ir = new RegExp(
      "^(?:([\\w\\d+.-]+):)?(?://(?:([^/?#@]*)@)?([\\w\\d\\-\\u0100-\\uffff.+%]*|\\[[^\\]]+\\])(?::([0-9]+))?)?(.+)?$",
    );
  function Ar(e, t) {
    return Cr(e) && Cr(t) ? e.toLowerCase() === t.toLowerCase() : e === t;
  }
  function Lr(e, t) {
        ...
        [
          ...
          },
          {
            ...
            value: function (e) {
              var t = this;
              return (
                Ar(t.hostname, e.hostname) &&
                Ar(t.scheme, e.scheme) &&
                Ar(t.port, e.port)
              );
            },
          },
          {
            ...
            value: function (e) {
              var t,
                ...
                s = this;
              return (
                (t = s.scheme) && (a.push(Lr(t, Tr)), a.push(":")),
                (r = s.hostname) &&
                  (a.push("//"),
                  (i = s.userInfo) && (a.push(Lr(i, Tr)), a.push("@")),
                  a.push(encodeURIComponent(r)),
                  (o = s.port) && (a.push(":"), a.push(o))),
                (n = s.path) &&
                  (r && !Sr(n, "/") && (n = "/" + n), a.push(Lr(n, Er))),
                a.join("")
              );
            },
          },
    ...
    (Pr.LTS._ = {
      createLtsInstance: function (e) {
        var t,
          ...
          N = e.dt,
          D = e.dm,
          R = ["https://mlts.dynamsoft.com/", "https://slts.dynamsoft.com/"],
          M = !1,
          U = Dynamsoft.Lib.Promise.resolve(),
          F = e.lf,
          B =
            (e.log &&
              function () {
          ...
          V = e.feab,
          Y = function (e) {
            return I(I(e.replace(/\n/g, "+").replace(/\s/g, "=")).substring(1));
          },
          Z = function (e) {
            return O(String.fromCharCode(97 + 25 * Math.random()) + O(e))
              .replace(/\+/g, "\n")
              .replace(/=/g, " ");
          },
          K = function () {
          ...
          Q = {
            ...
            publicTrialNetworkTimeout:
              "Failed to connect to the Dynamsoft License Server: network timed out." +
              X,
            networkTimeout:
            ...
            publicTrialFailConnect:
              "Failed to connect to the Dynamsoft License Server: network connection error." +
              X,
            failConnect:
            ...
            checkLocalTime:
              "Your system date and time appear to have been changed, causing the license to fail. Please correct the system date and time, then try again.",
          },
          ee = (function () {
                                  ...
                                  function (t) {
                                    for (;;)
                                      switch ((t.prev = t.next)) {
                                        ...
                                        case 34:
                                          if (
                                            ((s = t.sent), (t.t4 = s), !t.t4)
                                          ) {
                                            t.next = 39;
                                            break;
                                          }
                                          return (t.next = 39), v.setItem(m, s);
                                        case 39:
                                          if (((t.t5 = s), !t.t5)) {
                                            t.next = 50;
                                            break;
                                          ...
                                          return (
                                            (t.t6 = JSON), (t.next = 44), Y(s)
                                          );
                                        case 44:
                                          (t.t7 = t.sent),
                                            (i = t.t6.parse.call(t.t6, t.t7)),
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (y = O(
                              String.fromCharCode(P.charCodeAt(0) + 10) +
                                O(L) +
                                O(P) +
                                j +
                                O("" + N),
          ...
          ne = (function () {
            var e = _asyncToGenerator(
              _regeneratorRuntime().mark(function a(e) {
                    ...
                    switch ((a.prev = a.next)) {
                      case 0:
                        return (
                          ...
                          x ||
                            (x = _asyncToGenerator(
                              _regeneratorRuntime().mark(function s() {
                                var a, p, b, w, _, S;
                                return _regeneratorRuntime().wrap(
                                  function (s) {
                                    for (;;)
                                      switch ((s.prev = s.next)) {
                                        case 0:
                                          ...
                                          return (s.next = 7), v.getItem(m);
                                        case 7:
                                          if (
                                            ((_ = s.sent), (s.t0 = _), !s.t0)
                                          ) {
                                            s.next = 19;
                                            break;
                                          }
                                          return (
                                            (s.t1 = JSON), (s.next = 13), Y(_)
                                          );
                                        case 13:
                                          (s.t2 = s.sent),
                                            (b = s.t1.parse.call(s.t1, s.t2)),
                                        ...
                                        case 20:
                                          return (
                                            ...
                                            Promise.race([
                                              ...
                                              new Dynamsoft.Lib.Promise(
                                                function (e, t) {
                                                  var n;
                                                  (n = c
                                                    ? Q.publicTrialNetworkTimeout
                                                    : Q.networkTimeout),
                                                    setTimeout(
                                                      function () {
                ...
                return _regeneratorRuntime().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 3:
                        if (((r = t.sent), H(r), !(r && r < e))) {
                          t.next = 6;
                          break;
                        }
                        throw d
                          ? new Error(Q.dlsErrorAndCacheExpire)
                          : new Error(Q.checkLocalTime);
                      case 6:
                      case "end":
                        return t.stop();
                    }
          ...
          ae = null,
          se = new Dynamsoft.Lib.Promise(function (e) {
            ae = function () {
              (se.isPending = !1), (se.isFulfilled = !0), e();
            };
          }),
          ce = null,
          ue = (function () {
                                    ...
                                    for (;;)
                                      switch ((o.prev = o.next)) {
                                        ...
                                        case 19:
                                          ...
                                          return (o.next = 22), v.getItem(m);
                                        case 22:
                                          if (
                                            ((d = o.sent), (o.t2 = d), !o.t2)
                                          ) {
                                            o.next = 33;
                                            break;
                                          }
                                          return (
                                            (o.t3 = JSON), (o.next = 28), Y(d)
                                          );
                                        case 28:
                                          (o.t4 = o.sent),
                                            (f = o.t3.parse.call(o.t3, o.t4)),
                                            (l = _slicedToArray(f, 1)),
                                            (n = l[0]);
                                        case 33:
                                          return (
                                            (o.t5 = v),
                                            (o.t6 = m),
                                            (o.next = 37),
                                            Z(JSON.stringify([n, h]))
                                          );
                                        case 37:
                                          (o.t7 = o.sent),
                                            o.t5.setItem.call(o.t5, o.t6, o.t7);
                                        case 39:
                                          (o.prev = 39),
                                            (y = void 0),
                                            (b = void 0),
        ...
        return {
          i:
            ((T = _asyncToGenerator(
              _regeneratorRuntime().mark(function fe(e) {
                return _regeneratorRuntime().wrap(function (a) {
                  for (;;)
                    switch ((a.prev = a.next)) {
                      case 0:
                        return (
                          ...
                          (o =
                            "string" != typeof e.os
                              ? JSON.stringify(e.os)
                              : e.os),
                          "string" == typeof (i = e.fn) &&
                            (i = i.substring(0, 255)),
                          e.ls &&
                            e.ls.length &&
                            1 == (R = e.ls).length &&
                            R.push(R[0]),
                          (c = !P || "200001" === P || P.startsWith("200001-")),
                          (u = e.sp),
                          "string" == typeof (f = e.rmk) &&
                            (f = f.substring(0, 255)),
                          e.cv && (l = "" + e.cv),
                          e.lf && (F = e.lf),
                          e.lsu && (n = g = e.lsu),
                      ...
                      case 29:
                        return (
                          (!d ||
                            (d.ltsErrorCode >= 102 && d.ltsErrorCode <= 120)) &&
                            ue(null, !0),
                          a.abrupt("return", { ar: r, cu: n })
                        );
                      case 31:
                      case "end":
                        return a.stop();
          ...
          c:
            ((C = _asyncToGenerator(
              _regeneratorRuntime().mark(function le() {
                var e, t, r, n, o, i;
                return _regeneratorRuntime().wrap(function (a) {
                  for (;;)
                    switch ((a.prev = a.next)) {
                      case 0:
                        if (!((e = new Date()).getTime() < w + 36e4)) {
                          a.next = 3;
                          break;
                        }
                        return a.abrupt("return");
                      case 3:
                        return (
                          (t = e.kUtilFormat("yyyy-MM-ddTHH:mm:ss.SSSZ")),
                          (a.next = 6),
                          J()
                        );
                      case 6:
                        return (r = a.sent), (a.next = 9), $();
                      case 9:
                        if (!((n = a.sent) && n < t)) {
                          a.next = 17;
                          break;
                        }
                        return (a.next = 13), ne(!0);
                      case 13:
                        return (a.next = 15), oe();
                      case 15:
                        a.next = 18;
                      ...
                      case 17:
                        r &&
                          r < t &&
                          ((o = new Date(e.getTime())).setMinutes(
                            e.getMinutes() - 6,
                          ),
                          (i = o.kUtilFormat("yyyy-MM-ddTHH:mm:ss.SSSZ")),
                          h < i &&
                            ne().then(function () {
                              return oe();
                            }));
          ...
          s:
            ((k = _asyncToGenerator(
              _regeneratorRuntime().mark(function he(e, t, r, n) {
                var o;
                return _regeneratorRuntime().wrap(
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 9:
                          ...
                          return H("bs " + r), (e.next = 14), p.setItem(r, o);
                        case 14:
                          H("ss " + r), (e.next = 18);
                          break;
                        case 17:
                        ...
                        case 18:
                          ...
                          break;
                        case 20:
                          (e.prev = 20), (e.t1 = e["catch"](1));
                        case 22:
                          if (((e.t2 = n), !e.t2)) {
                            e.next = 28;
                            break;
                          }
                          return H("bd " + r), (e.next = 27), ue(r, 2 == n);
                        case 27:
                          H("sd " + r);
                        case 28:
                          ce && clearTimeout(ce),
          ...
          u:
            ((S = _asyncToGenerator(
              _regeneratorRuntime().mark(function de() {
                return _regeneratorRuntime().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
