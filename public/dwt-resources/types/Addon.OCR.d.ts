...
export interface OCR {
   ...
   */
  SetLanguage(
    language: DynamsoftEnumsDWT.EnumDWT_OCRLanguage | string,
  ): boolean;
  /**
   * Configure the OCR operation.
   ...
   */
  SetOutputFormat(
    format: DynamsoftEnumsDWT.EnumDWT_OCROutputFormat | number,
  ): boolean;
  /**
   * Configure the OCR operation.
   ...
   */
  SetPageSetMode(
    mode: DynamsoftEnumsDWT.EnumDWT_OCRPageSetMode | number,
  ): boolean;
  /**
  ...
  Recognize(
    index: number,
    successCallback: (imageId: string, result: OCRResult) => void,
    failureCallback: (errorCode: number, errorString: string) => void,
  ): void;
  /**
